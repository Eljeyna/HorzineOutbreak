...
#define AMMO_CROSSBOWCLIP_GIVE 5 //CROSSBOW_MAX_CLIP
...
extern void RadiusDamageGrenade( Vector vecSrc, entvars_t *pevInflictor, entvars_t *pevAttacker, float flDamage, float flRadius, int iClassIgnore, int bitsDamageType, float flForce );
