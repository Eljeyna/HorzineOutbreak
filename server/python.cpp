...
public:
	...
	void PythonFire( float flSpread , float flCycleTime );
	BOOL Deploy( void );
	void Holster( void );
	void Reload( void );
...
void CPython::PythonFire( float flSpread , float flCycleTime )
{
...
void CPython::Reload( void )
{
	...
	DefaultReload( PYTHON_MAX_CLIP, PYTHON_RELOAD, 2.0 );

	/*if (DefaultReload( PYTHON_MAX_CLIP, PYTHON_RELOAD, 2.0 ))
	{
		m_flSoundDelay = 1.5;
	}*/
}
