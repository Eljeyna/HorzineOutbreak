...
; 149  : 		for( int j = i + 1; j < gcTextures; j++ )
	...
	mov	edx, DWORD PTR _i$[ebp]
	add	edx, 1
	mov	DWORD PTR _j$6100[ebp], edx
	jmp	SHORT $L6101
$L6102:
	mov	eax, DWORD PTR _j$6100[ebp]
	add	eax, 1
	mov	DWORD PTR _j$6100[ebp], eax
$L6101:
	mov	ecx, DWORD PTR _j$6100[ebp]
	cmp	ecx, DWORD PTR _gcTextures
	jge	SHORT $L6103
...
; 177  : 		Vector curpos = start + curdist * diff;
	...
	push	edx
	lea	eax, DWORD PTR $T7558[ebp]
	push	eax
	call	??D@YA?AVVector@@MABV0@@Z		; operator*
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR $T7559[ebp]
	push	ecx
	lea	ecx, DWORD PTR _start$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	push	eax
	lea	ecx, DWORD PTR _curpos$6118[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 511  : 	{
	...
	xor	edx, edx
	mov	dl, BYTE PTR $L7616[eax]
	jmp	DWORD PTR $L7617[edx*4]
$L6398:
...
; 647  : 			{
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR $L7651[edx]
	jmp	DWORD PTR $L7652[ecx*4]
$L6449:
...
; 1299 : 		Vector start, stop;
	...
	lea	ecx, DWORD PTR _start$6666[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
	lea	ecx, DWORD PTR _stop$6667[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector

; 1300 : 		pmtrace_t trace;

	lea	ecx, DWORD PTR _trace$6668[ebp]
	call	??0pmtrace_s@@QAE@XZ			; pmtrace_s::pmtrace_s
...
; 1307 : 		trace = pmove->PM_PlayerTrace (start, stop, PM_NORMAL, -1 );
	...
	mov	esi, eax
	mov	ecx, 17					; 00000011H
	lea	edi, DWORD PTR _trace$6668[ebp]
	rep movsd

; 1308 : 
; 1309 : 		if (trace.fraction == 1.0)

	fld	DWORD PTR _trace$6668[ebp+16]
...
; 1460 : 	dest = pmove->origin + pmove->velocity * pmove->frametime;
	...
	mov	edx, DWORD PTR [ecx+16]
	push	edx
	lea	eax, DWORD PTR $T7735[ebp]
	push	eax
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	add	ecx, 92					; 0000005cH
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T7736[ebp]
	push	ecx
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	add	ecx, 56					; 00000038H
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
...
; 1724 : 			int nReps = 0;
	...
	mov	DWORD PTR _nReps$6817[ebp], 0
...
; 1729 : 				int i = PM_GetRandomStuckOffsets( pmove->player_index, pmove->server, offset );
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _i$6821[ebp], eax

; 1730 : 				test = base + offset;

	lea	eax, DWORD PTR _offset$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T7781[ebp]
	push	ecx
	lea	ecx, DWORD PTR _base$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	edx, DWORD PTR [eax]
...
; 1740 : 			} while( ++nReps < 54 );
	...
	mov	edx, DWORD PTR _nReps$6817[ebp]
	add	edx, 1
	mov	DWORD PTR _nReps$6817[ebp], edx
	cmp	DWORD PTR _nReps$6817[ebp], 54		; 00000036H
	jl	$L6818
$L6820:
...
; 1774 : 		for( float z = 0; z <= (4 * pmove->movevars->stepsize); z += pmove->movevars->stepsize )
	...
	mov	DWORD PTR _z$6831[ebp], 0
	jmp	SHORT $L6832
$L6833:
	mov	edx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	mov	eax, DWORD PTR [edx+324848]
	fld	DWORD PTR _z$6831[ebp]
	fadd	DWORD PTR [eax+48]
	fstp	DWORD PTR _z$6831[ebp]
$L6832:
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	mov	edx, DWORD PTR [ecx+324848]
	fld	DWORD PTR __real@4@40018000000000000000
	fmul	DWORD PTR [edx+48]
	fcomp	DWORD PTR _z$6831[ebp]
	fnstsw	ax
	test	ah, 1
	jne	$L6834
...
; 1776 : 			for( float x = -8.0f; x <= 8.0f; x += 8.0f )
	...
	mov	DWORD PTR _x$6835[ebp], -1056964608	; c1000000H
	jmp	SHORT $L6836
$L6837:
	fld	DWORD PTR _x$6835[ebp]
	fadd	DWORD PTR __real@4@40028000000000000000
	fstp	DWORD PTR _x$6835[ebp]
$L6836:
	fld	DWORD PTR _x$6835[ebp]
...
; 1778 : 				for( float y = -8.0f; y <= 8.0f; y += 8.0f )
	...
	mov	DWORD PTR _y$6839[ebp], -1056964608	; c1000000H
	jmp	SHORT $L6840
$L6841:
	fld	DWORD PTR _y$6839[ebp]
	fadd	DWORD PTR __real@4@40028000000000000000
	fstp	DWORD PTR _y$6839[ebp]
$L6840:
	fld	DWORD PTR _y$6839[ebp]
	fcomp	DWORD PTR __real@4@40028000000000000000
	fnstsw	ax
...
; 1899 : 		for (target = 0; target < pmove->numphysent; target++)
	...
	mov	DWORD PTR _target$6877[ebp], 0
	jmp	SHORT $L6879
$L6880:
	mov	edx, DWORD PTR _target$6877[ebp]
	add	edx, 1
	mov	DWORD PTR _target$6877[ebp], edx
$L6879:
	mov	eax, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	mov	ecx, DWORD PTR _target$6877[ebp]
...
; 2082 : 					float fMore = (VEC_DUCK_HULL_MIN - VEC_HULL_MIN);
	...
	mov	DWORD PTR _fMore$6944[ebp], 1099956224	; 41900000H
...
; 2086 : 					pmove->view_ofs[2] = ((VEC_DUCK_VIEW - fMore ) * duckFraction) + (VEC_VIEW * (1-duckFraction));
	...
	fsub	DWORD PTR _fMore$6944[ebp]
...
; 2111 : 	ladderCenter = pLadder->origin + ( modelmins + modelmaxs ) * 0.5f;
	...
	lea	ecx, DWORD PTR $T7827[ebp]
	push	ecx
	lea	edx, DWORD PTR _modelmaxs$[ebp]
	push	edx
	lea	eax, DWORD PTR $T7826[ebp]
	push	eax
	lea	ecx, DWORD PTR _modelmins$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	ecx, eax
...
; 2133 : 		float forward = 0, right = 0;
	...
	mov	DWORD PTR _forward$6963[ebp], 0
	mov	DWORD PTR _right$6964[ebp], 0

; 2134 : 		Vector vpn, v_right;

	lea	ecx, DWORD PTR _vpn$6965[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
	lea	ecx, DWORD PTR _v_right$6966[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
...
; 2138 : 			forward -= MAX_CLIMB_SPEED;
	...
	fld	DWORD PTR _forward$6963[ebp]
	fsub	DWORD PTR __real@4@4006c800000000000000
	fstp	DWORD PTR _forward$6963[ebp]
$L6967:
...
; 2142 : 			right -= MAX_CLIMB_SPEED;
	...
	fld	DWORD PTR _right$6964[ebp]
	fsub	DWORD PTR __real@4@4006c800000000000000
	fstp	DWORD PTR _right$6964[ebp]
$L6969:
...
; 2155 : 				Vector velocity, cross, lateral, tmp;
	...
	lea	ecx, DWORD PTR _velocity$6976[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
	lea	ecx, DWORD PTR _cross$6977[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
	lea	ecx, DWORD PTR _lateral$6978[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
	lea	ecx, DWORD PTR _tmp$6979[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
...
; 2162 : 				velocity = vpn * forward;
	...
	mov	ecx, DWORD PTR _forward$6963[ebp]
	push	ecx
	lea	edx, DWORD PTR $T7830[ebp]
	push	edx
	lea	ecx, DWORD PTR _vpn$6965[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _velocity$6976[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _velocity$6976[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _velocity$6976[ebp+8], eax

; 2163 : 				velocity += v_right * right;

	mov	ecx, DWORD PTR _right$6964[ebp]
	push	ecx
	lea	edx, DWORD PTR $T7831[ebp]
	push	edx
	lea	ecx, DWORD PTR _v_right$6966[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
...
; 2167 : 				Vector perp = CrossProduct( Vector(0,0,1), trace.plane.normal );
	...
	push	0
	push	0
	lea	ecx, DWORD PTR $T7832[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	ecx, DWORD PTR $T7833[ebp]
	push	ecx
	call	?CrossProduct@@YA?AVVector@@ABV1@0@Z	; CrossProduct
	add	esp, 12					; 0000000cH
	push	eax
	lea	ecx, DWORD PTR _perp$6983[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 2168 : 				perp = perp.Normalize();

	lea	edx, DWORD PTR $T7834[ebp]
	push	edx
	lea	ecx, DWORD PTR _perp$6983[ebp]
	call	?Normalize@Vector@@QBE?AV1@XZ		; Vector::Normalize
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _perp$6983[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _perp$6983[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _perp$6983[ebp+8], eax
...
; 2171 : 				normal = DotProduct( velocity, trace.plane.normal );
	...
	lea	ecx, DWORD PTR _trace$[ebp+32]
	push	ecx
	lea	edx, DWORD PTR _velocity$6976[ebp]
	push	edx
	call	?DotProduct@@YAMABVVector@@0@Z		; DotProduct
	add	esp, 8
	fstp	DWORD PTR _normal$6980[ebp]

; 2172 : 				// This is the velocity into the face of the ladder
; 2173 : 				cross = trace.plane.normal * normal;

	mov	eax, DWORD PTR _normal$6980[ebp]
	push	eax
	lea	ecx, DWORD PTR $T7835[ebp]
	push	ecx
	lea	ecx, DWORD PTR _trace$[ebp+32]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _cross$6977[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _cross$6977[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _cross$6977[ebp+8], edx
...
; 2177 : 				lateral = velocity - cross;
	...
	lea	eax, DWORD PTR _cross$6977[ebp]
	push	eax
	lea	ecx, DWORD PTR $T7836[ebp]
	push	ecx
	lea	ecx, DWORD PTR _velocity$6976[ebp]
	call	??GVector@@QBE?AV0@ABV0@@Z		; Vector::operator-
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _lateral$6978[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _lateral$6978[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _lateral$6978[ebp+8], edx
...
; 2184 : 				tmp = CrossProduct( trace.plane.normal, perp );
	...
	lea	eax, DWORD PTR _perp$6983[ebp]
	push	eax
	lea	ecx, DWORD PTR _trace$[ebp+32]
	push	ecx
	lea	edx, DWORD PTR $T7837[ebp]
	push	edx
	call	?CrossProduct@@YA?AVVector@@ABV1@0@Z	; CrossProduct
	add	esp, 12					; 0000000cH
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _tmp$6979[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _tmp$6979[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _tmp$6979[ebp+8], eax

; 2185 : 				pmove->velocity = lateral + tmp * -normal;

	fld	DWORD PTR _normal$6980[ebp]
	fchs
	push	ecx
	fstp	DWORD PTR [esp]
	lea	ecx, DWORD PTR $T7838[ebp]
	push	ecx
	lea	ecx, DWORD PTR _tmp$6979[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	edx, DWORD PTR $T7839[ebp]
	push	edx
	lea	ecx, DWORD PTR _lateral$6978[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
...
; 2212 : 			hull_t *hull = (hull_t *)pmove->PM_HullForBsp( pe, offset );
	...
	add	esp, 8
	mov	DWORD PTR _hull$7011[ebp], eax

; 2213 : 			int num = hull->firstclipnode;

	mov	ecx, DWORD PTR _hull$7011[ebp]
	mov	edx, DWORD PTR [ecx+8]
	mov	DWORD PTR _num$7013[ebp], edx
...
; 2223 : 				matrix4x4	entityToWorld( offset, pe->angles );
	...
	lea	ecx, DWORD PTR _offset$[ebp]
	push	ecx
	lea	ecx, DWORD PTR _entityToWorld$7016[ebp]
...
; 2228 : 			if( pmove->PM_HullPointContents( hull, num, test ) == CONTENTS_EMPTY )
	...
	call	??BVector@@QAEPAMXZ			; Vector::operator float *
	push	eax
	mov	ecx, DWORD PTR _num$7013[ebp]
	push	ecx
	mov	edx, DWORD PTR _hull$7011[ebp]
	push	edx
	mov	eax, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
...
; 2384 : 		Vector base;
	...
	lea	ecx, DWORD PTR _base$7063[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
...
; 2386 : 		base = g_vecZero;
	...
	mov	ecx, DWORD PTR ?g_vecZero@@3VVector@@B
	mov	DWORD PTR _base$7063[ebp], ecx
	mov	edx, DWORD PTR ?g_vecZero@@3VVector@@B+4
	mov	DWORD PTR _base$7063[ebp+4], edx
	mov	eax, DWORD PTR ?g_vecZero@@3VVector@@B+8
	mov	DWORD PTR _base$7063[ebp+8], eax
...
; 2410 : 		pmove->velocity -= base;
	...
	lea	edx, DWORD PTR _base$7063[ebp]
	push	edx
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	add	ecx, 92					; 0000005cH
	call	??ZVector@@QAEAAV0@ABV0@@Z		; Vector::operator-=
...
; 2437 : 	wishvel = pmove->forward * fmove + pmove->right * smove;
	...
	push	ecx
	lea	edx, DWORD PTR $T7898[ebp]
	push	edx
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	add	ecx, 32					; 00000020H
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	eax, DWORD PTR $T7899[ebp]
	push	eax
	mov	ecx, DWORD PTR _fmove$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T7897[ebp]
	push	edx
	mov	ecx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	add	ecx, 20					; 00000014H
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
...
; 2678 : 		vecEnd = vecStart + flatforward * 24;
	...
	push	1103101952				; 41c00000H
	lea	ecx, DWORD PTR $T7921[ebp]
	push	ecx
	lea	ecx, DWORD PTR _flatforward$[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	edx, DWORD PTR $T7922[ebp]
	push	edx
	lea	ecx, DWORD PTR _vecStart$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	ecx, DWORD PTR [eax]
...
; 2701 : 		float fvol = 0.5;
	...
	mov	DWORD PTR _fvol$7164[ebp], 1056964608	; 3f000000H
...
; 2719 : 			fvol = 1.0;
	...
	mov	DWORD PTR _fvol$7164[ebp], 1065353216	; 3f800000H
...
; 2724 : 			tfc = atoi( pmove->PM_Info_ValueForKey( pmove->physinfo, "tfc" ) ) == 1 ? true : false;
	...
	sete	al
	and	eax, 255				; 000000ffH
	mov	DWORD PTR _tfc$7172[ebp], eax

; 2725 : 
; 2726 : 			if ( tfc )

	cmp	DWORD PTR _tfc$7172[ebp], 0
	je	SHORT $L7173
...
; 2731 : 			fvol = 0.85;
	...
	mov	DWORD PTR _fvol$7164[ebp], 1062836634	; 3f59999aH
...
; 2735 : 			fvol = 0;
	...
	mov	DWORD PTR _fvol$7164[ebp], 0
$L7176:

; 2737 : 
; 2738 : 		if ( fvol > 0.0 )

	fld	DWORD PTR _fvol$7164[ebp]
	fcomp	QWORD PTR __real@8@00000000000000000000
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	$L7178
...
; 2746 : 			PM_PlayStepSound( PM_MapTextureTypeStepType( pmove->chtexturetype ), fvol );
	...
	mov	ecx, DWORD PTR _fvol$7164[ebp]
	push	ecx
	mov	edx, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	mov	al, BYTE PTR [edx+496]
	push	eax
...
; 2876 : 		float fRatio = pmove->maxspeed / spd;
	...
	fld	DWORD PTR [edx+500]
	fdiv	DWORD PTR _spd$[ebp]
	fstp	DWORD PTR _fRatio$7225[ebp]

; 2877 : 		pmove->cmd.forwardmove *= fRatio;

	mov	eax, DWORD PTR ?pmove@@3PAUplayermove_s@@A ; pmove
	fld	DWORD PTR _fRatio$7225[ebp]
