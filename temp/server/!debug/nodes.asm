...
; 66   : 	delete [] m_pBuffer;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T39814[ebp], ecx
	mov	edx, DWORD PTR $T39814[ebp]
	push	edx
...
; 88   : 		int reduced_size = m_iLength - m_iOffset;
	...
	mov	DWORD PTR _reduced_size$36303[ebp], eax

; 89   : 		memcpy( out, m_pBuffer + m_iOffset, reduced_size );

	mov	ecx, DWORD PTR _reduced_size$36303[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 90   : 		m_iOffset += reduced_size;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+8]
	add	ecx, DWORD PTR _reduced_size$36303[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+8], ecx

; 91   : 		read_size = reduced_size;

	mov	eax, DWORD PTR _reduced_size$36303[ebp]
	mov	DWORD PTR _read_size$[ebp], eax
$L36302:
...
; 103  : 		size_t newsize = m_iOffset + size + FS_MEM_BLOCK;
	...
	mov	DWORD PTR _newsize$36311[ebp], ecx
...
; 105  : 		if( m_iBuffSize < newsize )
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	cmp	eax, DWORD PTR _newsize$36311[ebp]
	jae	SHORT $L36312

; 107  : 			// reallocate buffer now
; 108  : 			m_pBuffer = (byte *)realloc( m_pBuffer, newsize );

	mov	ecx, DWORD PTR _newsize$36311[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	push	eax
...
; 109  : 			memset( m_pBuffer + m_iBuffSize, 0, newsize - m_iBuffSize );
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _newsize$36311[ebp]
...
; 110  : 			m_iBuffSize = newsize; // update buffsize
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _newsize$36311[ebp]
	mov	DWORD PTR [ecx+4], edx
$L36312:
...
; 130  : 		size_t newsize = m_iLength + size + FS_MEM_BLOCK;
	...
	mov	eax, DWORD PTR _size$[ebp]
	lea	ecx, DWORD PTR [edx+eax+65535]
	mov	DWORD PTR _newsize$36322[ebp], ecx
...
; 132  : 		if( m_iBuffSize < newsize )
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	cmp	eax, DWORD PTR _newsize$36322[ebp]
	jae	SHORT $L36323

; 134  : 			// reallocate buffer now
; 135  : 			m_pBuffer = (byte *)realloc( m_pBuffer, newsize );

	mov	ecx, DWORD PTR _newsize$36322[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	push	eax
...
; 136  : 			memset( m_pBuffer + m_iBuffSize, 0, newsize - m_iBuffSize );
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _newsize$36322[ebp]
	sub	eax, DWORD PTR [edx+4]
	push	eax
	push	0
	mov	ecx, DWORD PTR _this$[ebp]
...
; 137  : 			m_iBuffSize = newsize; // update buffsize
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _newsize$36322[ebp]
	mov	DWORD PTR [ecx+4], edx
$L36323:
...
; 143  : 	byte *backup = new byte[rp_size];
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T39821[ebp], eax
	mov	ecx, DWORD PTR $T39821[ebp]
...
; 152  : 	delete [] backup;
	...
	mov	DWORD PTR $T39822[ebp], edx
	mov	eax, DWORD PTR $T39822[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 206  : 		delete [] tempbuff;
	...
	mov	DWORD PTR $T39834[ebp], ecx
	mov	edx, DWORD PTR $T39834[ebp]
	push	edx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 211  : 	delete [] tempbuff;
	...
	mov	DWORD PTR $T39835[ebp], eax
	mov	ecx, DWORD PTR $T39835[ebp]
	push	ecx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 224  : 		tempbuff = new char[buff_size];
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T39838[ebp], eax
	mov	edx, DWORD PTR $T39838[ebp]
	mov	DWORD PTR _tempbuff$[ebp], edx
...
; 228  : 		delete [] tempbuff;
	...
	mov	ecx, DWORD PTR _tempbuff$[ebp]
	mov	DWORD PTR $T39839[ebp], ecx
	mov	edx, DWORD PTR $T39839[ebp]
	push	edx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 494  : 		HashSearch(iCurrentNode, iNext, iLink);
	...
	lea	eax, DWORD PTR _iLink$37373[ebp]
	push	eax
...
; 495  : 		if (iLink < 0)
	...
	cmp	DWORD PTR _iLink$37373[ebp], 0
	jge	SHORT $L37374
...
; 500  : 		CLink &link = Link(iLink);
	...
	mov	edx, DWORD PTR _iLink$37373[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Link@CGraph@@QAEAAVCLink@@H@Z		; CGraph::Link
	mov	DWORD PTR _link$37376[ebp], eax

; 501  : 		distance += link.m_flWeight;

	mov	eax, DWORD PTR _link$37376[ebp]
...
; 523  : 		if (ch < 0)
	...
	movsx	edx, BYTE PTR _ch$37390[ebp]
	test	edx, edx
	jge	SHORT $L37391
...
; 527  : 			ch = -ch;
	...
	movsx	eax, BYTE PTR _ch$37390[ebp]
	neg	eax
	mov	BYTE PTR _ch$37390[ebp], al

; 528  : 			if (nCount <= ch)

	movsx	ecx, BYTE PTR _ch$37390[ebp]
...
_queue$37427 = -832
_i$37436 = -836
_flCurrentDistance$37443 = -840
_pCurrentNode$37445 = -844
_flOurDistance$37452 = -848
...
; 604  : 		int iCap = CapIndex( afCapMask );
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?CapIndex@CGraph@@QAEHH@Z		; CGraph::CapIndex
	mov	DWORD PTR _iCap$37419[ebp], eax
...
; 617  : 			iNext = NextNodeInRoute( iCurrentNode, iDest, iHull, iCap );
	...
	mov	eax, DWORD PTR _iCap$37419[ebp]
	push	eax
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?NextNodeInRoute@CGraph@@QAEHHHHH@Z	; CGraph::NextNodeInRoute
	mov	DWORD PTR _iNext$37420[ebp], eax

; 618  : 			if (iCurrentNode == iNext)

	mov	ecx, DWORD PTR _iCurrentNode$[ebp]
	cmp	ecx, DWORD PTR _iNext$37420[ebp]
	jne	SHORT $L37424
...
; 629  : 			piPath[iNumPathNodes++] = iNext;
	...
	mov	eax, DWORD PTR _piPath$[ebp]
	mov	ecx, DWORD PTR _iNext$37420[ebp]
...
; 630  : 			iCurrentNode = iNext;
	...
	mov	eax, DWORD PTR _iNext$37420[ebp]
...
; 636  : 		CQueuePriority	queue;
	...
	lea	ecx, DWORD PTR _queue$37427[ebp]
...
; 656  : 		for ( int i = 0; i < m_cNodes; i++)
	...
	mov	DWORD PTR _i$37436[ebp], 0
	jmp	SHORT $L37437
$L37438:
	mov	eax, DWORD PTR _i$37436[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37436[ebp], eax
$L37437:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _i$37436[ebp]
...
; 669  : 			iCurrentNode = queue.Remove(flCurrentDistance);
	...
	lea	eax, DWORD PTR _flCurrentDistance$37443[ebp]
	push	eax
	lea	ecx, DWORD PTR _queue$37427[ebp]
...
; 676  : 			CNode *pCurrentNode = &m_pNodes[ iCurrentNode ];
	...
	mov	ecx, DWORD PTR [eax+12]
	add	ecx, edx
	mov	DWORD PTR _pCurrentNode$37445[ebp], ecx
...
$L37447:
	mov	edx, DWORD PTR _i$37436[ebp]
	add	edx, 1
	mov	DWORD PTR _i$37436[ebp], edx
$L37446:
	mov	eax, DWORD PTR _pCurrentNode$37445[ebp]
	mov	ecx, DWORD PTR _i$37436[ebp]
...
; 682  : 				if ( ( m_pLinkPool[  m_pNodes[ iCurrentNode ].m_iFirstLink + i ].m_afLinkInfo & iHullMask ) != iHullMask )
	...
	add	ecx, DWORD PTR _i$37436[ebp]
...
; 688  : 				if ( m_pLinkPool[ m_pNodes[ iCurrentNode ].m_iFirstLink + i ].m_pLinkEnt != NULL )
	...
	add	edx, DWORD PTR _i$37436[ebp]
...
; 691  : 					if ( !HandleLinkEnt ( iCurrentNode, m_pLinkPool[ m_pNodes[ iCurrentNode ].m_iFirstLink + i ].m_pLinkEnt, afCapMask, NODEGRAPH_STATIC ) )
	...
	add	eax, DWORD PTR _i$37436[ebp]
	imul	eax, 24					; 00000018H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+16]
...
; 696  : 				float flOurDistance = flCurrentDistance + m_pLinkPool[ m_pNodes[ iCurrentNode ].m_iFirstLink + i].m_flWeight;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+16]
	fld	DWORD PTR _flCurrentDistance$37443[ebp]
	fadd	DWORD PTR [ecx+edx+20]
	fstp	DWORD PTR _flOurDistance$37452[ebp]
...
; 698  : 				   || flOurDistance < m_pNodes[ iVisitNode ].m_flClosestSoFar - 0.001 )
	...
	test	ah, 1
	jne	SHORT $L37454
	fld	DWORD PTR _flOurDistance$37452[ebp]
	mov	edx, DWORD PTR _iVisitNode$[ebp]
	imul	edx, 88					; 00000058H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
...
; 700  : 					m_pNodes[iVisitNode].m_flClosestSoFar = flOurDistance;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	mov	eax, DWORD PTR _flOurDistance$37452[ebp]
...
; 725  : 		for ( i = iNumPathNodes - 1 ; i >= 0 ; i-- )
	...
	mov	ecx, DWORD PTR _iNumPathNodes$[ebp]
	sub	ecx, 1
	mov	DWORD PTR _i$37436[ebp], ecx
	jmp	SHORT $L37459
$L37460:
	mov	edx, DWORD PTR _i$37436[ebp]
	sub	edx, 1
...
; 822  : 		TraceResult tr;
	...
	lea	ecx, DWORD PTR _tr$37500[ebp]
	call	??0gametrace_s@@QAE@XZ			; gametrace_s::gametrace_s
...
; 825  : 		UTIL_TraceLine ( vecOrigin, m_pNodes[ iNode ].m_vecOriginPeek, ignore_monsters, 0, &tr );
	...
	lea	edx, DWORD PTR _tr$37500[ebp]
	push	edx
	push	0
	push	1
	mov	eax, DWORD PTR _iNode$[ebp]
...
; 827  : 		if ( tr.flFraction == 1.0 )
	...
	fld	DWORD PTR _tr$37500[ebp+16]
...
; 888  : 		for (int i = 0; i < m_cNodes; i++)
	...
	mov	DWORD PTR _i$37522[ebp], 0
	jmp	SHORT $L37523
$L37524:
	mov	edx, DWORD PTR _i$37522[ebp]
	add	edx, 1
	mov	DWORD PTR _i$37522[ebp], edx
$L37523:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$37522[ebp]
	cmp	ecx, DWORD PTR [eax+24]
	jge	SHORT $L37525
...
; 932  : 			int rgY = m_pNodes[m_di[j].m_SortedBy[0]].m_Region[1];
	...
	mov	DWORD PTR _rgY$37537[ebp], eax

; 933  : 			if (rgY > m_maxBoxY) break;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgY$37537[ebp]
...
; 934  :             if (rgY < m_minBoxY) continue;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _rgY$37537[ebp]
...
; 936  : 			int rgZ = m_pNodes[m_di[j].m_SortedBy[0]].m_Region[2];
	...
	mov	DWORD PTR _rgZ$37540[ebp], eax

; 937  :             if (rgZ < m_minBoxZ) continue;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgZ$37540[ebp]
...
; 938  :             if (rgZ > m_maxBoxZ) continue;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _rgZ$37540[ebp]
...
; 949  : 			int rgZ = m_pNodes[m_di[j].m_SortedBy[1]].m_Region[2];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+26]
	mov	DWORD PTR _rgZ$37551[ebp], ecx

; 950  :             if (rgZ > m_maxBoxZ) break;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rgZ$37551[ebp]
...
; 951  :             if (rgZ < m_minBoxZ) continue;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgZ$37551[ebp]
	cmp	edx, DWORD PTR [ecx+6224]
	jge	SHORT $L37553
	jmp	$L37548
$L37553:
...
; 952  : 			int rgX = m_pNodes[m_di[j].m_SortedBy[1]].m_Region[0];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+24]
	mov	DWORD PTR _rgX$37554[ebp], ecx

; 953  :             if (rgX < m_minBoxX) continue;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rgX$37554[ebp]
...
; 954  :             if (rgX > m_maxBoxX) continue;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgX$37554[ebp]
...
; 965  : 			int rgX = m_pNodes[m_di[j].m_SortedBy[2]].m_Region[0];
	...
	mov	DWORD PTR _rgX$37565[ebp], eax

; 966  :             if (rgX > m_maxBoxX) break;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgX$37565[ebp]
	cmp	edx, DWORD PTR [ecx+6228]
	jle	SHORT $L37566
	jmp	$L37563
$L37566:
...
; 967  :             if (rgX < m_minBoxX) continue;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _rgX$37565[ebp]
...
; 968  : 			int rgY = m_pNodes[m_di[j].m_SortedBy[2]].m_Region[1];
	...
	xor	eax, eax
	mov	al, BYTE PTR [ecx+edx+25]
	mov	DWORD PTR _rgY$37568[ebp], eax

; 969  :             if (rgY < m_minBoxY) continue;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgY$37568[ebp]
...
; 970  : 			if (rgY > m_maxBoxY) continue;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _rgY$37568[ebp]
...
; 981  : 			int rgY = m_pNodes[m_di[j].m_SortedBy[0]].m_Region[1];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+25]
	mov	DWORD PTR _rgY$37579[ebp], ecx

; 982  : 			if (rgY > m_maxBoxY) break;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rgY$37579[ebp]
...
; 983  :             if (rgY < m_minBoxY) continue;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgY$37579[ebp]
	cmp	edx, DWORD PTR [ecx+6220]
	jge	SHORT $L37581
	jmp	$L37576
$L37581:
...
; 985  : 			int rgZ = m_pNodes[m_di[j].m_SortedBy[0]].m_Region[2];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+26]
	mov	DWORD PTR _rgZ$37582[ebp], ecx

; 986  :             if (rgZ < m_minBoxZ) continue;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rgZ$37582[ebp]
...
; 987  :             if (rgZ > m_maxBoxZ) continue;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgZ$37582[ebp]
...
; 998  : 			int rgZ = m_pNodes[m_di[j].m_SortedBy[1]].m_Region[2];
	...
	xor	eax, eax
	mov	al, BYTE PTR [ecx+edx+26]
	mov	DWORD PTR _rgZ$37593[ebp], eax

; 999  :             if (rgZ > m_maxBoxZ) break;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgZ$37593[ebp]
	cmp	edx, DWORD PTR [ecx+6236]
	jle	SHORT $L37594
	jmp	$L37591
$L37594:
...
; 1000 :             if (rgZ < m_minBoxZ) continue;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _rgZ$37593[ebp]
...
; 1001 : 			int rgX = m_pNodes[m_di[j].m_SortedBy[1]].m_Region[0];
	...
	xor	eax, eax
	mov	al, BYTE PTR [ecx+edx+24]
	mov	DWORD PTR _rgX$37596[ebp], eax

; 1002 :             if (rgX < m_minBoxX) continue;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgX$37596[ebp]
...
; 1003 :             if (rgX > m_maxBoxX) continue;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _rgX$37596[ebp]
...
; 1014 : 			int rgX = m_pNodes[m_di[j].m_SortedBy[2]].m_Region[0];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+24]
	mov	DWORD PTR _rgX$37607[ebp], ecx

; 1015 :             if (rgX > m_maxBoxX) break;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rgX$37607[ebp]
...
; 1016 :             if (rgX < m_minBoxX) continue;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgX$37607[ebp]
	cmp	edx, DWORD PTR [ecx+6216]
	jge	SHORT $L37609
	jmp	$L37604
$L37609:
...
; 1017 : 			int rgY = m_pNodes[m_di[j].m_SortedBy[2]].m_Region[1];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+25]
	mov	DWORD PTR _rgY$37610[ebp], ecx

; 1018 :             if (rgY < m_minBoxY) continue;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rgY$37610[ebp]
...
; 1019 : 			if (rgY > m_maxBoxY) continue;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _rgY$37610[ebp]
	cmp	edx, DWORD PTR [ecx+6232]
	jle	SHORT $L37612
	jmp	$L37604
$L37612:
...
; 1374 : 			vec2DirToCheckNode = ( pCheckNode->m_vecOrigin - pSrcNode->m_vecOrigin ).Make2D(); 
	...
	lea	edx, DWORD PTR $T40005[ebp]
	push	edx
	mov	eax, DWORD PTR _pSrcNode$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T40004[ebp]
	push	ecx
...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T40047[ebp], eax
	mov	ecx, DWORD PTR $T40047[ebp]
...
; 200  : 			delete m_Names[i];
	...
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR $T40052[ebp], edx
	mov	eax, DWORD PTR $T40052[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
...
; 1541 : 		CTestHull *pHull = GetClassPtr((CTestHull *)NULL);
	...
	add	esp, 4
	mov	DWORD PTR _pHull$37899[ebp], eax
...
; 1542 : 		pHull->Spawn( pev );
	...
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	ecx, DWORD PTR _pHull$37899[ebp]
...
; 1588 : 	UTIL_ParticleEffect ( absOrigin - gpGlobals->v_right * 64, g_vecZero, 255, 25 );
	...
	push	OFFSET FLAT:?g_vecZero@@3VVector@@B	; g_vecZero
	push	1115684864				; 42800000H
	lea	ecx, DWORD PTR $T40092[ebp]
	push	ecx
	mov	ecx, DWORD PTR ?gpGlobals@@3PAUglobalvars_t@@A ; gpGlobals
	add	ecx, 64					; 00000040H
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	edx, DWORD PTR $T40093[ebp]
	push	edx
	lea	ecx, DWORD PTR _absOrigin$[ebp]
	call	??GVector@@QBE?AV0@ABV0@@Z		; Vector::operator-
	push	eax
...
_tr$37990 = -568
_trEnt$37993 = -624
_SaveFlags$38038 = -628
_MoveMode$38039 = -632
_fWalkFailed$38043 = -636
_stepSize$38047 = -640
$T40108 = -720
$T40109 = -732
$T40110 = -744
...
; 1705 : 			TraceResult	tr;
	...
	lea	ecx, DWORD PTR _tr$37990[ebp]
	call	??0gametrace_s@@QAE@XZ			; gametrace_s::gametrace_s
...
; 1714 : 			TraceResult	trEnt;
	...
	lea	ecx, DWORD PTR _trEnt$37993[ebp]
	call	??0gametrace_s@@QAE@XZ			; gametrace_s::gametrace_s
...
; 1719 : 				 &trEnt );
	...
	lea	edx, DWORD PTR _trEnt$37993[ebp]
	push	edx
	mov	eax, DWORD PTR ?g_pBodyQueueHead@@3PAUedict_s@@A ; g_pBodyQueueHead
	push	eax
	push	0
...
; 1723 : 			if ( trEnt.flFraction < tr.flFraction )
	...
	fld	DWORD PTR _trEnt$37993[ebp+16]
	fcomp	DWORD PTR _tr$37990[ebp+16]
	fnstsw	ax
	test	ah, 1
	je	SHORT $L37997
...
; 1726 : 				if ( trEnt.pHit && (trEnt.pHit->v.flags & FL_WORLDBRUSH) )
	...
	cmp	DWORD PTR _trEnt$37993[ebp+48], 0
	je	SHORT $L37997
	mov	edx, DWORD PTR _trEnt$37993[ebp+48]
...
; 1727 : 					tr.vecEndPos = trEnt.vecEndPos;
	...
	mov	ecx, DWORD PTR _trEnt$37993[ebp+20]
	mov	DWORD PTR _tr$37990[ebp+20], ecx
	mov	edx, DWORD PTR _trEnt$37993[ebp+24]
	mov	DWORD PTR _tr$37990[ebp+24], edx
	mov	eax, DWORD PTR _trEnt$37993[ebp+28]
	mov	DWORD PTR _tr$37990[ebp+28], eax
$L37997:

; 1731 : 				WorldGraph.m_pNodes[i].m_vecOrigin.z = tr.vecEndPos.z + NODE_HEIGHT;

	fld	DWORD PTR _tr$37990[ebp+28]
	fadd	DWORD PTR __real@4@40028000000000000000
	mov	ecx, DWORD PTR _i$[ebp]
	imul	ecx, 88					; 00000058H
	mov	edx, DWORD PTR ?WorldGraph@@3VCGraph@@A+12
...
; 1792 : 					UTIL_SetSize(pev, Vector(-32, -32, 0), Vector(32, 32, 64));
	...
	push	1107296256				; 42000000H
	lea	ecx, DWORD PTR $T40116[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	push	0
	push	-1040187392				; c2000000H
	push	-1040187392				; c2000000H
	lea	ecx, DWORD PTR $T40117[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
...
; 1827 : 					int SaveFlags = pev->flags;
	...
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR [ecx+420]
	mov	DWORD PTR _SaveFlags$38038[ebp], edx

; 1828 : 					int MoveMode = WALKMOVE_WORLDONLY;

	mov	DWORD PTR _MoveMode$38039[ebp], 1
...
; 1832 : 						MoveMode = WALKMOVE_NORMAL;
	...
	mov	DWORD PTR _MoveMode$38039[ebp], 0
$L38040:
...
; 1839 : 					int fWalkFailed = FALSE;
	...
	mov	DWORD PTR _fWalkFailed$38043[ebp], 0
...
$L38044:
	...
	test	ah, 1
	je	$L38046
	cmp	DWORD PTR _fWalkFailed$38043[ebp], 0
	jne	$L38046

; 1844 : 						float stepSize = HULL_STEP_SIZE;

	mov	DWORD PTR _stepSize$38047[ebp], 1098907648 ; 41800000H

; 1845 : 
; 1846 : 						if ( (step + stepSize) >= (flDist-1) )

	fild	DWORD PTR _step$[ebp]
	fadd	DWORD PTR _stepSize$38047[ebp]
	fld	DWORD PTR _flDist$[ebp]
...
; 1847 : 							stepSize = (flDist - step) - 1;
	...
	fsub	DWORD PTR __real@4@3fff8000000000000000
	fstp	DWORD PTR _stepSize$38047[ebp]
$L38048:

; 1848 : 
; 1849 : 						if ( !WALK_MOVE( ENT(pev), flYaw, stepSize, MoveMode ) )

	mov	ecx, DWORD PTR _MoveMode$38039[ebp]
	push	ecx
	mov	edx, DWORD PTR _stepSize$38047[ebp]
	push	edx
...
; 1852 : 							fWalkFailed = TRUE;
	...
	mov	DWORD PTR _fWalkFailed$38043[ebp], 1
...
; 1888 : 					pev->flags = SaveFlags;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, DWORD PTR _SaveFlags$38038[ebp]
...
; 1892 : 					TraceResult tr;
	...
	lea	ecx, DWORD PTR _tr$38064[ebp]
	call	??0gametrace_s@@QAE@XZ			; gametrace_s::gametrace_s
...
; 1894 : 					UTIL_TraceHull( pSrcNode->m_vecOrigin + Vector( 0, 0, 32 ), pDestNode->m_vecOriginPeek + Vector( 0, 0, 32 ), ignore_monsters, large_hull, ENT( pev ), &tr );
	...
	lea	eax, DWORD PTR _tr$38064[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
...
; 1895 : 					if (tr.fStartSolid || tr.flFraction < 1.0)
	...
	cmp	DWORD PTR _tr$38064[ebp+4], 0
	jne	SHORT $L38070
	fld	DWORD PTR _tr$38064[ebp+16]
	fcomp	QWORD PTR __real@8@3fff8000000000000000
	fnstsw	ax
	test	ah, 1
	je	SHORT $L38069
...
; 1974 : 			WorldGraph.HashSearch(WorldGraph.INodeLink(i,j), i, iLink);
	...
	lea	edx, DWORD PTR _iLink$38096[ebp]
	push	edx
	mov	eax, DWORD PTR _i$[ebp]
	push	eax
	mov	ecx, DWORD PTR _j$[ebp]
...
; 1975 : 			if (iLink < 0)
	...
	cmp	DWORD PTR _iLink$38096[ebp], 0
	jge	SHORT $L38097
...
; 2251 : 		int rightchild = HEAP_RIGHT_CHILD(parent);
	...
	mov	DWORD PTR _rightchild$38201[ebp], ecx

; 2252 : 		if (rightchild < m_cSize)

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _rightchild$38201[ebp]
	cmp	eax, DWORD PTR [edx]
	jge	SHORT $L38203

; 2254 : 			if ( m_heap[ rightchild ].Priority < m_heap[ child ].Priority )

	mov	ecx, DWORD PTR _rightchild$38201[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
; 2274 : 		int parent = HEAP_PARENT(child);
	...
	sub	eax, edx
	sar	eax, 1
	mov	DWORD PTR _parent$38213[ebp], eax

; 2275 : 		if ( m_heap[ parent ].Priority <= m_heap[ child ].Priority )

	mov	edx, DWORD PTR _parent$38213[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _child$[ebp]
	mov	esi, DWORD PTR _this$[ebp]
...
; 2279 : 		Tmp = m_heap[ child ];
	...
	mov	DWORD PTR _Tmp$38215[ebp], ecx
	mov	DWORD PTR _Tmp$38215[ebp+4], edx

; 2280 : 		m_heap[ child ] = m_heap[ parent ];

	mov	eax, DWORD PTR _parent$38213[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+eax*8+4]
	mov	eax, DWORD PTR [ecx+eax*8+8]
	mov	ecx, DWORD PTR _child$[ebp]
...
; 2281 : 		m_heap[ parent ] = Tmp;
	...
	mov	edx, DWORD PTR _parent$38213[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _Tmp$38215[ebp]
	mov	DWORD PTR [eax+edx*8+4], ecx
	mov	ecx, DWORD PTR _Tmp$38215[ebp+4]
...
; 2415 : 		for (int i = 0; i < m_cNodes; i++)
	...
	mov	DWORD PTR _i$38283[ebp], 0
	jmp	SHORT $L38284
$L38285:
	mov	eax, DWORD PTR _i$38283[ebp]
	add	eax, 1
	mov	DWORD PTR _i$38283[ebp], eax
$L38284:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _i$38283[ebp]
	cmp	edx, DWORD PTR [ecx+24]
	jge	SHORT $L38286
...
; 2463 : }
	...
	jmp	SHORT $ShortFile$38234
$L38296:
	jmp	SHORT $NoMemory$38251
$L38289:
	jmp	SHORT $ShortFile$38234
$L38282:
	jmp	SHORT $NoMemory$38251
...
; 2519 : 			return true;
	...
	mov	DWORD PTR $T40180[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _file$[ebp]
	call	??1CVirtualFS@@QAE@XZ			; CVirtualFS::~CVirtualFS
	mov	eax, DWORD PTR $T40180[ebp]
	jmp	SHORT $L38307
$L38326:
...
; 2523 : 	return (iResult == LUMP_SAVE_OK) ? true : false;
	...
	mov	DWORD PTR $T40182[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _file$[ebp]
	call	??1CVirtualFS@@QAE@XZ			; CVirtualFS::~CVirtualFS
	mov	eax, DWORD PTR $T40182[ebp]
$L38307:
...
; 2549 : 			memcpy( name, m_pLinkPool[ i ].m_szLinkEntModelname, 4 );
	...
	lea	eax, DWORD PTR [edx+eax+12]
	push	eax
	lea	ecx, DWORD PTR _name$38340[ebp]
	push	ecx
	call	_memcpy
	add	esp, 12					; 0000000cH
...
; 2550 : 			name[4] = 0;
	...
	mov	BYTE PTR _name$38340[ebp+4], 0

; 2551 : 			pLinkEnt =  UTIL_FindEntityByString( NULL, "model", name );

	lea	edx, DWORD PTR _name$38340[ebp]
	push	edx
...
; 2557 : 				ALERT ( at_aiconsole, "**Could not find model %s\n", name );
	...
	lea	eax, DWORD PTR _name$38340[ebp]
	push	eax
...
; 2675 : 		CLink &link = Link(m_pHashLinks[i]);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Link@CGraph@@QAEAAVCLink@@H@Z		; CGraph::Link
	mov	DWORD PTR _link$38399[ebp], eax

; 2676 :         if (iSrcNode == link.m_iSrcNode && iDestNode == link.m_iDestNode)

	mov	ecx, DWORD PTR _link$38399[ebp]
	mov	edx, DWORD PTR _iSrcNode$[ebp]
	cmp	edx, DWORD PTR [ecx]
	jne	SHORT $L38400
	mov	eax, DWORD PTR _link$38399[ebp]
...
; 2722 :         int Lower = Primes[0];
	...
	mov	DWORD PTR _Lower$38417[ebp], eax

; 2723 :         for (int jPrime = 0; Primes[jPrime] != 0; jPrime++)

	mov	DWORD PTR _jPrime$38418[ebp], 0
	jmp	SHORT $L38419
$L38420:
	mov	ecx, DWORD PTR _jPrime$38418[ebp]
	add	ecx, 1
	mov	DWORD PTR _jPrime$38418[ebp], ecx
$L38419:
	mov	edx, DWORD PTR _jPrime$38418[ebp]
	cmp	DWORD PTR ?Primes@@3PAHA[edx*4], 0
	je	$L38421

; 2725 :             if (jPrime != 0 && TableSize % Primes[jPrime] == 0) continue;

	cmp	DWORD PTR _jPrime$38418[ebp], 0
	je	SHORT $L38422
	mov	ecx, DWORD PTR _jPrime$38418[ebp]
	mov	eax, DWORD PTR _TableSize$[ebp]
	cdq
...
; 2726 :             int Upper = Primes[jPrime];
	...
	mov	DWORD PTR _Upper$38423[ebp], eax

; 2727 :             if (Lower <= iZone && iZone <= Upper)

	mov	ecx, DWORD PTR _Lower$38417[ebp]
	cmp	ecx, DWORD PTR _iZone$[ebp]
	jg	SHORT $L38424
	mov	edx, DWORD PTR _iZone$[ebp]
	cmp	edx, DWORD PTR _Upper$38423[ebp]
	jg	SHORT $L38424
...
; 2731 :                 if (iZone - Lower <= Upper - iZone)
	...
	sub	eax, DWORD PTR _Lower$38417[ebp]
	mov	ecx, DWORD PTR _Upper$38423[ebp]
...
; 2737 :                     m_HashPrimes[iPrime++] = Upper;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _Upper$38423[ebp]
...
; 2741 :             Lower = Upper;
	...
	mov	ecx, DWORD PTR _Upper$38423[ebp]
	mov	DWORD PTR _Lower$38417[ebp], ecx
...
; 2760 :         m_HashPrimes[15-iPrime] = Temp;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _Temp$38434[ebp]
	mov	DWORD PTR [eax+edx*4+8316], ecx
...
; 2784 : 		for (int j = 0 ; j < m_pNodes[i].m_cNumLinks; j++ )
	...
	mov	DWORD PTR _j$38448[ebp], 0
	jmp	SHORT $L38449
$L38450:
	mov	ecx, DWORD PTR _j$38448[ebp]
	add	ecx, 1
	mov	DWORD PTR _j$38448[ebp], ecx
$L38449:
	mov	edx, DWORD PTR _i$[ebp]
	imul	edx, 88					; 00000058H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	mov	eax, DWORD PTR _j$38448[ebp]
...
; 2786 : 			int iDestNode = INodeLink(i, j);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?INodeLink@CGraph@@QAEHHH@Z		; CGraph::INodeLink
	mov	DWORD PTR _iDestNode$38452[ebp], eax

; 2787 : 			if (m_pNodes[iDestNode].m_iPreviousNode == UNNUMBERED_NODE)

	mov	eax, DWORD PTR _iDestNode$38452[ebp]
	imul	eax, 88					; 00000058H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+12]
...
; 2821 : 			int iDestNode = m_pNodes[i].m_iPreviousNode;
	...
	mov	DWORD PTR _iDestNode$38467[ebp], ecx

; 2822 : 			CNode TempNode = m_pNodes[iDestNode];

	mov	edx, DWORD PTR _iDestNode$38467[ebp]
	imul	edx, 88					; 00000058H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	add	ecx, edx
	push	ecx
	lea	ecx, DWORD PTR _TempNode$38468[ebp]
...
; 2823 : 			m_pNodes[iDestNode] = m_pNodes[i];
	...
	add	esi, edx
	mov	ecx, DWORD PTR _iDestNode$38467[ebp]
	imul	ecx, 88					; 00000058H
	mov	edx, DWORD PTR _this$[ebp]
...
; 2824 : 			m_pNodes[i] = TempNode;
	...
	add	edi, eax
	mov	ecx, 22					; 00000016H
	lea	esi, DWORD PTR _TempNode$38468[ebp]
	rep movsd
...
; 2847 : 		CLink &link = Link(i);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?Link@CGraph@@QAEAAVCLink@@H@Z		; CGraph::Link
	mov	DWORD PTR _link$38487[ebp], eax

; 2848 : 		HashInsert(link.m_iSrcNode, link.m_iDestNode, i);

	mov	ecx, DWORD PTR _i$[ebp]
	push	ecx
	mov	edx, DWORD PTR _link$38487[ebp]
	mov	eax, DWORD PTR [edx+4]
	push	eax
	mov	ecx, DWORD PTR _link$38487[ebp]
	mov	edx, DWORD PTR [ecx]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 2910 : 		for (int j = 0; j < NUM_RANGES; j++)
	...
	mov	DWORD PTR _j$38516[ebp], 0
	jmp	SHORT $L38517
$L38518:
	mov	eax, DWORD PTR _j$38516[ebp]
	add	eax, 1
	mov	DWORD PTR _j$38516[ebp], eax
$L38517:
	cmp	DWORD PTR _j$38516[ebp], 256		; 00000100H
	jge	SHORT $L38519
...
; 2912 : 			m_RangeStart[i][j] = 255;
	...
	mov	edx, DWORD PTR _this$[ebp]
	lea	eax, DWORD PTR [edx+ecx+40]
	mov	ecx, DWORD PTR _j$38516[ebp]
...
; 2913 : 			m_RangeEnd[i][j] = 0;
	...
	mov	edx, DWORD PTR _j$38516[ebp]
...
$L38524:
	mov	edx, DWORD PTR _j$38516[ebp]
	add	edx, 1
	mov	DWORD PTR _j$38516[ebp], edx
$L38523:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+24]
	sub	ecx, 1
	cmp	DWORD PTR _j$38516[ebp], ecx
	jge	$L38525
...
; 2922 : 			int jNode = m_di[j].m_SortedBy[i];
	...
	mov	DWORD PTR _jNode$38526[ebp], eax

; 2923 : 			int jCodeX = m_pNodes[jNode].m_Region[0];

	mov	ecx, DWORD PTR _jNode$38526[ebp]
	imul	ecx, 88					; 00000058H
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+12]
	xor	edx, edx
	mov	dl, BYTE PTR [eax+ecx+24]
	mov	DWORD PTR _jCodeX$38527[ebp], edx

; 2924 : 			int jCodeY = m_pNodes[jNode].m_Region[1];

	mov	eax, DWORD PTR _jNode$38526[ebp]
	imul	eax, 88					; 00000058H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+12]
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+25]
	mov	DWORD PTR _jCodeY$38528[ebp], ecx

; 2925 : 			int jCodeZ = m_pNodes[jNode].m_Region[2];

	mov	edx, DWORD PTR _jNode$38526[ebp]
	imul	edx, 88					; 00000058H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	xor	eax, eax
	mov	al, BYTE PTR [ecx+edx+26]
	mov	DWORD PTR _jCodeZ$38529[ebp], eax
...
; 2930 : 				jCode = (jCodeX << 16) + (jCodeY << 8) + jCodeZ;
	...
	mov	edx, DWORD PTR _jCodeX$38527[ebp]
	shl	edx, 16					; 00000010H
	mov	eax, DWORD PTR _jCodeY$38528[ebp]
	shl	eax, 8
	mov	ecx, DWORD PTR _jCodeZ$38529[ebp]
	add	ecx, edx
	add	eax, ecx
	mov	DWORD PTR _jCode$38530[ebp], eax
...
; 2933 : 				jCode = (jCodeY << 16) + (jCodeZ << 8) + jCodeX;
	...
	mov	edx, DWORD PTR _jCodeY$38528[ebp]
	shl	edx, 16					; 00000010H
	mov	eax, DWORD PTR _jCodeZ$38529[ebp]
	shl	eax, 8
	mov	ecx, DWORD PTR _jCodeX$38527[ebp]
	add	ecx, edx
	add	eax, ecx
	mov	DWORD PTR _jCode$38530[ebp], eax
...
; 2936 : 				jCode = (jCodeZ << 16) + (jCodeX << 8) + jCodeY;
	...
	mov	edx, DWORD PTR _jCodeZ$38529[ebp]
	shl	edx, 16					; 00000010H
	mov	eax, DWORD PTR _jCodeX$38527[ebp]
	shl	eax, 8
	mov	ecx, DWORD PTR _jCodeY$38528[ebp]
	add	ecx, edx
	add	eax, ecx
	mov	DWORD PTR _jCode$38530[ebp], eax
$L38532:
...
; 2940 : 			for (int k = j+1; k < m_cNodes; k++)
	...
	mov	edx, DWORD PTR _j$38516[ebp]
	add	edx, 1
	mov	DWORD PTR _k$38538[ebp], edx
	jmp	SHORT $L38539
$L38540:
	mov	eax, DWORD PTR _k$38538[ebp]
	add	eax, 1
	mov	DWORD PTR _k$38538[ebp], eax
$L38539:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _k$38538[ebp]
	cmp	edx, DWORD PTR [ecx+24]
	jge	$L38541
...
; 2942 : 				int kNode = m_di[k].m_SortedBy[i];
	...
	mov	DWORD PTR _kNode$38542[ebp], ecx

; 2943 : 				int kCodeX = m_pNodes[kNode].m_Region[0];

	mov	edx, DWORD PTR _kNode$38542[ebp]
	imul	edx, 88					; 00000058H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	xor	eax, eax
	mov	al, BYTE PTR [ecx+edx+24]
	mov	DWORD PTR _kCodeX$38543[ebp], eax

; 2944 : 				int kCodeY = m_pNodes[kNode].m_Region[1];

	mov	ecx, DWORD PTR _kNode$38542[ebp]
	imul	ecx, 88					; 00000058H
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+12]
	xor	edx, edx
	mov	dl, BYTE PTR [eax+ecx+25]
	mov	DWORD PTR _kCodeY$38544[ebp], edx

; 2945 : 				int kCodeZ = m_pNodes[kNode].m_Region[2];

	mov	eax, DWORD PTR _kNode$38542[ebp]
	imul	eax, 88					; 00000058H
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+12]
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+26]
	mov	DWORD PTR _kCodeZ$38545[ebp], ecx
...
; 2950 : 					kCode = (kCodeX << 16) + (kCodeY << 8) + kCodeZ;
	...
	mov	eax, DWORD PTR _kCodeX$38543[ebp]
	shl	eax, 16					; 00000010H
	mov	ecx, DWORD PTR _kCodeY$38544[ebp]
	shl	ecx, 8
	mov	edx, DWORD PTR _kCodeZ$38545[ebp]
	add	edx, eax
	add	ecx, edx
	mov	DWORD PTR _kCode$38546[ebp], ecx
...
; 2953 : 					kCode = (kCodeY << 16) + (kCodeZ << 8) + kCodeX;
	...
	mov	eax, DWORD PTR _kCodeY$38544[ebp]
	shl	eax, 16					; 00000010H
	mov	ecx, DWORD PTR _kCodeZ$38545[ebp]
	shl	ecx, 8
	mov	edx, DWORD PTR _kCodeX$38543[ebp]
	add	edx, eax
	add	ecx, edx
	mov	DWORD PTR _kCode$38546[ebp], ecx
...
; 2956 : 					kCode = (kCodeZ << 16) + (kCodeX << 8) + kCodeY;
	...
	mov	eax, DWORD PTR _kCodeZ$38545[ebp]
	shl	eax, 16					; 00000010H
	mov	ecx, DWORD PTR _kCodeX$38543[ebp]
	shl	ecx, 8
	mov	edx, DWORD PTR _kCodeY$38544[ebp]
	add	edx, eax
	add	ecx, edx
	mov	DWORD PTR _kCode$38546[ebp], ecx
$L38548:
...
; 2960 : 				if (kCode < jCode)
	...
	mov	eax, DWORD PTR _kCode$38546[ebp]
	cmp	eax, DWORD PTR _jCode$38530[ebp]
	jge	SHORT $L38554
...
; 2964 : 					int Tmp = m_di[j].m_SortedBy[i];
	...
	mov	DWORD PTR _Tmp$38555[ebp], edx
...
; 2966 : 					m_di[k].m_SortedBy[i] = Tmp;
	...
	add	edx, eax
	mov	eax, DWORD PTR _i$[ebp]
	mov	ecx, DWORD PTR _Tmp$38555[ebp]
	mov	DWORD PTR [edx+eax*4], ecx
$L38554:
...
; 2976 : 		int CodeX = m_pNodes[m_di[i].m_SortedBy[0]].m_Region[0];
	...
	xor	eax, eax
	mov	al, BYTE PTR [ecx+edx+24]
	mov	DWORD PTR _CodeX$38559[ebp], eax
...
; 2977 : 		int CodeY = m_pNodes[m_di[i].m_SortedBy[1]].m_Region[1];
	...
	xor	edx, edx
	mov	dl, BYTE PTR [eax+ecx+25]
	mov	DWORD PTR _CodeY$38560[ebp], edx
...
; 2978 : 		int CodeZ = m_pNodes[m_di[i].m_SortedBy[2]].m_Region[2];
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR [edx+eax+26]
	mov	DWORD PTR _CodeZ$38561[ebp], ecx

; 2979 : 
; 2980 :         if (i < m_RangeStart[0][CodeX])

	mov	edx, DWORD PTR _CodeX$38559[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$[ebp]
...
; 2984 :         if (i < m_RangeStart[1][CodeY])
	...
	mov	edx, DWORD PTR _CodeY$38560[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$[ebp]
...
; 2988 :         if (i < m_RangeStart[2][CodeZ])
	...
	mov	edx, DWORD PTR _CodeZ$38561[ebp]
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$[ebp]
...
_BestNextNodes$ = -20
_pRoute$ = -24
_nTotalCompressedSize$38587 = -28
_iHull$38588 = -32
_iCap$38592 = -36
_iCapMask$38596 = -40
_iFrom$38603 = -44
...
_cSequence$38641 = -88
_cRepeats$38642 = -92
_CompressedSize$38643 = -96
_p$38644 = -100
_i$38645 = -104
_CanRepeat$38649 = -108
_CanSequence$38650 = -112
_a$38654 = -116
_b$38655 = -120
_c$38656 = -124
_a$38676 = -128
...
; 3015 : 	short *Routes = new short[nRoutes];
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T40210[ebp], eax
	mov	ecx, DWORD PTR $T40210[ebp]
...
; 3024 : 		int nTotalCompressedSize = 0;
	...
	mov	DWORD PTR _nTotalCompressedSize$38587[ebp], 0

; 3025 : 		for (int iHull = 0; iHull < MAX_NODE_HULLS; iHull++)

	mov	DWORD PTR _iHull$38588[ebp], 0
	jmp	SHORT $L38589
$L38590:
	mov	edx, DWORD PTR _iHull$38588[ebp]
	add	edx, 1
	mov	DWORD PTR _iHull$38588[ebp], edx
$L38589:
	cmp	DWORD PTR _iHull$38588[ebp], 4
	jge	$L38591

; 3027 : 			for (int iCap = 0; iCap < 2; iCap++)

	mov	DWORD PTR _iCap$38592[ebp], 0
	jmp	SHORT $L38593
$L38594:
	mov	eax, DWORD PTR _iCap$38592[ebp]
	add	eax, 1
	mov	DWORD PTR _iCap$38592[ebp], eax
$L38593:
	cmp	DWORD PTR _iCap$38592[ebp], 2
	jge	$L38595

; 3031 : 				{

	mov	ecx, DWORD PTR _iCap$38592[ebp]
...
; 3033 : 					iCapMask = 0;
	...
	mov	DWORD PTR _iCapMask$38596[ebp], 0
...
; 3037 : 					iCapMask = bits_CAP_OPEN_DOORS | bits_CAP_AUTO_DOORS | bits_CAP_USE;
	...
	mov	DWORD PTR _iCapMask$38596[ebp], 832	; 00000340H
$L38598:
...
; 3044 : 				for (int iFrom = 0; iFrom < m_cNodes; iFrom++)
	...
	mov	DWORD PTR _iFrom$38603[ebp], 0
	jmp	SHORT $L38604
$L38605:
	mov	edx, DWORD PTR _iFrom$38603[ebp]
	add	edx, 1
	mov	DWORD PTR _iFrom$38603[ebp], edx
$L38604:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _iFrom$38603[ebp]
	cmp	ecx, DWORD PTR [eax+24]
	jge	SHORT $L38606

; 3046 : 					for (int iTo = 0; iTo < m_cNodes; iTo++)

	mov	DWORD PTR _iTo$38607[ebp], 0
	jmp	SHORT $L38608
$L38609:
	mov	edx, DWORD PTR _iTo$38607[ebp]
	add	edx, 1
	mov	DWORD PTR _iTo$38607[ebp], edx
$L38608:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _iTo$38607[ebp]
	cmp	ecx, DWORD PTR [eax+24]
	jge	SHORT $L38610
...
; 3048 : 						Routes[FROM_TO(iFrom, iTo)] = -1;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _iFrom$38603[ebp]
	imul	eax, DWORD PTR [edx+24]
	add	eax, DWORD PTR _iTo$38607[ebp]
...
; 3054 : 					for (int iTo = m_cNodes-1; iTo >= 0; iTo--)
	...
	mov	eax, DWORD PTR [edx+24]
	sub	eax, 1
	mov	DWORD PTR _iTo$38614[ebp], eax
	jmp	SHORT $L38615
$L38616:
	mov	ecx, DWORD PTR _iTo$38614[ebp]
	sub	ecx, 1
	mov	DWORD PTR _iTo$38614[ebp], ecx
$L38615:
	cmp	DWORD PTR _iTo$38614[ebp], 0
	jl	$L38617
...
; 3056 : 						if (Routes[FROM_TO(iFrom, iTo)] != -1) continue;
	...
	mov	eax, DWORD PTR _iFrom$38603[ebp]
	imul	eax, DWORD PTR [edx+24]
	add	eax, DWORD PTR _iTo$38614[ebp]
	mov	ecx, DWORD PTR _Routes$[ebp]
...
; 3058 : 						int cPathSize = FindShortestPath(pMyPath, iFrom, iTo, iHull, iCapMask);
	...
	mov	eax, DWORD PTR _iCapMask$38596[ebp]
	push	eax
	mov	ecx, DWORD PTR _iHull$38588[ebp]
	push	ecx
	mov	edx, DWORD PTR _iTo$38614[ebp]
	push	edx
	mov	eax, DWORD PTR _iFrom$38603[ebp]
	push	eax
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindShortestPath@CGraph@@QAEHPAHHHHH@Z	; CGraph::FindShortestPath
	mov	DWORD PTR _cPathSize$38619[ebp], eax
...
; 3062 : 						if (cPathSize > 1)
	...
	cmp	DWORD PTR _cPathSize$38619[ebp], 1
	jle	SHORT $L38620

; 3064 : 							for (int iNode = 0; iNode < cPathSize-1; iNode++)

	mov	DWORD PTR _iNode$38621[ebp], 0
	jmp	SHORT $L38622
$L38623:
	mov	edx, DWORD PTR _iNode$38621[ebp]
	add	edx, 1
	mov	DWORD PTR _iNode$38621[ebp], edx
$L38622:
	mov	eax, DWORD PTR _cPathSize$38619[ebp]
	sub	eax, 1
	cmp	DWORD PTR _iNode$38621[ebp], eax
	jge	SHORT $L38624

; 3066 : 								int iStart = pMyPath[iNode];

	mov	ecx, DWORD PTR _iNode$38621[ebp]
	mov	edx, DWORD PTR _pMyPath$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
	mov	DWORD PTR _iStart$38625[ebp], eax
...
; 3067 : 								int iNext  = pMyPath[iNode+1];
	...
	mov	edx, DWORD PTR _pMyPath$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4+4]
	mov	DWORD PTR _iNext$38626[ebp], eax

; 3068 : 								for (int iNode1 = iNode+1; iNode1 < cPathSize; iNode1++)

	mov	ecx, DWORD PTR _iNode$38621[ebp]
	add	ecx, 1
	mov	DWORD PTR _iNode1$38627[ebp], ecx
	jmp	SHORT $L38628
$L38629:
	mov	edx, DWORD PTR _iNode1$38627[ebp]
	add	edx, 1
	mov	DWORD PTR _iNode1$38627[ebp], edx
$L38628:
	mov	eax, DWORD PTR _iNode1$38627[ebp]
	cmp	eax, DWORD PTR _cPathSize$38619[ebp]
	jge	SHORT $L38630

; 3070 : 									int iEnd = pMyPath[iNode1];

	mov	ecx, DWORD PTR _iNode1$38627[ebp]
	mov	edx, DWORD PTR _pMyPath$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
	mov	DWORD PTR _iEnd$38631[ebp], eax

; 3071 : 									Routes[FROM_TO(iStart, iEnd)] = iNext;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _iStart$38625[ebp]
	imul	edx, DWORD PTR [ecx+24]
	add	edx, DWORD PTR _iEnd$38631[ebp]
	mov	eax, DWORD PTR _Routes$[ebp]
	mov	cx, WORD PTR _iNext$38626[ebp]
...
; 3094 : 							Routes[FROM_TO(iFrom, iTo)] = iFrom;
	...
	add	eax, DWORD PTR _iTo$38614[ebp]
	mov	ecx, DWORD PTR _Routes$[ebp]
	mov	dx, WORD PTR _iFrom$38603[ebp]
...
; 3095 : 							Routes[FROM_TO(iTo, iFrom)] = iTo;
	...
	add	ecx, DWORD PTR _iFrom$38603[ebp]
	mov	edx, DWORD PTR _Routes$[ebp]
	mov	ax, WORD PTR _iTo$38614[ebp]
...
$L38634:
	mov	ecx, DWORD PTR _iFrom$38603[ebp]
	add	ecx, 1
	mov	DWORD PTR _iFrom$38603[ebp], ecx
$L38633:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _iFrom$38603[ebp]
	cmp	eax, DWORD PTR [edx+24]
...
; 3102 : 					for (int iTo = 0; iTo < m_cNodes; iTo++)
	...
	mov	DWORD PTR _iTo$38636[ebp], 0
	jmp	SHORT $L38637
$L38638:
	mov	ecx, DWORD PTR _iTo$38636[ebp]
	add	ecx, 1
	mov	DWORD PTR _iTo$38636[ebp], ecx
$L38637:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _iTo$38636[ebp]
	cmp	eax, DWORD PTR [edx+24]
	jge	SHORT $L38639
...
; 3104 : 						BestNextNodes[iTo] = Routes[FROM_TO(iFrom, iTo)];
	...
	mov	edx, DWORD PTR _iFrom$38603[ebp]
	imul	edx, DWORD PTR [ecx+24]
	add	edx, DWORD PTR _iTo$38636[ebp]
	mov	eax, DWORD PTR _iTo$38636[ebp]
...
; 3109 : 					int iLastNode = 9999999; // just really big.
	...
	mov	DWORD PTR _iLastNode$38640[ebp], 9999999 ; 0098967fH

; 3110 : 					int cSequence = 0;

	mov	DWORD PTR _cSequence$38641[ebp], 0

; 3111 : 					int cRepeats = 0;

	mov	DWORD PTR _cRepeats$38642[ebp], 0

; 3112 : 					int CompressedSize = 0;

	mov	DWORD PTR _CompressedSize$38643[ebp], 0

; 3113 : 					char *p = pRoute;

	mov	eax, DWORD PTR _pRoute$[ebp]
	mov	DWORD PTR _p$38644[ebp], eax

; 3114 : 					for (int i = 0; i < m_cNodes; i++)

	mov	DWORD PTR _i$38645[ebp], 0
	jmp	SHORT $L38646
$L38647:
	mov	ecx, DWORD PTR _i$38645[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$38645[ebp], ecx
$L38646:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _i$38645[ebp]
	cmp	eax, DWORD PTR [edx+24]
	jge	$L38648
...
; 3116 : 						BOOL CanRepeat = ((BestNextNodes[i] == iLastNode) && cRepeats < 127);
	...
	cmp	eax, DWORD PTR _iLastNode$38640[ebp]
	jne	SHORT $L40214
	cmp	DWORD PTR _cRepeats$38642[ebp], 127	; 0000007fH
	jge	SHORT $L40214
...
$L40215:
	...
	mov	DWORD PTR _CanRepeat$38649[ebp], ecx

; 3117 : 						BOOL CanSequence = (BestNextNodes[i] == i && cSequence < 128);

	mov	edx, DWORD PTR _i$38645[ebp]
	mov	eax, DWORD PTR _BestNextNodes$[ebp]
	xor	ecx, ecx
	mov	cx, WORD PTR [eax+edx*2]
	cmp	ecx, DWORD PTR _i$38645[ebp]
	jne	SHORT $L40216
	cmp	DWORD PTR _cSequence$38641[ebp], 128	; 00000080H
	jge	SHORT $L40216
...
$L40217:
	...
	mov	DWORD PTR _CanSequence$38650[ebp], edx

; 3118 : 
; 3119 : 						if (cRepeats)

	cmp	DWORD PTR _cRepeats$38642[ebp], 0
	je	$L38651

; 3121 : 							if (CanRepeat)

	cmp	DWORD PTR _CanRepeat$38649[ebp], 0
	je	SHORT $L38652

; 3123 : 								cRepeats++;

	mov	eax, DWORD PTR _cRepeats$38642[ebp]
	add	eax, 1
	mov	DWORD PTR _cRepeats$38642[ebp], eax
...
; 3129 : 								CompressedSize += 2; // (count-1, iLastNode-i)
	...
	mov	ecx, DWORD PTR _CompressedSize$38643[ebp]
	add	ecx, 2
	mov	DWORD PTR _CompressedSize$38643[ebp], ecx

; 3130 : 								*p++ = cRepeats - 1;

	mov	edx, DWORD PTR _cRepeats$38642[ebp]
	sub	edx, 1
	mov	eax, DWORD PTR _p$38644[ebp]
	mov	BYTE PTR [eax], dl
	mov	ecx, DWORD PTR _p$38644[ebp]
	add	ecx, 1
	mov	DWORD PTR _p$38644[ebp], ecx

; 3131 : 								int a = iLastNode - iFrom;

	mov	edx, DWORD PTR _iLastNode$38640[ebp]
	sub	edx, DWORD PTR _iFrom$38603[ebp]
	mov	DWORD PTR _a$38654[ebp], edx

; 3132 : 								int b = iLastNode - iFrom + m_cNodes;

	mov	eax, DWORD PTR _iLastNode$38640[ebp]
	sub	eax, DWORD PTR _iFrom$38603[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+24]
	mov	DWORD PTR _b$38655[ebp], eax
...
; 3133 : 								int c = iLastNode - iFrom - m_cNodes;
	...
	mov	DWORD PTR _c$38656[ebp], edx

; 3134 : 								if (-128 <= a && a <= 127)

	cmp	DWORD PTR _a$38654[ebp], -128		; ffffff80H
	jl	SHORT $L38657
	cmp	DWORD PTR _a$38654[ebp], 127		; 0000007fH
	jg	SHORT $L38657

; 3136 : 									*p++ = a;

	mov	ecx, DWORD PTR _p$38644[ebp]
	mov	dl, BYTE PTR _a$38654[ebp]
	mov	BYTE PTR [ecx], dl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3138 : 								else if (-128 <= b && b <= 127)
	...
	jmp	SHORT $L38662
$L38657:
	cmp	DWORD PTR _b$38655[ebp], -128		; ffffff80H
	jl	SHORT $L38659
	cmp	DWORD PTR _b$38655[ebp], 127		; 0000007fH
	jg	SHORT $L38659

; 3140 : 									*p++ = b;

	mov	ecx, DWORD PTR _p$38644[ebp]
	mov	dl, BYTE PTR _b$38655[ebp]
	mov	BYTE PTR [ecx], dl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3142 : 								else if (-128 <= c && c <= 127)
	...
	jmp	SHORT $L38662
$L38659:
	cmp	DWORD PTR _c$38656[ebp], -128		; ffffff80H
	jl	SHORT $L38661
	cmp	DWORD PTR _c$38656[ebp], 127		; 0000007fH
	jg	SHORT $L38661

; 3144 : 									*p++ = c;

	mov	ecx, DWORD PTR _p$38644[ebp]
	mov	dl, BYTE PTR _c$38656[ebp]
	mov	BYTE PTR [ecx], dl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3152 : 								if (CanSequence)
	...
	cmp	DWORD PTR _CanSequence$38650[ebp], 0
	je	SHORT $L38664
...
; 3156 : 									cSequence++;
	...
	mov	eax, DWORD PTR _cSequence$38641[ebp]
	add	eax, 1
	mov	DWORD PTR _cSequence$38641[ebp], eax
...
; 3162 : 									cRepeats++;
	...
	mov	ecx, DWORD PTR _cRepeats$38642[ebp]
	add	ecx, 1
	mov	DWORD PTR _cRepeats$38642[ebp], ecx
$L38665:
...
; 3166 : 						else if (cSequence)
	...
	jmp	SHORT $L38674
$L38651:
	cmp	DWORD PTR _cSequence$38641[ebp], 0
	je	SHORT $L38667
...
; 3170 : 								cSequence++;
	...
	mov	edx, DWORD PTR _cSequence$38641[ebp]
	add	edx, 1
	mov	DWORD PTR _cSequence$38641[ebp], edx
...
; 3178 : 								if (cSequence == 1 && CanRepeat)
	...
	cmp	DWORD PTR _cSequence$38641[ebp], 1
	jne	SHORT $L38670
	cmp	DWORD PTR _CanRepeat$38649[ebp], 0
	je	SHORT $L38670
...
; 3182 : 									cRepeats = 2;
	...
	mov	DWORD PTR _cRepeats$38642[ebp], 2
...
; 3189 : 									CompressedSize += 1; // (-count)
	...
	mov	eax, DWORD PTR _CompressedSize$38643[ebp]
	add	eax, 1
	mov	DWORD PTR _CompressedSize$38643[ebp], eax

; 3190 : 									*p++ = -cSequence;

	mov	ecx, DWORD PTR _cSequence$38641[ebp]
	neg	ecx
	mov	edx, DWORD PTR _p$38644[ebp]
	mov	BYTE PTR [edx], cl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3214 : 						iLastNode = BestNextNodes[i];
	...
	xor	eax, eax
	mov	ax, WORD PTR [edx+ecx*2]
	mov	DWORD PTR _iLastNode$38640[ebp], eax
...
; 3227 : 						int a = iLastNode - iFrom;
	...
	mov	edx, DWORD PTR _iLastNode$38640[ebp]
	sub	edx, DWORD PTR _iFrom$38603[ebp]
	mov	DWORD PTR _a$38676[ebp], edx
...
; 3228 : 						int b = iLastNode - iFrom + m_cNodes;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	add	eax, DWORD PTR [ecx+24]
	mov	DWORD PTR _b$38677[ebp], eax
...
; 3229 : 						int c = iLastNode - iFrom - m_cNodes;
	...
	mov	eax, DWORD PTR _this$[ebp]
	sub	edx, DWORD PTR [eax+24]
	mov	DWORD PTR _c$38678[ebp], edx

; 3230 : 						if (-128 <= a && a <= 127)

	cmp	DWORD PTR _a$38676[ebp], -128		; ffffff80H
	jl	SHORT $L38679
	cmp	DWORD PTR _a$38676[ebp], 127		; 0000007fH
	jg	SHORT $L38679

; 3232 : 							*p++ = a;

	mov	ecx, DWORD PTR _p$38644[ebp]
	mov	dl, BYTE PTR _a$38676[ebp]
	mov	BYTE PTR [ecx], dl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3234 : 						else if (-128 <= b && b <= 127)
	...
	jmp	SHORT $L38684
$L38679:
	cmp	DWORD PTR _b$38677[ebp], -128		; ffffff80H
	jl	SHORT $L38681
	cmp	DWORD PTR _b$38677[ebp], 127		; 0000007fH
	jg	SHORT $L38681

; 3236 : 							*p++ = b;

	mov	ecx, DWORD PTR _p$38644[ebp]
	mov	dl, BYTE PTR _b$38677[ebp]
	mov	BYTE PTR [ecx], dl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3238 : 						else if (-128 <= c && c <= 127)
	...
	jmp	SHORT $L38684
$L38681:
	cmp	DWORD PTR _c$38678[ebp], -128		; ffffff80H
	jl	SHORT $L38683
	cmp	DWORD PTR _c$38678[ebp], 127		; 0000007fH
	jg	SHORT $L38683

; 3240 : 							*p++ = c;

	mov	ecx, DWORD PTR _p$38644[ebp]
	mov	dl, BYTE PTR _c$38678[ebp]
	mov	BYTE PTR [ecx], dl
	mov	eax, DWORD PTR _p$38644[ebp]
	add	eax, 1
	mov	DWORD PTR _p$38644[ebp], eax
...
; 3257 : 					int nRoute = p - pRoute;
	...
	mov	DWORD PTR _nRoute$38686[ebp], ecx
...
; 3260 : 						for (int i = 0; i < m_nRouteInfo - nRoute; i++)
	...
	mov	DWORD PTR _i$38688[ebp], 0
	jmp	SHORT $L38689
$L38690:
	mov	eax, DWORD PTR _i$38688[ebp]
	add	eax, 1
	mov	DWORD PTR _i$38688[ebp], eax
$L38689:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+32]
	sub	edx, DWORD PTR _nRoute$38686[ebp]
	cmp	DWORD PTR _i$38688[ebp], edx
	jge	SHORT $L38691

; 3262 : 							if (memcmp(m_pRouteInfo + i, pRoute, nRoute) == 0)

	mov	eax, DWORD PTR _nRoute$38686[ebp]
	push	eax
	mov	ecx, DWORD PTR _pRoute$[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+20]
	add	eax, DWORD PTR _i$38688[ebp]
	push	eax
	call	_memcmp
	add	esp, 12					; 0000000cH
	test	eax, eax
...
; 3269 : 							m_pNodes[ iFrom ].m_pNextBestNode[iHull][iCap] = i;
	...
	mov	edx, DWORD PTR [ecx+12]
	add	edx, eax
	mov	eax, DWORD PTR _iHull$38588[ebp]
	lea	ecx, DWORD PTR [edx+eax*8+40]
	mov	edx, DWORD PTR _iCap$38592[ebp]
	mov	eax, DWORD PTR _i$38688[ebp]
...
; 3273 : 							char *Tmp = (char *)calloc(sizeof(char), (m_nRouteInfo + nRoute));
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+32]
	add	edx, DWORD PTR _nRoute$38686[ebp]
	push	edx
	push	1
	call	_calloc
	add	esp, 8
	mov	DWORD PTR _Tmp$38695[ebp], eax
...
; 3274 : 							memcpy(Tmp, m_pRouteInfo, m_nRouteInfo);
	...
	mov	eax, DWORD PTR [edx+20]
	push	eax
	mov	ecx, DWORD PTR _Tmp$38695[ebp]
	push	ecx
	call	_memcpy
	add	esp, 12					; 0000000cH
...
; 3276 : 							m_pRouteInfo = Tmp;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _Tmp$38695[ebp]
...
; 3279 : 							m_nRouteInfo += nRoute;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+32]
	add	ecx, DWORD PTR _nRoute$38686[ebp]
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+32], ecx

; 3280 : 							nTotalCompressedSize += CompressedSize;

	mov	eax, DWORD PTR _nTotalCompressedSize$38587[ebp]
	add	eax, DWORD PTR _CompressedSize$38643[ebp]
	mov	DWORD PTR _nTotalCompressedSize$38587[ebp], eax
$L38694:
...
; 3285 : 						m_nRouteInfo = nRoute;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _nRoute$38686[ebp]
...
; 3294 : 		ALERT( at_aiconsole, "Size of Routes = %d\n", nTotalCompressedSize);
	...
	mov	ecx, DWORD PTR _nTotalCompressedSize$38587[ebp]
	push	ecx
...
; 3296 : 	if (Routes) delete Routes;
	...
	je	SHORT $L38702
	mov	edx, DWORD PTR _Routes$[ebp]
	mov	DWORD PTR $T40218[ebp], edx
	mov	eax, DWORD PTR $T40218[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
$L38702:
...
; 3297 : 	if (BestNextNodes) delete BestNextNodes;
	...
	je	SHORT $L38704
	mov	ecx, DWORD PTR _BestNextNodes$[ebp]
	mov	DWORD PTR $T40219[ebp], ecx
	mov	edx, DWORD PTR $T40219[ebp]
	push	edx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
$L38704:
...
; 3298 : 	if (pRoute) delete pRoute;
	...
	je	SHORT $L38706
	mov	eax, DWORD PTR _pRoute$[ebp]
	mov	DWORD PTR $T40220[ebp], eax
	mov	ecx, DWORD PTR $T40220[ebp]
	push	ecx
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
$L38706:
...
; 3299 : 	if (pMyPath) delete pMyPath;
	...
	je	SHORT $L38708
	mov	edx, DWORD PTR _pMyPath$[ebp]
	mov	DWORD PTR $T40221[ebp], edx
	mov	eax, DWORD PTR $T40221[ebp]
	push	eax
	call	??3@YAXPAX@Z				; operator delete
	add	esp, 4
$L38708:
...
_iFrom$38736 = -28
_iTo$38740 = -32
_cPathSize1$38744 = -36
_cPathSize2$38745 = -40
_flDistance1$38747 = -44
_i$38748 = -48
_iVisitNode$38753 = -52
_bFound$38754 = -56
_iLink$38755 = -60
_flDistance2$38762 = -64
_iVisitNode$38767 = -68
_bFound$38768 = -72
_iLink$38769 = -76
_i$38778 = -80
...
; 3315 : 	int *pMyPath = new int[m_cNodes];
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T40224[ebp], eax
	mov	edx, DWORD PTR $T40224[ebp]
...
; 3319 : 		for (int iHull = 0; iHull < MAX_NODE_HULLS; iHull++)
	...
	mov	DWORD PTR _iHull$38721[ebp], 0
	jmp	SHORT $L38722
$L38723:
	mov	eax, DWORD PTR _iHull$38721[ebp]
	add	eax, 1
	mov	DWORD PTR _iHull$38721[ebp], eax
$L38722:
	cmp	DWORD PTR _iHull$38721[ebp], 4
	jge	$EnoughSaid$38787

; 3321 : 			for (int iCap = 0; iCap < 2; iCap++)

	mov	DWORD PTR _iCap$38725[ebp], 0
	jmp	SHORT $L38726
$L38727:
	mov	ecx, DWORD PTR _iCap$38725[ebp]
	add	ecx, 1
	mov	DWORD PTR _iCap$38725[ebp], ecx
$L38726:
	cmp	DWORD PTR _iCap$38725[ebp], 2
	jge	$L38728

; 3325 : 				{

	mov	edx, DWORD PTR _iCap$38725[ebp]
...
; 3327 : 					iCapMask = 0;
	...
	mov	DWORD PTR _iCapMask$38729[ebp], 0
...
; 3331 : 					iCapMask = bits_CAP_OPEN_DOORS | bits_CAP_AUTO_DOORS | bits_CAP_USE;
	...
	mov	DWORD PTR _iCapMask$38729[ebp], 832	; 00000340H
$L38731:

; 3334 : 
; 3335 : 				for (int iFrom = 0; iFrom < m_cNodes; iFrom++)

	mov	DWORD PTR _iFrom$38736[ebp], 0
	jmp	SHORT $L38737
$L38738:
	mov	eax, DWORD PTR _iFrom$38736[ebp]
	add	eax, 1
	mov	DWORD PTR _iFrom$38736[ebp], eax
$L38737:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _iFrom$38736[ebp]
	cmp	edx, DWORD PTR [ecx+24]
	jge	$L38739

; 3337 : 					for (int iTo = 0; iTo < m_cNodes; iTo++)

	mov	DWORD PTR _iTo$38740[ebp], 0
	jmp	SHORT $L38741
$L38742:
	mov	eax, DWORD PTR _iTo$38740[ebp]
	add	eax, 1
	mov	DWORD PTR _iTo$38740[ebp], eax
$L38741:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _iTo$38740[ebp]
	cmp	edx, DWORD PTR [ecx+24]
	jge	$L38743
...
; 3340 : 						int cPathSize1 = FindShortestPath(pMyPath, iFrom, iTo, iHull, iCapMask);
	...
	mov	ecx, DWORD PTR _iCapMask$38729[ebp]
	push	ecx
	mov	edx, DWORD PTR _iHull$38721[ebp]
	push	edx
	mov	eax, DWORD PTR _iTo$38740[ebp]
	push	eax
	mov	ecx, DWORD PTR _iFrom$38736[ebp]
	push	ecx
	mov	edx, DWORD PTR _pMyPath$[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindShortestPath@CGraph@@QAEHPAHHHHH@Z	; CGraph::FindShortestPath
	mov	DWORD PTR _cPathSize1$38744[ebp], eax
...
; 3342 : 						int cPathSize2 = FindShortestPath(pMyPath2, iFrom, iTo, iHull, iCapMask);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindShortestPath@CGraph@@QAEHPAHHHHH@Z	; CGraph::FindShortestPath
	mov	DWORD PTR _cPathSize2$38745[ebp], eax
...
; 3346 : 						if (cPathSize2 == MAX_PATH_SIZE) continue;
	...
	cmp	DWORD PTR _cPathSize2$38745[ebp], 10	; 0000000aH
	jne	SHORT $L38746
	jmp	SHORT $L38742
$L38746:
...
; 3351 : 						float flDistance1 = 0.0;
	...
	mov	DWORD PTR _flDistance1$38747[ebp], 0

; 3352 : 						for (int i = 0; i < cPathSize1-1; i++)

	mov	DWORD PTR _i$38748[ebp], 0
	jmp	SHORT $L38749
$L38750:
	mov	eax, DWORD PTR _i$38748[ebp]
	add	eax, 1
	mov	DWORD PTR _i$38748[ebp], eax
$L38749:
	mov	ecx, DWORD PTR _cPathSize1$38744[ebp]
	sub	ecx, 1
	cmp	DWORD PTR _i$38748[ebp], ecx
	jge	$L38751
...
; 3356 : 							if (pMyPath[i] == pMyPath[i+1]) continue;
	...
	mov	edx, DWORD PTR _i$38748[ebp]
	mov	eax, DWORD PTR _pMyPath$[ebp]
	mov	ecx, DWORD PTR _i$38748[ebp]
...
; 3358 : 							BOOL bFound = FALSE;
	...
	mov	DWORD PTR _bFound$38754[ebp], 0

; 3359 : 							for (int iLink = 0; iLink < m_pNodes[pMyPath[i]].m_cNumLinks; iLink++)

	mov	DWORD PTR _iLink$38755[ebp], 0
	jmp	SHORT $L38756
$L38757:
	mov	eax, DWORD PTR _iLink$38755[ebp]
	add	eax, 1
	mov	DWORD PTR _iLink$38755[ebp], eax
$L38756:
	mov	ecx, DWORD PTR _i$38748[ebp]
	mov	edx, DWORD PTR _pMyPath$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
...
; 3361 : 								iVisitNode = INodeLink ( pMyPath[i], iLink );
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?INodeLink@CGraph@@QAEHHH@Z		; CGraph::INodeLink
	mov	DWORD PTR _iVisitNode$38753[ebp], eax

; 3362 : 								if (iVisitNode == pMyPath[i+1])

	mov	eax, DWORD PTR _i$38748[ebp]
	mov	ecx, DWORD PTR _pMyPath$[ebp]
	mov	edx, DWORD PTR _iVisitNode$38753[ebp]
...
; 3364 : 									flDistance1 += m_pLinkPool[ m_pNodes[ pMyPath[i] ].m_iFirstLink + iLink].m_flWeight;
	...
	mov	ecx, DWORD PTR [eax+12]
	mov	edx, DWORD PTR [ecx+edx+36]
	add	edx, DWORD PTR _iLink$38755[ebp]
	imul	edx, 24					; 00000018H
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+16]
	fld	DWORD PTR _flDistance1$38747[ebp]
	fadd	DWORD PTR [ecx+edx+20]
	fstp	DWORD PTR _flDistance1$38747[ebp]

; 3365 : 									bFound = TRUE;

	mov	DWORD PTR _bFound$38754[ebp], 1
...
; 3369 : 							if (!bFound)
	...
	cmp	DWORD PTR _bFound$38754[ebp], 0
	jne	SHORT $L38760
...
; 3375 : 						float flDistance2 = 0.0;
	...
	mov	DWORD PTR _flDistance2$38762[ebp], 0
...
$L38764:
	mov	edx, DWORD PTR _i$38748[ebp]
	add	edx, 1
	mov	DWORD PTR _i$38748[ebp], edx
$L38763:
	mov	eax, DWORD PTR _cPathSize2$38745[ebp]
	sub	eax, 1
	cmp	DWORD PTR _i$38748[ebp], eax
	jge	$L38765
...
; 3382 : 							BOOL bFound = FALSE;
	...
	mov	DWORD PTR _bFound$38768[ebp], 0

; 3383 : 							for (int iLink = 0; iLink < m_pNodes[pMyPath2[i]].m_cNumLinks; iLink++)

	mov	DWORD PTR _iLink$38769[ebp], 0
	jmp	SHORT $L38770
$L38771:
	mov	edx, DWORD PTR _iLink$38769[ebp]
	add	edx, 1
	mov	DWORD PTR _iLink$38769[ebp], edx
$L38770:
	mov	eax, DWORD PTR _i$38748[ebp]
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	mov	eax, DWORD PTR _iLink$38769[ebp]
	cmp	eax, DWORD PTR [ecx+edx+32]
	jge	SHORT $L38772

; 3385 : 								iVisitNode = INodeLink ( pMyPath2[i], iLink );

	mov	ecx, DWORD PTR _iLink$38769[ebp]
	push	ecx
	mov	edx, DWORD PTR _i$38748[ebp]
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?INodeLink@CGraph@@QAEHHH@Z		; CGraph::INodeLink
	mov	DWORD PTR _iVisitNode$38767[ebp], eax

; 3386 : 								if (iVisitNode == pMyPath2[i+1])

	mov	edx, DWORD PTR _i$38748[ebp]
	mov	eax, DWORD PTR _pMyPath2$[ebp]
	mov	ecx, DWORD PTR _iVisitNode$38767[ebp]
...
; 3388 : 									flDistance2 += m_pLinkPool[ m_pNodes[ pMyPath2[i] ].m_iFirstLink + iLink].m_flWeight;
	...
	mov	eax, DWORD PTR [edx+12]
	mov	ecx, DWORD PTR [eax+ecx+36]
	add	ecx, DWORD PTR _iLink$38769[ebp]
	imul	ecx, 24					; 00000018H
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+16]
	fld	DWORD PTR _flDistance2$38762[ebp]
	fadd	DWORD PTR [eax+ecx+20]
	fstp	DWORD PTR _flDistance2$38762[ebp]

; 3389 : 									bFound = TRUE;

	mov	DWORD PTR _bFound$38768[ebp], 1
...
; 3393 : 							if (!bFound)
	...
	cmp	DWORD PTR _bFound$38768[ebp], 0
	jne	SHORT $L38774
...
; 3398 : 						if (fabs(flDistance1 - flDistance2) > 0.10)
	...
	fld	DWORD PTR _flDistance1$38747[ebp]
	fsub	DWORD PTR _flDistance2$38762[ebp]
	sub	esp, 8
	fstp	QWORD PTR [esp]
	call	_fabs
	add	esp, 8
...
; 3406 : 							for (int i = 0; i < cPathSize1; i++)
	...
	mov	DWORD PTR _i$38778[ebp], 0
	jmp	SHORT $L38779
$L38780:
	mov	edx, DWORD PTR _i$38778[ebp]
	add	edx, 1
	mov	DWORD PTR _i$38778[ebp], edx
$L38779:
	mov	eax, DWORD PTR _i$38778[ebp]
	cmp	eax, DWORD PTR _cPathSize1$38744[ebp]
	jge	SHORT $L38781

; 3408 : 								ALERT(at_aiconsole, "%d ", pMyPath[i]);

	mov	ecx, DWORD PTR _i$38778[ebp]
	mov	edx, DWORD PTR _pMyPath$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
	push	eax
...
$L38784:
	mov	eax, DWORD PTR _i$38778[ebp]
	cmp	eax, DWORD PTR _cPathSize2$38745[ebp]
	jge	SHORT $L38786
...
; 3417 : 							cPathSize1 = FindShortestPath(pMyPath, iFrom, iTo, iHull, iCapMask);
	...
	mov	edx, DWORD PTR _iCapMask$38729[ebp]
	push	edx
	mov	eax, DWORD PTR _iHull$38721[ebp]
	push	eax
	mov	ecx, DWORD PTR _iTo$38740[ebp]
	push	ecx
	mov	edx, DWORD PTR _iFrom$38736[ebp]
	push	edx
	mov	eax, DWORD PTR _pMyPath$[ebp]
...
; 3526 : 		for (int i = 0; i < WorldGraph.m_cNodes; i++)
	...
	mov	DWORD PTR _i$38950[ebp], 0
	jmp	SHORT $L38951
$L38952:
	mov	eax, DWORD PTR _i$38950[ebp]
	add	eax, 1
	mov	DWORD PTR _i$38950[ebp], eax
$L38951:
	mov	ecx, DWORD PTR _i$38950[ebp]
	cmp	ecx, DWORD PTR ?WorldGraph@@3VCGraph@@A+24
	jge	SHORT $L38953
...
; 3536 : 		int start = 0;
	...
	mov	DWORD PTR _start$38955[ebp], 0
$L38957:
...
; 3539 : 			end = m_nVisited;
	...
	mov	DWORD PTR _end$38956[ebp], edx
...
; 3541 : 			for (end = m_nVisited; start < end; start++)
	...
	mov	DWORD PTR _end$38956[ebp], ecx
	jmp	SHORT $L38960
$L38961:
	mov	edx, DWORD PTR _start$38955[ebp]
	add	edx, 1
	mov	DWORD PTR _start$38955[ebp], edx
$L38960:
	mov	eax, DWORD PTR _start$38955[ebp]
	cmp	eax, DWORD PTR _end$38956[ebp]
	jge	SHORT $L38962

; 3543 : 				FindNodeConnections( m_aFrom[start] );

	mov	ecx, DWORD PTR _start$38955[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
; 3546 : 		} while (end != m_nVisited);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _end$38956[ebp]
...
; 3562 : 		CLink *pToLink = &WorldGraph.NodeLink( iNode, i);
	...
	mov	ecx, OFFSET FLAT:?WorldGraph@@3VCGraph@@A
	call	?NodeLink@CGraph@@QAEAAVCLink@@HH@Z	; CGraph::NodeLink
	mov	DWORD PTR _pToLink$38974[ebp], eax
...
; 3563 : 		AddNode( pToLink->m_iDestNode, WorldGraph.NextNodeInRoute( pToLink->m_iDestNode, m_iBaseNode, m_iHull, 0 ));
	...
	mov	eax, DWORD PTR [edx+1764]
	push	eax
	mov	ecx, DWORD PTR _pToLink$38974[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	ecx, OFFSET FLAT:?WorldGraph@@3VCGraph@@A
	call	?NextNodeInRoute@CGraph@@QAEHHHHH@Z	; CGraph::NextNodeInRoute
	push	eax
	mov	eax, DWORD PTR _pToLink$38974[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?AddNode@CNodeViewer@@QAEXHH@Z		; CNodeViewer::AddNode
...
; 3578 : 		for (int i = 0; i < m_nVisited; i++)
	...
	mov	DWORD PTR _i$38983[ebp], 0
	jmp	SHORT $L38984
$L38985:
	mov	edx, DWORD PTR _i$38983[ebp]
	add	edx, 1
	mov	DWORD PTR _i$38983[ebp], edx
$L38984:
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _i$38983[ebp]
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40342[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40342[ebp], 0
	je	SHORT $L40343
	mov	ecx, DWORD PTR $T40342[ebp]
...
; 318  : 	virtual Vector BodyTarget( const Vector &posSrc ) { return Center( ) * 0.75 + EyePosition() * 0.25; };		// position to shoot at
	...
	lea	eax, DWORD PTR $T40553[ebp]
	push	eax
	lea	ecx, DWORD PTR $T40552[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _this$[ebp]
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T40554[ebp]
	push	ecx
	push	1061158912				; 3f400000H
	lea	edx, DWORD PTR $T40551[ebp]
	push	edx
	lea	eax, DWORD PTR $T40550[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
