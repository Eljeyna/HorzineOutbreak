...
; 59   : 		Vector vecTarget = pevTarget->origin;
	...
	add	ecx, 8
	push	ecx
	lea	ecx, DWORD PTR _vecTarget$36521[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 60   : 		vecTarget.x += RANDOM_FLOAT( pevTarget->mins.x + flSize, pevTarget->maxs.x - flSize);
	...
	add	esp, 8
	fadd	DWORD PTR _vecTarget$36521[ebp]
	fstp	DWORD PTR _vecTarget$36521[ebp]
...
; 61   : 		vecTarget.y += RANDOM_FLOAT( pevTarget->mins.y + flSize, pevTarget->maxs.y - flSize);
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+364
	add	esp, 8
	fadd	DWORD PTR _vecTarget$36521[ebp+4]
	fstp	DWORD PTR _vecTarget$36521[ebp+4]
...
; 62   : 		vecTarget.z += RANDOM_FLOAT( pevTarget->mins.z + flSize, pevTarget->maxs.z - flSize);
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+364
	add	esp, 8
	fadd	DWORD PTR _vecTarget$36521[ebp+8]
	fstp	DWORD PTR _vecTarget$36521[ebp+8]
...
; 68   : 			vecTargetOrigin = vecTarget;
	...
	mov	ecx, DWORD PTR _vecTarget$36521[ebp]
	mov	DWORD PTR [eax], ecx
	mov	edx, DWORD PTR _vecTarget$36521[ebp+4]
	mov	DWORD PTR [eax+4], edx
	mov	ecx, DWORD PTR _vecTarget$36521[ebp+8]
...
; 110  : 	UTIL_TraceLine(vecMidPoint, vecMidPoint + Vector(0,0,500), ignore_monsters, ENT(pev), &tr);
	...
	push	0
	push	0
	lea	ecx, DWORD PTR $T36916[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	eax, DWORD PTR $T36917[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecMidPoint$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	push	eax
...
; 141  : 	vecApex  = vecSpot1 + vecGrenadeVel * time1;
	...
	push	ecx
	lea	edx, DWORD PTR $T36920[ebp]
	push	edx
	lea	ecx, DWORD PTR _vecGrenadeVel$[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	eax, DWORD PTR $T36921[ebp]
	push	eax
	mov	ecx, DWORD PTR _vecSpot1$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	ecx, DWORD PTR [eax]
...
; 180  : 	Vector vecApex = vecSpot1 + (vecSpot2 - vecSpot1) * 0.5;
	...
	push	1056964608				; 3f000000H
	lea	ecx, DWORD PTR $T36952[ebp]
	push	ecx
	mov	edx, DWORD PTR _vecSpot1$[ebp]
	push	edx
	lea	eax, DWORD PTR $T36951[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecSpot2$[ebp]
	call	??GVector@@QBE?AV0@ABV0@@Z		; Vector::operator-
	mov	ecx, eax
