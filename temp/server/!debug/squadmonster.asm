...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T37789[ebp], edx
	mov	eax, DWORD PTR $T37789[ebp]
	push	eax
...
; 146  : 		for (int i = 0; i < MAX_SQUAD_MEMBERS-1;i++)
	...
	mov	DWORD PTR _i$37204[ebp], 0
	jmp	SHORT $L37205
$L37206:
	mov	edx, DWORD PTR _i$37204[ebp]
	add	edx, 1
	mov	DWORD PTR _i$37204[ebp], edx
$L37205:
	cmp	DWORD PTR _i$37204[ebp], 4
	jge	SHORT $L37207

; 148  : 			CSquadMonster *pMember = MySquadMember(i);

	mov	eax, DWORD PTR _i$37204[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37208[ebp], eax

; 149  : 			if (pMember)

	cmp	DWORD PTR _pMember$37208[ebp], 0
	je	SHORT $L37209

; 151  : 				pMember->m_hSquadLeader = NULL;

	push	0
	mov	ecx, DWORD PTR _pMember$37208[ebp]
	add	ecx, 2396				; 0000095cH
...
; 152  : 				m_hSquadMember[i] = NULL;
	...
	push	0
	mov	ecx, DWORD PTR _i$37204[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
; 158  : 		CSquadMonster *pSquadLeader = MySquadLeader();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?MySquadLeader@CSquadMonster@@QAEPAV1@XZ ; CSquadMonster::MySquadLeader
	mov	DWORD PTR _pSquadLeader$37211[ebp], eax

; 159  : 		if (pSquadLeader)

	cmp	DWORD PTR _pSquadLeader$37211[ebp], 0
	je	SHORT $L37216

; 161  : 			for (int i = 0; i < MAX_SQUAD_MEMBERS-1;i++)

	mov	DWORD PTR _i$37213[ebp], 0
	jmp	SHORT $L37214
$L37215:
	mov	eax, DWORD PTR _i$37213[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37213[ebp], eax
$L37214:
	cmp	DWORD PTR _i$37213[ebp], 4
	jge	SHORT $L37216

; 163  : 				if (pSquadLeader->m_hSquadMember[i] == this)

	mov	ecx, DWORD PTR _i$37213[ebp]
	mov	edx, DWORD PTR _pSquadLeader$37211[ebp]
	lea	ecx, DWORD PTR [edx+ecx*8+2404]
	call	??BEHANDLE@@QAEPAVCBaseEntity@@XZ	; EHANDLE::operator CBaseEntity *
	cmp	eax, DWORD PTR _this$[ebp]
	jne	SHORT $L37217
...
; 165  : 					pSquadLeader->m_hSquadMember[i] = NULL;
	...
	push	0
	mov	eax, DWORD PTR _i$37213[ebp]
	mov	ecx, DWORD PTR _pSquadLeader$37211[ebp]
...
; 249  : 		CSquadMonster *pMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37254[ebp], eax

; 250  : 		if (pMember)

	cmp	DWORD PTR _pMember$37254[ebp], 0
	je	$L37256
...
; 253  : 			if (pMember->m_hEnemy != pEnemy && !pMember->HasConditions( bits_COND_SEE_ENEMY))
	...
	mov	ecx, DWORD PTR _pMember$37254[ebp]
...
; 258  : 					pMember->PushEnemy( pMember->m_hEnemy, pMember->m_vecEnemyLKP );
	...
	mov	edx, DWORD PTR _pMember$37254[ebp]
...
; 324  : 			CSquadMonster *pRecruit = pEntity->MySquadMonsterPointer();
	...
	mov	DWORD PTR _pRecruit$37285[ebp], eax

; 325  : 
; 326  : 			if ( pRecruit )

	cmp	DWORD PTR _pRecruit$37285[ebp], 0
	je	SHORT $L37287

; 328  : 				if ( !pRecruit->InSquad() && pRecruit->Classify() == iMyClass && pRecruit != this )

	mov	ecx, DWORD PTR _pRecruit$37285[ebp]
	call	?InSquad@CSquadMonster@@QAEHXZ		; CSquadMonster::InSquad
	test	eax, eax
	jne	SHORT $L37287
	mov	ecx, DWORD PTR _pRecruit$37285[ebp]
	...
	jne	SHORT $L37287
	mov	eax, DWORD PTR _pRecruit$37285[ebp]
	cmp	eax, DWORD PTR _this$[ebp]
	je	SHORT $L37287
...
; 344  : 			CSquadMonster *pRecruit = pEntity->MySquadMonsterPointer( );
	...
	mov	ecx, DWORD PTR _pEntity$[ebp]
	call	DWORD PTR [eax+128]
	mov	DWORD PTR _pRecruit$37293[ebp], eax

; 345  : 
; 346  : 			if ( pRecruit && pRecruit != this && pRecruit->IsAlive() && !pRecruit->m_pCine )

	cmp	DWORD PTR _pRecruit$37293[ebp], 0
	je	$L37300
	mov	ecx, DWORD PTR _pRecruit$37293[ebp]
	cmp	ecx, DWORD PTR _this$[ebp]
	je	$L37300
	mov	edx, DWORD PTR _pRecruit$37293[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _pRecruit$37293[ebp]
...
; 353  : 					TraceResult tr;
	...
	lea	ecx, DWORD PTR _tr$37297[ebp]
...
; 354  : 					UTIL_TraceLine( EyePosition(), pRecruit->EyePosition(), ignore_monsters, pRecruit->edict(), &tr );// try to hit recruit with a traceline.
	...
	push	eax
	push	1
	lea	edx, DWORD PTR $T37845[ebp]
	push	edx
	mov	eax, DWORD PTR _pRecruit$37293[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pRecruit$37293[ebp]
	call	DWORD PTR [edx+308]
	push	eax
	lea	eax, DWORD PTR $T37846[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 355  : 					if ( tr.flFraction == 1.0 )
	...
	fld	DWORD PTR _tr$37297[ebp+16]
...
; 422  : 		int iSquadSize = SquadRecruit( 1024, 4 );
	...
	mov	DWORD PTR _iSquadSize$37321[ebp], eax

; 423  : 
; 424  : 		if ( iSquadSize )

	cmp	DWORD PTR _iSquadSize$37321[ebp], 0
	je	SHORT $L37322
...
; 426  : 		  ALERT ( at_aiconsole, "Squad of %d %s formed\n", iSquadSize, STRING( pev->classname ) );
	...
	add	esp, 4
	push	eax
	mov	edx, DWORD PTR _iSquadSize$37321[ebp]
	push	edx
...
; 463  : 		UTIL_MakeVectors ( UTIL_VecToAngles( m_hEnemy->Center() - GetAbsOrigin() ) );
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	eax, DWORD PTR $T37881[ebp]
	push	eax
	lea	ecx, DWORD PTR $T37880[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 1960				; 000007a8H
...
; 472  : 	vecRightSide = GetAbsOrigin() + ( gpGlobals->v_right * ( pev->size.x * 1.5 ) );
	...
	push	ecx
	fstp	DWORD PTR [esp]
	lea	eax, DWORD PTR $T37885[ebp]
	push	eax
	mov	ecx, DWORD PTR ?gpGlobals@@3PAUglobalvars_t@@A ; gpGlobals
	add	ecx, 64					; 00000040H
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T37886[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
; 488  : 		CSquadMonster *pMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37352[ebp], eax

; 489  : 		if (pMember && pMember != this)

	cmp	DWORD PTR _pMember$37352[ebp], 0
	je	SHORT $L37354
	mov	edx, DWORD PTR _pMember$37352[ebp]
...
; 494  : 				 rightPlane.PointInFront ( pMember->GetAbsOrigin()) )
	...
	mov	ecx, DWORD PTR _pMember$37352[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _backPlane$[ebp]
...
; 565  : 		CSquadMonster *pMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37383[ebp], eax

; 566  : 		if (pMember != NULL && pMember->m_hEnemy != NULL && pMember->m_hEnemy != pEnemy)

	cmp	DWORD PTR _pMember$37383[ebp], 0
	je	SHORT $L37384
	mov	ecx, DWORD PTR _pMember$37383[ebp]
	add	ecx, 1960				; 000007a8H
	call	??BEHANDLE@@QAEHXZ			; EHANDLE::operator int
	test	eax, eax
	je	SHORT $L37384
...
; 588  : 		CSquadMonster *pSquadMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pSquadMember$37396[ebp], eax

; 589  : 		if (pSquadMember && (vecLocation - pSquadMember->GetAbsOrigin() ).Length2D() <= flDist)

	cmp	DWORD PTR _pSquadMember$37396[ebp], 0
	je	SHORT $L37398
	mov	ecx, DWORD PTR _pSquadMember$37396[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	edx, DWORD PTR $T37913[ebp]
	push	edx
