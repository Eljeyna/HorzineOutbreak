...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T37802[ebp], edx
	mov	eax, DWORD PTR $T37802[ebp]
	push	eax
...
; 146  : 		for (int i = 0; i < MAX_SQUAD_MEMBERS-1;i++)
	...
	jmp	SHORT $L37218
$L37219:
	mov	edx, DWORD PTR _i$37217[ebp]
	add	edx, 1
	mov	DWORD PTR _i$37217[ebp], edx
$L37218:
	cmp	DWORD PTR _i$37217[ebp], 4
	jge	SHORT $L37220
...
; 148  : 			CSquadMonster *pMember = MySquadMember(i);
	...
	mov	DWORD PTR _pMember$37221[ebp], eax

; 149  : 			if (pMember)

	cmp	DWORD PTR _pMember$37221[ebp], 0
	je	SHORT $L37222

; 151  : 				pMember->m_hSquadLeader = NULL;

	push	0
	mov	ecx, DWORD PTR _pMember$37221[ebp]
	add	ecx, 2396				; 0000095cH
...
; 152  : 				m_hSquadMember[i] = NULL;
	...
	push	0
	mov	ecx, DWORD PTR _i$37217[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
; 158  : 		CSquadMonster *pSquadLeader = MySquadLeader();
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?MySquadLeader@CSquadMonster@@QAEPAV1@XZ ; CSquadMonster::MySquadLeader
	mov	DWORD PTR _pSquadLeader$37224[ebp], eax

; 159  : 		if (pSquadLeader)

	cmp	DWORD PTR _pSquadLeader$37224[ebp], 0
	je	SHORT $L37229

; 161  : 			for (int i = 0; i < MAX_SQUAD_MEMBERS-1;i++)

	mov	DWORD PTR _i$37226[ebp], 0
	jmp	SHORT $L37227
$L37228:
	mov	eax, DWORD PTR _i$37226[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37226[ebp], eax
$L37227:
	cmp	DWORD PTR _i$37226[ebp], 4
	jge	SHORT $L37229

; 163  : 				if (pSquadLeader->m_hSquadMember[i] == this)

	mov	ecx, DWORD PTR _i$37226[ebp]
	mov	edx, DWORD PTR _pSquadLeader$37224[ebp]
	lea	ecx, DWORD PTR [edx+ecx*8+2404]
	call	??BEHANDLE@@QAEPAVCBaseEntity@@XZ	; EHANDLE::operator CBaseEntity *
	cmp	eax, DWORD PTR _this$[ebp]
	jne	SHORT $L37230
...
; 165  : 					pSquadLeader->m_hSquadMember[i] = NULL;
	...
	push	0
	mov	eax, DWORD PTR _i$37226[ebp]
	mov	ecx, DWORD PTR _pSquadLeader$37224[ebp]
...
; 249  : 		CSquadMonster *pMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37267[ebp], eax

; 250  : 		if (pMember)

	cmp	DWORD PTR _pMember$37267[ebp], 0
	je	$L37269
...
; 253  : 			if (pMember->m_hEnemy != pEnemy && !pMember->HasConditions( bits_COND_SEE_ENEMY))
	...
	mov	ecx, DWORD PTR _pMember$37267[ebp]
...
; 258  : 					pMember->PushEnemy( pMember->m_hEnemy, pMember->m_vecEnemyLKP );
	...
	mov	edx, DWORD PTR _pMember$37267[ebp]
...
; 344  : 			CSquadMonster *pRecruit = pEntity->MySquadMonsterPointer( );
	...
	mov	ecx, DWORD PTR _pEntity$[ebp]
	call	DWORD PTR [eax+128]
	mov	DWORD PTR _pRecruit$37306[ebp], eax

; 345  : 
; 346  : 			if ( pRecruit && pRecruit != this && pRecruit->IsAlive() && !pRecruit->m_pCine )

	cmp	DWORD PTR _pRecruit$37306[ebp], 0
	je	$L37313
	mov	ecx, DWORD PTR _pRecruit$37306[ebp]
	cmp	ecx, DWORD PTR _this$[ebp]
	je	$L37313
	mov	edx, DWORD PTR _pRecruit$37306[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _pRecruit$37306[ebp]
...
; 353  : 					TraceResult tr;
	...
	lea	ecx, DWORD PTR _tr$37310[ebp]
...
; 354  : 					UTIL_TraceLine( EyePosition(), pRecruit->EyePosition(), ignore_monsters, pRecruit->edict(), &tr );// try to hit recruit with a traceline.
	...
	push	eax
	push	1
	lea	edx, DWORD PTR $T37858[ebp]
	push	edx
	mov	eax, DWORD PTR _pRecruit$37306[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pRecruit$37306[ebp]
	call	DWORD PTR [edx+308]
	push	eax
	lea	eax, DWORD PTR $T37859[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 355  : 					if ( tr.flFraction == 1.0 )
	...
	fld	DWORD PTR _tr$37310[ebp+16]
...
; 422  : 		int iSquadSize = SquadRecruit( 1024, 4 );
	...
	mov	DWORD PTR _iSquadSize$37334[ebp], eax

; 423  : 
; 424  : 		if ( iSquadSize )

	cmp	DWORD PTR _iSquadSize$37334[ebp], 0
	je	SHORT $L37335
...
; 426  : 		  ALERT ( at_aiconsole, "Squad of %d %s formed\n", iSquadSize, STRING( pev->classname ) );
	...
	add	esp, 4
	push	eax
	mov	edx, DWORD PTR _iSquadSize$37334[ebp]
	push	edx
...
; 488  : 		CSquadMonster *pMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37365[ebp], eax

; 489  : 		if (pMember && pMember != this)

	cmp	DWORD PTR _pMember$37365[ebp], 0
	je	SHORT $L37367
	mov	edx, DWORD PTR _pMember$37365[ebp]
...
; 494  : 				 rightPlane.PointInFront ( pMember->GetAbsOrigin()) )
	...
	mov	ecx, DWORD PTR _pMember$37365[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _backPlane$[ebp]
...
; 565  : 		CSquadMonster *pMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pMember$37396[ebp], eax

; 566  : 		if (pMember != NULL && pMember->m_hEnemy != NULL && pMember->m_hEnemy != pEnemy)

	cmp	DWORD PTR _pMember$37396[ebp], 0
	je	SHORT $L37397
	mov	ecx, DWORD PTR _pMember$37396[ebp]
	add	ecx, 1960				; 000007a8H
	call	??BEHANDLE@@QAEHXZ			; EHANDLE::operator int
	test	eax, eax
	je	SHORT $L37397
...
; 588  : 		CSquadMonster *pSquadMember = pSquadLeader->MySquadMember(i);
	...
	mov	ecx, DWORD PTR _pSquadLeader$[ebp]
	call	?MySquadMember@CSquadMonster@@QAEPAV1@H@Z ; CSquadMonster::MySquadMember
	mov	DWORD PTR _pSquadMember$37409[ebp], eax

; 589  : 		if (pSquadMember && (vecLocation - pSquadMember->GetAbsOrigin() ).Length2D() <= flDist)

	cmp	DWORD PTR _pSquadMember$37409[ebp], 0
	je	SHORT $L37411
	mov	ecx, DWORD PTR _pSquadMember$37409[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	edx, DWORD PTR $T37926[ebp]
	push	edx
