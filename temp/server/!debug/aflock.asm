...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T37915[ebp], edx
	mov	eax, DWORD PTR $T37915[ebp]
	push	eax
...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T37947[ebp], eax
	mov	ecx, DWORD PTR $T37947[ebp]
...
; 336  : 	UTIL_SetSize(pev, Vector(-5,-5,0), Vector(5,5,2));
	...
	push	1084227584				; 40a00000H
	lea	ecx, DWORD PTR $T38011[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	push	0
	push	-1063256064				; c0a00000H
	push	-1063256064				; c0a00000H
	lea	ecx, DWORD PTR $T38012[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
...
; 425  : 		int squadCount = 1;
	...
	mov	DWORD PTR _squadCount$37082[ebp], 1

; 426  : 
; 427  : 		CBaseEntity *pEntity = NULL;

	mov	DWORD PTR _pEntity$37083[ebp], 0
$L37085:
...
; 429  : 		while ((pEntity = UTIL_FindEntityInSphere( pEntity, GetAbsOrigin(), AFLOCK_MAX_RECRUIT_RADIUS )) != NULL)
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	mov	eax, DWORD PTR _pEntity$37083[ebp]
	push	eax
	call	?UTIL_FindEntityInSphere@@YAPAVCBaseEntity@@PAV1@ABVVector@@M@Z ; UTIL_FindEntityInSphere
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _pEntity$37083[ebp], eax
	cmp	DWORD PTR _pEntity$37083[ebp], 0
	je	SHORT $L37086

; 431  : 			CBaseMonster *pRecruit = pEntity->MyMonsterPointer( );

	mov	ecx, DWORD PTR _pEntity$37083[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _pEntity$37083[ebp]
	call	DWORD PTR [edx+124]
	mov	DWORD PTR _pRecruit$37087[ebp], eax

; 432  : 
; 433  : 			if ( pRecruit && pRecruit != this && pRecruit->IsAlive() && !pRecruit->m_pCine )

	cmp	DWORD PTR _pRecruit$37087[ebp], 0
	je	SHORT $L37089
	mov	eax, DWORD PTR _pRecruit$37087[ebp]
	cmp	eax, DWORD PTR _this$[ebp]
	je	SHORT $L37089
	mov	ecx, DWORD PTR _pRecruit$37087[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _pRecruit$37087[ebp]
...
; 438  : 					squadCount++;
	...
	mov	eax, DWORD PTR _squadCount$37082[ebp]
	add	eax, 1
	mov	DWORD PTR _squadCount$37082[ebp], eax
...
; 470  : 			pList->SetAbsVelocity( ( pList->GetAbsVelocity() + vecDir ) * 0.5 );
	...
	lea	edx, DWORD PTR $T38062[ebp]
	push	edx
	lea	eax, DWORD PTR _vecDir$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T38061[ebp]
	push	ecx
	mov	ecx, DWORD PTR _pList$[ebp]
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	mov	ecx, eax
...
; 540  : 	UTIL_TraceLine(GetAbsOrigin() - gpGlobals->v_right * 12, GetAbsOrigin() - gpGlobals->v_right * 12 + gpGlobals->v_forward * AFLOCK_CHECK_DIST, ignore_monsters, ENT(pev), &tr);
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	edx, DWORD PTR $T38098[ebp]
	push	edx
	push	1094713344				; 41400000H
	lea	eax, DWORD PTR $T38095[ebp]
	push	eax
	mov	ecx, DWORD PTR ?gpGlobals@@3PAUglobalvars_t@@A ; gpGlobals
	add	ecx, 64					; 00000040H
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T38096[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
_flLeftSide$ = -92
_flRightSide$ = -96
_avelocity$37163 = -108
_avelocity$37174 = -120
_avelocity$37177 = -132
_avelocity$37180 = -144
_avelocity$37182 = -156
_velocity$37187 = -168
_velocity$37191 = -180
...
; 581  : 			Vector avelocity = GetLocalAvelocity();
	...
	call	?GetLocalAvelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetLocalAvelocity
	push	eax
	lea	ecx, DWORD PTR _avelocity$37163[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 582  : 			avelocity.y = 0;

	mov	DWORD PTR _avelocity$37163[ebp+4], 0

; 583  : 			SetLocalAvelocity( avelocity );

	lea	edx, DWORD PTR _avelocity$37163[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetLocalAvelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetLocalAvelocity
$L37162:
...
; 623  : 			Vector avelocity = GetLocalAvelocity();
	...
	call	?GetLocalAvelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetLocalAvelocity
	push	eax
	lea	ecx, DWORD PTR _avelocity$37177[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 624  : 			avelocity.y = AFLOCK_TURN_RATE;

	mov	DWORD PTR _avelocity$37177[ebp+4], 1117126656 ; 42960000H

; 625  : 			SetLocalAvelocity( avelocity );

	lea	eax, DWORD PTR _avelocity$37177[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetLocalAvelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetLocalAvelocity
...
; 635  : 				Vector avelocity = GetLocalAvelocity();
	...
	call	?GetLocalAvelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetLocalAvelocity
	push	eax
	lea	ecx, DWORD PTR _avelocity$37180[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 636  : 				avelocity.y = AFLOCK_TURN_RATE;

	mov	DWORD PTR _avelocity$37180[ebp+4], 1117126656 ; 42960000H

; 637  : 				SetLocalAvelocity( avelocity );

	lea	eax, DWORD PTR _avelocity$37180[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetLocalAvelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetLocalAvelocity
...
; 641  : 				Vector avelocity = GetLocalAvelocity();
	...
	call	?GetLocalAvelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetLocalAvelocity
	push	eax
	lea	ecx, DWORD PTR _avelocity$37182[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 642  : 				avelocity.y = -AFLOCK_TURN_RATE;

	mov	DWORD PTR _avelocity$37182[ebp+4], -1030356992 ; c2960000H
...
; 655  : 		Vector velocity = GetAbsVelocity();
	...
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	push	eax
	lea	ecx, DWORD PTR _velocity$37187[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 656  : 		velocity.z = 0;

	mov	DWORD PTR _velocity$37187[ebp+8], 0

; 657  : 		SetAbsVelocity( velocity );

	lea	edx, DWORD PTR _velocity$37187[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity
$L37186:
...
; 663  : 		Vector velocity = GetAbsVelocity();
	...
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	push	eax
	lea	ecx, DWORD PTR _velocity$37191[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 664  : 		velocity.z = 0;

	mov	DWORD PTR _velocity$37191[ebp+8], 0

; 665  : 		SetAbsVelocity( velocity );

	lea	edx, DWORD PTR _velocity$37191[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity
$L37188:
...
; 737  : 		SetAbsVelocity( (GetAbsVelocity() + vecDirToLeader) * 0.5 ); 	
	...
	push	1056964608				; 3f000000H
	lea	ecx, DWORD PTR $T38129[ebp]
	push	ecx
	lea	edx, DWORD PTR _vecDirToLeader$[ebp]
	push	edx
	lea	eax, DWORD PTR $T38128[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	mov	ecx, eax
...
; 852  : 			CFlockingFlyer *pLeader = m_pSquadNext;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+2400]
	mov	DWORD PTR _pLeader$37244[ebp], eax
...
; 855  : 			pLeader->m_vecEnemyLKP = m_vecEnemyLKP;
	...
	mov	edx, DWORD PTR _pLeader$37244[ebp]
...
; 857  : 			if ( pLeader )
	...
	cmp	DWORD PTR _pLeader$37244[ebp], 0
	je	SHORT $L37249

; 859  : 				CFlockingFlyer *pList = pLeader;

	mov	edx, DWORD PTR _pLeader$37244[ebp]
	mov	DWORD PTR _pList$37246[ebp], edx
$L37248:

; 860  : 
; 861  : 				while ( pList )

	cmp	DWORD PTR _pList$37246[ebp], 0
	je	SHORT $L37249

; 863  : 					pList->m_pSquadLeader = pLeader;

	mov	eax, DWORD PTR _pList$37246[ebp]
	mov	ecx, DWORD PTR _pLeader$37244[ebp]
	mov	DWORD PTR [eax+2396], ecx

; 864  : 					pList = pList->m_pSquadNext;

	mov	edx, DWORD PTR _pList$37246[ebp]
	mov	eax, DWORD PTR [edx+2400]
	mov	DWORD PTR _pList$37246[ebp], eax
...
; 872  : 			CFlockingFlyer *pList = this;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR _pList$37251[ebp], ecx
$L37253:
...
; 875  : 			while ( pList->m_pSquadNext != pRemove )
	...
	mov	edx, DWORD PTR _pList$37251[ebp]
	mov	eax, DWORD PTR [edx+2400]
...
; 879  : 				pList = pList->m_pSquadNext;
	...
	mov	ecx, DWORD PTR _pList$37251[ebp]
	mov	edx, DWORD PTR [ecx+2400]
	mov	DWORD PTR _pList$37251[ebp], edx
...
; 1086 : 		a = new(pev) T;
	...
	add	esp, 8
	mov	DWORD PTR $T38197[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T38197[ebp], 0
	je	SHORT $L38198
	mov	ecx, DWORD PTR $T38197[ebp]
...
$L38199:
	...
	mov	DWORD PTR $T38196[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T38196[ebp]
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T38216[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T38216[ebp], 0
	je	SHORT $L38217
	mov	ecx, DWORD PTR $T38216[ebp]
	call	??0CFlockingFlyer@@QAE@XZ		; CFlockingFlyer::CFlockingFlyer
	mov	DWORD PTR -28+[ebp], eax
	jmp	SHORT $L38218
$L38217:
...
$L38218:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T38215[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T38215[ebp]
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T38231[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T38231[ebp], 0
	je	SHORT $L38232
	mov	ecx, DWORD PTR $T38231[ebp]
...
$L38233:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T38230[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T38230[ebp]
	mov	DWORD PTR _newEnt$[ebp], ecx
...
; 714  : 	virtual Vector Center( ) { return (pev->absmax + pev->absmin) * 0.5; }; // center point of entity
	...
	mov	DWORD PTR _this$[ebp], ecx
	push	1056964608				; 3f000000H
	lea	eax, DWORD PTR $T38360[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	add	edx, 196				; 000000c4H
	push	edx
	lea	eax, DWORD PTR $T38359[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 318  : 	virtual Vector BodyTarget( const Vector &posSrc ) { return Center( ) * 0.75 + EyePosition() * 0.25; };		// position to shoot at
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T38417[ebp]
	push	ecx
	push	1061158912				; 3f400000H
	lea	edx, DWORD PTR $T38414[ebp]
	push	edx
	lea	eax, DWORD PTR $T38413[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T38559[ebp], eax
	cmp	DWORD PTR $T38559[ebp], 0
	je	SHORT $L38560
	mov	ecx, DWORD PTR $T38559[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T38559[ebp]
