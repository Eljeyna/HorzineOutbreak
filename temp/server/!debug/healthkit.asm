...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T40286[ebp], eax
	cmp	DWORD PTR $T40286[ebp], 0
	je	SHORT $L40287
	mov	ecx, DWORD PTR $T40286[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T40286[ebp]
