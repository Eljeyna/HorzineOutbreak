...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T39105[ebp], eax
	mov	ecx, DWORD PTR $T39105[ebp]
...
; 115  : 		pev->dmg = gSkillData.plrDmgHornet;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR ?gSkillData@@3Uskilldata_t@@A+268
...
; 120  : 		pev->dmg = gSkillData.monDmgHornet;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR ?gSkillData@@3Uskilldata_t@@A+296
	mov	DWORD PTR [eax+480], ecx
$L38390:
...
; 332  : 		Vector vecVelocity = GetAbsVelocity();
	...
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	push	eax
	lea	ecx, DWORD PTR _vecVelocity$38486[ebp]
...
; 334  : 		vecVelocity.x += RANDOM_FLOAT ( -0.10, 0.10 );// scramble the flight dir a bit.
	...
	add	esp, 8
	fadd	DWORD PTR _vecVelocity$38486[ebp]
	fstp	DWORD PTR _vecVelocity$38486[ebp]
...
; 335  : 		vecVelocity.y += RANDOM_FLOAT ( -0.10, 0.10 );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+364
	add	esp, 8
	fadd	DWORD PTR _vecVelocity$38486[ebp+4]
	fstp	DWORD PTR _vecVelocity$38486[ebp+4]
...
; 336  : 		vecVelocity.z += RANDOM_FLOAT ( -0.10, 0.10 );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+364
	add	esp, 8
	fadd	DWORD PTR _vecVelocity$38486[ebp+8]
	fstp	DWORD PTR _vecVelocity$38486[ebp+8]

; 337  : 		SetAbsVelocity( vecVelocity );

	lea	eax, DWORD PTR _vecVelocity$38486[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity
$L38485:
...
; 362  : 			Vector vecOrigin = GetAbsOrigin();
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _vecOrigin$38499[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 365  : 				WRITE_COORD( vecOrigin.x );	// pos
	...
	mov	eax, DWORD PTR _vecOrigin$38499[ebp]
	push	eax
...
; 366  : 				WRITE_COORD( vecOrigin.y );
	...
	mov	ecx, DWORD PTR _vecOrigin$38499[ebp+4]
	push	ecx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 367  : 				WRITE_COORD( vecOrigin.z );
	...
	mov	edx, DWORD PTR _vecOrigin$38499[ebp+8]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 402  : 		Vector vecVelocity = GetAbsVelocity();
	...
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	push	eax
	lea	ecx, DWORD PTR _vecVelocity$38521[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 404  : 		vecVelocity = vecVelocity.Normalize();
	...
	call	?Normalize@Vector@@QBE?AV1@XZ		; Vector::Normalize
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _vecVelocity$38521[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecVelocity$38521[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _vecVelocity$38521[ebp+8], edx

; 405  : 
; 406  : 		vecVelocity.x *= -1;

	fld	DWORD PTR _vecVelocity$38521[ebp]
	fmul	DWORD PTR __real@4@bfff8000000000000000
	fstp	DWORD PTR _vecVelocity$38521[ebp]

; 407  : 		vecVelocity.y *= -1;

	fld	DWORD PTR _vecVelocity$38521[ebp+4]
	fmul	DWORD PTR __real@4@bfff8000000000000000
	fstp	DWORD PTR _vecVelocity$38521[ebp+4]

; 408  : 
; 409  : 		SetAbsVelocity( vecVelocity );

	lea	eax, DWORD PTR _vecVelocity$38521[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity
...
; 1106 : 		newEnt = new(pev) T;
	...
	add	esp, 8
	mov	DWORD PTR $T39295[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T39295[ebp], 0
	je	SHORT $L39296
	mov	ecx, DWORD PTR $T39295[ebp]
...
$L39297:
	...
	mov	DWORD PTR $T39294[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T39294[ebp]
...
; 714  : 	virtual Vector Center( ) { return (pev->absmax + pev->absmin) * 0.5; }; // center point of entity
	...
	lea	eax, DWORD PTR $T39418[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	add	edx, 196				; 000000c4H
	push	edx
	lea	eax, DWORD PTR $T39417[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 318  : 	virtual Vector BodyTarget( const Vector &posSrc ) { return Center( ) * 0.75 + EyePosition() * 0.25; };		// position to shoot at
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T39471[ebp]
	push	ecx
	push	1061158912				; 3f400000H
	lea	edx, DWORD PTR $T39468[ebp]
	push	edx
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T39613[ebp], eax
	cmp	DWORD PTR $T39613[ebp], 0
	je	SHORT $L39614
	mov	ecx, DWORD PTR $T39613[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T39613[ebp]
