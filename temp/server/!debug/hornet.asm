...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T39084[ebp], eax
	mov	ecx, DWORD PTR $T39084[ebp]
...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T39089[ebp], edx
	mov	eax, DWORD PTR $T39089[ebp]
	push	eax
...
; 115  : 		pev->dmg = gSkillData.plrDmgHornet;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR ?gSkillData@@3Uskilldata_t@@A+252
...
; 120  : 		pev->dmg = gSkillData.monDmgHornet;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR ?gSkillData@@3Uskilldata_t@@A+280
	mov	DWORD PTR [eax+480], ecx
$L38369:
...
; 326  : 	SetAbsVelocity(( vecFlightDir + vecDirToEnemy).Normalize() );
	...
	lea	eax, DWORD PTR $T39168[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecDirToEnemy$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T39167[ebp]
	push	edx
	lea	ecx, DWORD PTR _vecFlightDir$[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	ecx, eax
...
; 332  : 		Vector vecVelocity = GetAbsVelocity();
	...
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	push	eax
	lea	ecx, DWORD PTR _vecVelocity$38465[ebp]
...
; 334  : 		vecVelocity.x += RANDOM_FLOAT ( -0.10, 0.10 );// scramble the flight dir a bit.
	...
	add	esp, 8
	fadd	DWORD PTR _vecVelocity$38465[ebp]
	fstp	DWORD PTR _vecVelocity$38465[ebp]
...
; 335  : 		vecVelocity.y += RANDOM_FLOAT ( -0.10, 0.10 );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+364
	add	esp, 8
	fadd	DWORD PTR _vecVelocity$38465[ebp+4]
	fstp	DWORD PTR _vecVelocity$38465[ebp+4]
...
; 336  : 		vecVelocity.z += RANDOM_FLOAT ( -0.10, 0.10 );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+364
	add	esp, 8
	fadd	DWORD PTR _vecVelocity$38465[ebp+8]
	fstp	DWORD PTR _vecVelocity$38465[ebp+8]

; 337  : 		SetAbsVelocity( vecVelocity );

	lea	eax, DWORD PTR _vecVelocity$38465[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity
$L38464:
...
; 362  : 			Vector vecOrigin = GetAbsOrigin();
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _vecOrigin$38478[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 365  : 				WRITE_COORD( vecOrigin.x );	// pos
	...
	mov	eax, DWORD PTR _vecOrigin$38478[ebp]
	push	eax
...
; 366  : 				WRITE_COORD( vecOrigin.y );
	...
	mov	ecx, DWORD PTR _vecOrigin$38478[ebp+4]
	push	ecx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 367  : 				WRITE_COORD( vecOrigin.z );
	...
	mov	edx, DWORD PTR _vecOrigin$38478[ebp+8]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 402  : 		Vector vecVelocity = GetAbsVelocity();
	...
	call	?GetAbsVelocity@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsVelocity
	push	eax
	lea	ecx, DWORD PTR _vecVelocity$38500[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 404  : 		vecVelocity = vecVelocity.Normalize();
	...
	call	?Normalize@Vector@@QBE?AV1@XZ		; Vector::Normalize
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _vecVelocity$38500[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecVelocity$38500[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _vecVelocity$38500[ebp+8], edx

; 405  : 
; 406  : 		vecVelocity.x *= -1;

	fld	DWORD PTR _vecVelocity$38500[ebp]
	fmul	DWORD PTR __real@4@bfff8000000000000000
	fstp	DWORD PTR _vecVelocity$38500[ebp]

; 407  : 		vecVelocity.y *= -1;

	fld	DWORD PTR _vecVelocity$38500[ebp+4]
	fmul	DWORD PTR __real@4@bfff8000000000000000
	fstp	DWORD PTR _vecVelocity$38500[ebp+4]

; 408  : 
; 409  : 		SetAbsVelocity( vecVelocity );

	lea	eax, DWORD PTR _vecVelocity$38500[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity
...
; 1106 : 		newEnt = new(pev) T;
	...
	add	esp, 8
	mov	DWORD PTR $T39274[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T39274[ebp], 0
	je	SHORT $L39275
	mov	ecx, DWORD PTR $T39274[ebp]
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T39592[ebp], eax
	cmp	DWORD PTR $T39592[ebp], 0
	je	SHORT $L39593
	mov	ecx, DWORD PTR $T39592[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T39592[ebp]
