...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T38198[ebp], eax
	mov	ecx, DWORD PTR $T38198[ebp]
...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T38203[ebp], edx
	mov	eax, DWORD PTR $T38203[ebp]
	push	eax
...
; 376  : 	{
	...
	xor	eax, eax
	mov	al, BYTE PTR $L38243[ecx]
	jmp	DWORD PTR $L38244[eax*4]
$L37260:
...
; 416  : 			float yaw = VecToYaw(m_hTalkTarget->GetAbsOrigin() - GetAbsOrigin()) - GetAbsAngles().y;
	...
	fstp	DWORD PTR _yaw$37268[ebp]

; 417  : 
; 418  : 			if (yaw > 180) yaw -= 360;

	fld	DWORD PTR _yaw$37268[ebp]
...
; 457  : 			Vector dir = GetAbsAngles();
	...
	call	?GetAbsAngles@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsAngles
	push	eax
	lea	ecx, DWORD PTR _dir$37282[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 458  : 			dir.y = pev->ideal_yaw + 180;
	...
	fstp	DWORD PTR _dir$37282[ebp+4]

; 459  : 			Vector move;

	lea	ecx, DWORD PTR _move$37283[ebp]
...
; 462  : 			dir = GetAbsOrigin() + move * pTask->flData;
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _dir$37282[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _dir$37282[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _dir$37282[ebp+8], eax
...
; 496  : 	{
	...
	xor	eax, eax
	mov	al, BYTE PTR $L38295[ecx]
	jmp	DWORD PTR $L38296[eax*4]
$L37302:
...
; 506  : 			pPlayer = UTIL_PlayerByIndex( 1 );
	...
	add	esp, 4
	mov	DWORD PTR _pPlayer$37303[ebp], eax

; 507  : 
; 508  : 			if ( pPlayer )

	cmp	DWORD PTR _pPlayer$37303[ebp], 0
	je	SHORT $L37305

; 510  : 				IdleHeadTurn( pPlayer->GetAbsOrigin() );

	mov	ecx, DWORD PTR _pPlayer$37303[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 546  : 			CBaseEntity *pPlayer = UTIL_PlayerByIndex( 1 );
	...
	call	?UTIL_PlayerByIndex@@YAPAVCBaseEntity@@H@Z ; UTIL_PlayerByIndex
	add	esp, 4
	mov	DWORD PTR _pPlayer$37313[ebp], eax

; 547  : 
; 548  : 			if ( pPlayer )

	cmp	DWORD PTR _pPlayer$37313[ebp], 0
	je	$L37314

; 550  : 				MakeIdealYaw ( pPlayer->GetAbsOrigin() );

	mov	ecx, DWORD PTR _pPlayer$37313[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	sub	esp, 12					; 0000000cH
	mov	ecx, esp
	push	eax
...
; 581  : 			distance = (m_vecLastPosition - GetAbsOrigin()).Length2D();
	...
	mov	ecx, eax
	call	?Length2D@Vector@@QBEMXZ		; Vector::Length2D
	fstp	DWORD PTR _distance$37322[ebp]
...
; 584  : 			if ( distance > pTask->flData || MovementIsComplete() )
	...
	fld	DWORD PTR _distance$37322[ebp]
...
; 688  : 			CBaseMonster *pMonster = pFriend->MyMonsterPointer();
	...
	mov	DWORD PTR _pMonster$37378[ebp], eax

; 689  : 			if ( pMonster->IsAlive() )

	mov	eax, DWORD PTR _pMonster$37378[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pMonster$37378[ebp]
...
; 692  : 				pMonster->m_afMemory |= bits_MEMORY_PROVOKED;
	...
	or	ecx, 1
	mov	edx, DWORD PTR _pMonster$37378[ebp]
...
; 710  : 			CBaseMonster *pMonster = pFriend->MyMonsterPointer();
	...
	mov	ecx, DWORD PTR _pFriend$[ebp]
	call	DWORD PTR [edx+124]
	mov	DWORD PTR _pMonster$37392[ebp], eax

; 711  : 			if ( pMonster )

	cmp	DWORD PTR _pMonster$37392[ebp], 0
	je	SHORT $L37393

; 713  : 				pMonster->SentenceStop();

	mov	eax, DWORD PTR _pMonster$37392[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pMonster$37392[ebp]
	call	DWORD PTR [edx+476]
$L37393:
...
; 733  : 			CBaseMonster *pMonster = pFriend->MyMonsterPointer();
	...
	mov	ecx, DWORD PTR _pFriend$[ebp]
	call	DWORD PTR [edx+124]
	mov	DWORD PTR _pMonster$37408[ebp], eax

; 734  : 			if ( pMonster )

	cmp	DWORD PTR _pMonster$37408[ebp], 0
	je	SHORT $L37411

; 736  : 				if ( pMonster->m_hTargetEnt == pPlayer )

	mov	ecx, DWORD PTR _pMonster$37408[ebp]
	add	ecx, 1968				; 000007b0H
...
; 740  : 						pMonster->StopFollowing( TRUE );
	...
	push	1
	mov	edx, DWORD PTR _pMonster$37408[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _pMonster$37408[ebp]
...
; 794  : 		strcpy(szBuf,STRING(m_iszSpeakAs));
	...
	add	esp, 4
	push	eax
	lea	eax, DWORD PTR _szBuf$37437[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 795  : 		strcat(szBuf,"_");
	...
	lea	ecx, DWORD PTR _szBuf$37437[ebp]
	push	ecx
	call	_strcat
	add	esp, 8
...
; 796  : 		char *szAssign = &(szBuf[strlen(szBuf)]);
	...
	lea	edx, DWORD PTR _szBuf$37437[ebp]
	push	edx
	call	_strlen
	add	esp, 4
	lea	eax, DWORD PTR _szBuf$37437[ebp+eax]
	mov	DWORD PTR _szAssign$37439[ebp], eax
...
; 799  : 		strcpy(szAssign,"ANSWER");
	...
	mov	ecx, DWORD PTR _szAssign$37439[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 801  : 		strcpy(szAssign,"QUESTION");
	...
	mov	edx, DWORD PTR _szAssign$37439[ebp]
	push	edx
	call	_strcpy
	add	esp, 8
...
; 810  : 			strcpy(szAssign,"OK");
	...
	mov	eax, DWORD PTR _szAssign$37439[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
$L37446:
...
; 893  : 			CBaseMonster *pMonster = pFriend->MyMonsterPointer();
	...
	mov	ecx, DWORD PTR _pFriend$[ebp]
	call	DWORD PTR [edx+124]
	mov	DWORD PTR _pMonster$37495[ebp], eax
...
; 896  : 			if ( !pMonster || pMonster->m_MonsterState == MONSTERSTATE_SCRIPT || pMonster->m_MonsterState == MONSTERSTATE_PRONE )
	...
	cmp	DWORD PTR _pMonster$37495[ebp], 0
	je	SHORT $L37497
	mov	eax, DWORD PTR _pMonster$37495[ebp]
	cmp	DWORD PTR [eax+2080], 6
	je	SHORT $L37497
	mov	ecx, DWORD PTR _pMonster$37495[ebp]
...
; 943  : 		float speed = fabs(pOther->GetAbsVelocity().x) + fabs(pOther->GetAbsVelocity().y);
	...
	fstp	DWORD PTR _speed$37515[ebp]

; 944  : 		if ( speed > 50 )

	fld	DWORD PTR _speed$37515[ebp]
...
; 1036 : 		CBaseEntity *pPlayer = FindNearestFriend(TRUE);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindNearestFriend@CTalkMonster@@QAEPAVCBaseEntity@@H@Z ; CTalkMonster::FindNearestFriend
	mov	DWORD PTR _pPlayer$37554[ebp], eax

; 1037 : 
; 1038 : 		if (pPlayer)

	cmp	DWORD PTR _pPlayer$37554[ebp], 0
	je	$L37556

; 1040 : 			if (FInViewCone(pPlayer) && FVisible(pPlayer))

	mov	edx, DWORD PTR _pPlayer$37554[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _this$[ebp]
	...
	test	eax, eax
	je	$L37556
	mov	eax, DWORD PTR _pPlayer$37554[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1065 : 		float yaw = VecToYaw(vecFriend - GetAbsOrigin()) - GetAbsAngles().y;
	...
	fsub	DWORD PTR [eax+4]
	fstp	DWORD PTR _yaw$37566[ebp]

; 1066 : 
; 1067 : 		if (yaw > 180) yaw -= 360;

	fld	DWORD PTR _yaw$37566[ebp]
	fcomp	DWORD PTR __real@4@4006b400000000000000
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $L37569
...
; 1071 : 		SetBoneController( 0, yaw );
	...
	mov	eax, DWORD PTR _yaw$37566[ebp]
	push	eax
	push	0
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetBoneController@CBaseAnimating@@QAEMHM@Z ; CBaseAnimating::SetBoneController
...
; 1162 : 		CTalkMonster *pTalkMonster = (CTalkMonster *)pFriend;
	...
	mov	ecx, DWORD PTR _pFriend$[ebp]
	mov	DWORD PTR _pTalkMonster$37598[ebp], ecx
...
; 1164 : 		pTalkMonster->SetAnswerQuestion( this ); // UNDONE: This is EVIL!!!
	...
	mov	eax, DWORD PTR _this$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pTalkMonster$37598[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _pTalkMonster$37598[ebp]
...
; 1165 : 		pTalkMonster->m_flStopTalkTime = m_flStopTalkTime;
	...
	mov	eax, DWORD PTR _pTalkMonster$37598[ebp]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 1175 : 		CBaseEntity *pFriend = FindNearestFriend(TRUE);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindNearestFriend@CTalkMonster@@QAEPAVCBaseEntity@@H@Z ; CTalkMonster::FindNearestFriend
	mov	DWORD PTR _pFriend$37601[ebp], eax

; 1176 : 
; 1177 : 		if ( pFriend )

	cmp	DWORD PTR _pFriend$37601[ebp], 0
	je	SHORT $L37602

; 1179 : 			m_hTalkTarget = pFriend;

	mov	eax, DWORD PTR _pFriend$37601[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 2512				; 000009d0H
	call	??4EHANDLE@@QAEPAVCBaseEntity@@PAV1@@Z	; EHANDLE::operator=
...
; 1253 : 			CBaseEntity *pFriend = FindNearestFriend(FALSE);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FindNearestFriend@CTalkMonster@@QAEPAVCBaseEntity@@H@Z ; CTalkMonster::FindNearestFriend
	mov	DWORD PTR _pFriend$37645[ebp], eax

; 1254 : 
; 1255 : 			if (pFriend && pFriend->IsAlive())

	cmp	DWORD PTR _pFriend$37645[ebp], 0
	je	SHORT $L37646
	mov	eax, DWORD PTR _pFriend$37645[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pFriend$37645[ebp]
	call	DWORD PTR [edx+200]
	test	eax, eax
	je	SHORT $L37646
...
; 1258 : 				CTalkMonster *pTalkMonster = (CTalkMonster *)pFriend;
	...
	mov	eax, DWORD PTR _pFriend$37645[ebp]
	mov	DWORD PTR _pTalkMonster$37647[ebp], eax
...
; 1259 : 				pTalkMonster->ChangeSchedule( slIdleStopShooting );
	...
	mov	ecx, DWORD PTR _pTalkMonster$37647[ebp]
	call	?ChangeSchedule@CBaseMonster@@QAEXPAUSchedule_t@@@Z ; CBaseMonster::ChangeSchedule
$L37646:
...
; 1270 : 	{
	...
	xor	edx, edx
	mov	dl, BYTE PTR $L38415[eax]
	jmp	DWORD PTR $L38416[edx*4]
$L37657:
...
; 1324 : 				CBaseEntity *pPlayer = UTIL_PlayerByIndex( 1 );
	...
	call	?UTIL_PlayerByIndex@@YAPAVCBaseEntity@@H@Z ; UTIL_PlayerByIndex
	add	esp, 4
	mov	DWORD PTR _pPlayer$37672[ebp], eax

; 1325 : 
; 1326 : 				if ( pPlayer )

	cmp	DWORD PTR _pPlayer$37672[ebp], 0
	je	$L37673

; 1328 : 					// watch the client.
; 1329 : 					UTIL_MakeVectors ( pPlayer->GetAbsAngles() );

	mov	ecx, DWORD PTR _pPlayer$37672[ebp]
	call	?GetAbsAngles@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsAngles
	push	eax
	call	?UTIL_MakeVectors@@YAXABVVector@@@Z	; UTIL_MakeVectors
	add	esp, 4
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T38511[ebp], eax
	cmp	DWORD PTR $T38511[ebp], 0
	je	SHORT $L38512
	mov	ecx, DWORD PTR $T38511[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T38511[ebp]
