	TITLE	Z:\XashXTSRC\server\monsters\barnacle.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BB@DNPO@monster_barnacle?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_09PKBF@CBarnacle?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0N@MGJB@m_flAltitude?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BD@NCJL@m_flKillVictimTime?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_07FFOF@m_cGibs?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BC@EPKG@m_fTongueExtended?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0P@CELG@m_fLiftingPrey?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0O@FKMD@m_flTongueAdj?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0O@FIDM@BarnacleThink?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0N@LFLO@WaitTillDead?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BE@NDBF@models?1barnacle?4mdl?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BH@KELH@barnacle?1bcl_bite3?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BH@NIBG@barnacle?1bcl_chew1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BH@DIHJ@barnacle?1bcl_chew2?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BH@JIFM@barnacle?1bcl_chew3?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BI@KDNJ@barnacle?1bcl_alert2?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_07EMHC@attack1?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@CJEG@barnacle?1bcl_die1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@GJAM@barnacle?1bcl_die3?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDataDescMap@CBarnacle@@UAEPAUdatamap_s@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetBaseMap@CBarnacle@@SAPAUdatamap_s@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT _$E24
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT _$E28
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Classify@CBarnacle@@UAEHXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?HandleAnimEvent@CBarnacle@@UAEXPAUMonsterEvent_t@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Spawn@CBarnacle@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?TakeDamage@CBarnacle@@UAEHPAUentvars_s@@0MH@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?BarnacleThink@CBarnacle@@QAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Killed@CBarnacle@@UAEXPAUentvars_s@@H@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?WaitTillDead@CBarnacle@@QAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Precache@CBarnacle@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?TongueTouchEnt@CBarnacle@@QAEPAVCBaseEntity@@PAM@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0gametrace_s@@QAE@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0?$CEntityFactory@VCBarnacle@@@@QAE@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Create@?$CEntityFactory@VCBarnacle@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Destroy@?$CEntityFactory@VCBarnacle@@@@UAEXPAVCBaseEntity@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCBarnacle@@@@UAEIXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0CBarnacle@@QAE@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_7?$CEntityFactory@VCBarnacle@@@@6B@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
PUBLIC	?m_DataMap@CBarnacle@@2Udatamap_s@@A		; CBarnacle::m_DataMap
PUBLIC	??_C@_09PKBF@CBarnacle?$AA@			; `string'
PUBLIC	?g_DataMapHolder@CBarnacle_DataDescInit@@3PAUdatamap_s@@A ; CBarnacle_DataDescInit::g_DataMapHolder
PUBLIC	??_C@_0N@MGJB@m_flAltitude?$AA@			; `string'
PUBLIC	??_C@_0BD@NCJL@m_flKillVictimTime?$AA@		; `string'
PUBLIC	??_C@_07FFOF@m_cGibs?$AA@			; `string'
PUBLIC	??_C@_0BC@EPKG@m_fTongueExtended?$AA@		; `string'
PUBLIC	??_C@_0P@CELG@m_fLiftingPrey?$AA@		; `string'
PUBLIC	??_C@_0O@FKMD@m_flTongueAdj?$AA@		; `string'
_BSS	SEGMENT
?g_DataMapHolder@CBarnacle_DataDescInit@@3PAUdatamap_s@@A DD 01H DUP (?) ; CBarnacle_DataDescInit::g_DataMapHolder
_BSS	ENDS
CRT$XCU	SEGMENT
_$S23	DD	FLAT:_$E22
CRT$XCU	ENDS
_DATA	SEGMENT
?m_DataMap@CBarnacle@@2Udatamap_s@@A DD 00H		; CBarnacle::m_DataMap
	DD	00H
	DD	FLAT:??_C@_09PKBF@CBarnacle?$AA@
	DD	00H
_DATA	ENDS
CRT$XCU	SEGMENT
_$S26	DD	FLAT:_$E25
CRT$XCU	ENDS
_DATA	SEGMENT
_?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A DD 012H
	DD	00H
	DD	00H
	DW	00H
	DW	00H
	...
	DD	00H
	DD	00H
	DD	FLAT:??_C@_0N@MGJB@m_flAltitude?$AA@
	DD	095cH
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0fH
	DD	FLAT:??_C@_0BD@NCJL@m_flKillVictimTime?$AA@
	DD	0960H
	DW	01H
	DW	02H
	DD	00H
	...
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0BC@EPKG@m_fTongueExtended?$AA@
	DD	0968H
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	0cH
	DD	FLAT:??_C@_0P@CELG@m_fLiftingPrey?$AA@
	DD	096cH
	DW	01H
	DW	02H
	DD	00H
	DD	00H
	DD	00H
	DD	FLAT:??_C@_0O@FKMD@m_flTongueAdj?$AA@
	DD	0970H
	DW	01H
	DW	02H
	DD	00H
...
;	COMDAT ??_C@_09PKBF@CBarnacle?$AA@
CONST	SEGMENT
??_C@_09PKBF@CBarnacle?$AA@ DB 'CBarnacle', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@MGJB@m_flAltitude?$AA@
CONST	SEGMENT
??_C@_0N@MGJB@m_flAltitude?$AA@ DB 'm_flAltitude', 00H	; `string'
CONST	ENDS
;	COMDAT ??_C@_0BD@NCJL@m_flKillVictimTime?$AA@
CONST	SEGMENT
??_C@_0BD@NCJL@m_flKillVictimTime?$AA@ DB 'm_flKillVictimTime', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_07FFOF@m_cGibs?$AA@
CONST	SEGMENT
??_C@_07FFOF@m_cGibs?$AA@ DB 'm_cGibs', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BC@EPKG@m_fTongueExtended?$AA@
CONST	SEGMENT
??_C@_0BC@EPKG@m_fTongueExtended?$AA@ DB 'm_fTongueExtended', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0P@CELG@m_fLiftingPrey?$AA@
CONST	SEGMENT
??_C@_0P@CELG@m_fLiftingPrey?$AA@ DB 'm_fLiftingPrey', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0O@FKMD@m_flTongueAdj?$AA@
CONST	SEGMENT
??_C@_0O@FKMD@m_flTongueAdj?$AA@ DB 'm_flTongueAdj', 00H ; `string'
CONST	ENDS
...
_$E22	ENDP
_TEXT	ENDS
PUBLIC	??0?$CEntityFactory@VCBarnacle@@@@QAE@PBD@Z	; CEntityFactory<CBarnacle>::CEntityFactory<CBarnacle>
PUBLIC	??_C@_0BB@DNPO@monster_barnacle?$AA@		; `string'
_BSS	SEGMENT
_monster_barnacle DD 01H DUP (?)
_BSS	ENDS
;	COMDAT ??_C@_0BB@DNPO@monster_barnacle?$AA@
; File z:\xashxtsrc\server\monsters\barnacle.cpp
CONST	SEGMENT
??_C@_0BB@DNPO@monster_barnacle?$AA@ DB 'monster_barnacle', 00H ; `string'
CONST	ENDS
;	COMDAT _$E21
_TEXT	SEGMENT
_$E21	PROC NEAR					; COMDAT

; 57   : LINK_ENTITY_TO_CLASS( monster_barnacle, CBarnacle );
	...
	push	esi
	push	edi
	push	OFFSET FLAT:??_C@_0BB@DNPO@monster_barnacle?$AA@ ; `string'
	mov	ecx, OFFSET FLAT:_monster_barnacle
	call	??0?$CEntityFactory@VCBarnacle@@@@QAE@PBD@Z ; CEntityFactory<CBarnacle>::CEntityFactory<CBarnacle>
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
...
_$E21	ENDP
_TEXT	ENDS
PUBLIC	?GetDataDescMap@CBarnacle@@UAEPAUdatamap_s@@XZ	; CBarnacle::GetDataDescMap
;	COMDAT ?GetDataDescMap@CBarnacle@@UAEPAUdatamap_s@@XZ
_TEXT	SEGMENT
_this$ = -4
?GetDataDescMap@CBarnacle@@UAEPAUdatamap_s@@XZ PROC NEAR ; CBarnacle::GetDataDescMap, COMDAT

; 59   : BEGIN_DATADESC( CBarnacle )
	...
	mov	eax, OFFSET FLAT:?m_DataMap@CBarnacle@@2Udatamap_s@@A ; CBarnacle::m_DataMap
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
?GetDataDescMap@CBarnacle@@UAEPAUdatamap_s@@XZ ENDP	; CBarnacle::GetDataDescMap
_TEXT	ENDS
PUBLIC	?GetBaseMap@CBarnacle@@SAPAUdatamap_s@@XZ	; CBarnacle::GetBaseMap
PUBLIC	?DataMapAccess@@YAXPAVCBaseMonster@@PAPAUdatamap_s@@@Z ; DataMapAccess
;	COMDAT ?GetBaseMap@CBarnacle@@SAPAUdatamap_s@@XZ
_TEXT	SEGMENT
_pResult$ = -4
?GetBaseMap@CBarnacle@@SAPAUdatamap_s@@XZ PROC NEAR	; CBarnacle::GetBaseMap, COMDAT
...
; 59   : BEGIN_DATADESC( CBarnacle )
	...
	pop	ebp
	ret	0
?GetBaseMap@CBarnacle@@SAPAUdatamap_s@@XZ ENDP		; CBarnacle::GetBaseMap
_TEXT	ENDS
;	COMDAT _$E25
_TEXT	SEGMENT
...
_$E25	ENDP
_TEXT	ENDS
PUBLIC	?DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z	; DataMapInit
;	COMDAT _$E24
_TEXT	SEGMENT
...
; 59   : BEGIN_DATADESC( CBarnacle )
	...
	push	edi
	push	0
	call	?DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z ; DataMapInit
	add	esp, 4
	mov	DWORD PTR ?g_DataMapHolder@CBarnacle_DataDescInit@@3PAUdatamap_s@@A, eax ; CBarnacle_DataDescInit::g_DataMapHolder
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
...
PUBLIC	?BarnacleThink@CBarnacle@@QAEXXZ		; CBarnacle::BarnacleThink
PUBLIC	?WaitTillDead@CBarnacle@@QAEXXZ			; CBarnacle::WaitTillDead
PUBLIC	??_C@_0O@FIDM@BarnacleThink?$AA@		; `string'
PUBLIC	??_C@_0N@LFLO@WaitTillDead?$AA@			; `string'
EXTRN	_atexit:NEAR
_BSS	SEGMENT
_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4VCDatadescGeneratedNameHolder@@A DB 01cH DUP (?)
_?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA DB 01H DUP (?)
_BSS	ENDS
;	COMDAT ??_C@_0O@FIDM@BarnacleThink?$AA@
; File z:\xashxtsrc\server\monsters\barnacle.cpp
CONST	SEGMENT
??_C@_0O@FIDM@BarnacleThink?$AA@ DB 'BarnacleThink', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0N@LFLO@WaitTillDead?$AA@
CONST	SEGMENT
??_C@_0N@LFLO@WaitTillDead?$AA@ DB 'WaitTillDead', 00H	; `string'
CONST	ENDS
;	COMDAT ?DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z
_TEXT	SEGMENT
?DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z PROC NEAR ; DataMapInit, COMDAT
...
; 59   : BEGIN_DATADESC( CBarnacle )
	...
	push	edi
	xor	eax, eax
	mov	al, BYTE PTR _?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA
	and	eax, 1
	test	eax, eax
	jne	SHORT $L36593
	mov	cl, BYTE PTR _?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA
	or	cl, 1
	mov	BYTE PTR _?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA, cl
	push	OFFSET FLAT:??_C@_09PKBF@CBarnacle?$AA@	; `string'
	mov	ecx, OFFSET FLAT:_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4VCDatadescGeneratedNameHolder@@A
	...
	add	esp, 4
$L36593:
	call	?GetBaseMap@CBarnacle@@SAPAUdatamap_s@@XZ ; CBarnacle::GetBaseMap
	mov	DWORD PTR ?m_DataMap@CBarnacle@@2Udatamap_s@@A+12, eax

; 60   : 	DEFINE_FIELD( m_flAltitude, FIELD_FLOAT ),
; 61   : 	DEFINE_FIELD( m_flKillVictimTime, FIELD_TIME ),
; 62   : 	DEFINE_FIELD( m_cGibs, FIELD_INTEGER ),// barnacle loads up on gibs each time it kills something.
; 63   : 	DEFINE_FIELD( m_fTongueExtended, FIELD_BOOLEAN ),
; 64   : 	DEFINE_FIELD( m_fLiftingPrey, FIELD_BOOLEAN ),
; 65   : 	DEFINE_FIELD( m_flTongueAdj, FIELD_FLOAT ),
; 66   : 	DEFINE_FUNCTION( BarnacleThink ),

	xor	edx, edx
	mov	dl, BYTE PTR _?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA
	and	edx, 2
	test	edx, edx
	jne	$L36615
	mov	al, BYTE PTR _?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA
	or	al, 2
	mov	BYTE PTR _?$S27@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4EA, al
	push	OFFSET FLAT:??_C@_0O@FIDM@BarnacleThink?$AA@ ; `string'
	mov	ecx, OFFSET FLAT:_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4VCDatadescGeneratedNameHolder@@A
	call	?GenerateName@CDatadescGeneratedNameHolder@@QAEPBDPBD@Z ; CDatadescGeneratedNameHolder::GenerateName
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+172, eax
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+176, 0
	mov	WORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+180, 1
	mov	WORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+182, 8
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+184, 0
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+188, OFFSET FLAT:?BarnacleThink@CBarnacle@@QAEXXZ ; CBarnacle::BarnacleThink

; 67   : 	DEFINE_FUNCTION( WaitTillDead ),

	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+192, 18 ; 00000012H
	push	OFFSET FLAT:??_C@_0N@LFLO@WaitTillDead?$AA@ ; `string'
	mov	ecx, OFFSET FLAT:_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4VCDatadescGeneratedNameHolder@@A
	call	?GenerateName@CDatadescGeneratedNameHolder@@QAEPBDPBD@Z ; CDatadescGeneratedNameHolder::GenerateName
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+196, eax
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+200, 0
	mov	WORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+204, 1
	mov	WORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+206, 8
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+208, 0
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+212, OFFSET FLAT:?WaitTillDead@CBarnacle@@QAEXXZ ; CBarnacle::WaitTillDead
$L36615:
...
; 68   : END_DATADESC()
	...
	test	ecx, ecx
	je	SHORT $L36622
	mov	DWORD PTR ?m_DataMap@CBarnacle@@2Udatamap_s@@A+4, 8
	mov	DWORD PTR ?m_DataMap@CBarnacle@@2Udatamap_s@@A, OFFSET FLAT:_?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A+24
	jmp	SHORT $L36623
$L36622:
	mov	DWORD PTR ?m_DataMap@CBarnacle@@2Udatamap_s@@A+4, 1
	mov	DWORD PTR ?m_DataMap@CBarnacle@@2Udatamap_s@@A, OFFSET FLAT:_?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z@4PAUtypedescription_s@@A
$L36623:
	mov	eax, OFFSET FLAT:?m_DataMap@CBarnacle@@2Udatamap_s@@A ; CBarnacle::m_DataMap
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
?DataMapInit@@YAPAUdatamap_s@@PAVCBarnacle@@@Z ENDP	; DataMapInit
_TEXT	ENDS
...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T37321[ebp], eax
	mov	ecx, DWORD PTR $T37321[ebp]
...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T37326[ebp], edx
	mov	eax, DWORD PTR $T37326[ebp]
	push	eax
...
PUBLIC	?Classify@CBarnacle@@UAEHXZ			; CBarnacle::Classify
;	COMDAT ?Classify@CBarnacle@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4
?Classify@CBarnacle@@UAEHXZ PROC NEAR			; CBarnacle::Classify, COMDAT
...
; 77   : 	return m_iClass ? m_iClass : CLASS_ALIEN_MONSTER;
...
; 78   : }
	...
	pop	ebp
	ret	0
?Classify@CBarnacle@@UAEHXZ ENDP			; CBarnacle::Classify
_TEXT	ENDS
PUBLIC	?HandleAnimEvent@CBarnacle@@UAEXPAUMonsterEvent_t@@@Z ; CBarnacle::HandleAnimEvent
...
_pEvent$ = 8
_this$ = -4
?HandleAnimEvent@CBarnacle@@UAEXPAUMonsterEvent_t@@@Z PROC NEAR ; CBarnacle::HandleAnimEvent, COMDAT
...
; 90   : 	case BARNACLE_AE_PUKEGIB:
; 91   : 		CGib::SpawnRandomGibs( pev, 1, 1 );	
...
; 93   : 	default:
; 94   : 		CBaseMonster::HandleAnimEvent( pEvent );
...
; 97   : }
	...
	pop	ebp
	ret	4
?HandleAnimEvent@CBarnacle@@UAEXPAUMonsterEvent_t@@@Z ENDP ; CBarnacle::HandleAnimEvent
_TEXT	ENDS
PUBLIC	??0Vector@@QAE@MMM@Z				; Vector::Vector
PUBLIC	__real@4@00000000000000000000
PUBLIC	?Spawn@CBarnacle@@UAEXXZ			; CBarnacle::Spawn
PUBLIC	?ENT@@YAPAUedict_s@@PBUentvars_s@@@Z		; ENT
PUBLIC	??_C@_0BE@NDBF@models?1barnacle?4mdl?$AA@	; `string'
...
; File z:\xashxtsrc\server\monsters\barnacle.cpp
CONST	SEGMENT
??_C@_0BE@NDBF@models?1barnacle?4mdl?$AA@ DB 'models/barnacle.mdl', 00H ; `string'
CONST	ENDS
...
$T37347 = -28
_this$ = -4
?Spawn@CBarnacle@@UAEXXZ PROC NEAR			; CBarnacle::Spawn, COMDAT
...
; 107  : 		SET_MODEL(ENT(pev), STRING(pev->model)); //LRC
...
; 109  : 		SET_MODEL(ENT(pev), "models/barnacle.mdl");

	push	OFFSET FLAT:??_C@_0BE@NDBF@models?1barnacle?4mdl?$AA@ ; `string'
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	call	?ENT@@YAPAUedict_s@@PBUentvars_s@@@Z	; ENT
...
; 110  : 	UTIL_SetSize( pev, Vector(-16, -16, -32), Vector(16, 16, 0) );

	push	0
	push	1098907648				; 41800000H
	push	1098907648				; 41800000H
	lea	ecx, DWORD PTR $T37346[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	push	-1040187392				; c2000000H
	push	-1048576000				; c1800000H
	push	-1048576000				; c1800000H
	lea	ecx, DWORD PTR $T37347[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
...
; 111  : 
; 112  : 	pev->solid		= SOLID_SLIDEBOX;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR [eax+268], 3

; 113  : 	pev->movetype		= MOVETYPE_NONE;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+264], 0

; 114  : 	pev->takedamage		= DAMAGE_AIM;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+364], 1073741824		; 40000000H

; 115  : 	m_bloodColor		= BLOOD_COLOR_RED;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+2328], 247		; 000000f7H

; 116  : 	pev->effects		= EF_INVLIGHT;	// take light from the ceiling 

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+280], 16			; 00000010H
...
; 118  : 		pev->health	= 25;
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+352], 1103626240		; 41c80000H
$L36648:

; 119  : 	m_flFieldOfView		= 0.5;		// indicates the width of this monster's forward view cone ( as a dotproduct result )

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2056], 1056964608	; 3f000000H

; 120  : 	m_MonsterState		= MONSTERSTATE_NONE;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+2080], 0

; 121  : 	m_flKillVictimTime	= 0;
...
; 123  : 	m_fLiftingPrey		= FALSE;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+2412], 0

; 124  : 	m_flTongueAdj		= -100;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+2416], -1027080192	; c2c80000H

; 125  : 
; 126  : 	InitBoneControllers();

	mov	ecx, DWORD PTR _this$[ebp]
	call	?InitBoneControllers@CBaseAnimating@@QAEXXZ ; CBaseAnimating::InitBoneControllers

; 127  : 
; 128  : 	SetActivity ( ACT_IDLE );
...
; 129  : 
; 130  : 	SetThink ( BarnacleThink );

	push	OFFSET FLAT:??_C@_0O@FIDM@BarnacleThink?$AA@ ; `string'
	push	OFFSET FLAT:?BarnacleThink@CBarnacle@@QAEXXZ ; CBarnacle::BarnacleThink
	mov	ecx, DWORD PTR _this$[ebp]
	call	?ThinkSet@CBaseEntity@@QAEP81@AEXXZP81@AEXXZPAD@Z ; CBaseEntity::ThinkSet

; 131  : 	SetNextThink( 0.5 );
...
; 132  : 
; 133  : 	UTIL_SetOrigin ( this, GetLocalOrigin() );
...
; 134  : }
	...
	pop	ebp
	ret	0
?Spawn@CBarnacle@@UAEXXZ ENDP				; CBarnacle::Spawn
_TEXT	ENDS
;	COMDAT ??0Vector@@QAE@MMM@Z
_TEXT	SEGMENT
_X$ = 8
...
_TEXT	ENDS
PUBLIC	?TakeDamage@CBarnacle@@UAEHPAUentvars_s@@0MH@Z	; CBarnacle::TakeDamage
...
_bitsDamageType$ = 20
_this$ = -4
?TakeDamage@CBarnacle@@UAEHPAUentvars_s@@0MH@Z PROC NEAR ; CBarnacle::TakeDamage, COMDAT
...
; 138  : 	if ( bitsDamageType & DMG_CLUB )
...
; 142  : 
; 143  : 	return CBaseMonster::TakeDamage( pevInflictor, pevAttacker, flDamage, bitsDamageType );
...
; 144  : }
	...
	pop	ebp
	ret	16					; 00000010H
?TakeDamage@CBarnacle@@UAEHPAUentvars_s@@0MH@Z ENDP	; CBarnacle::TakeDamage
_TEXT	ENDS
...
PUBLIC	__real@8@4004b000000000000000
PUBLIC	__real@4@4002a000000000000000
PUBLIC	__real@4@bfff8000000000000000
PUBLIC	?TongueTouchEnt@CBarnacle@@QAEPAVCBaseEntity@@PAM@Z ; CBarnacle::TongueTouchEnt
PUBLIC	?SetBaseVelocity@CBaseEntity@@QAEXABVVector@@@Z	; CBaseEntity::SetBaseVelocity
PUBLIC	?FNullEnt@@YAHPBUedict_s@@@Z			; FNullEnt
PUBLIC	??_C@_0BH@KELH@barnacle?1bcl_bite3?4wav?$AA@	; `string'
PUBLIC	??_C@_0BH@NIBG@barnacle?1bcl_chew1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BH@DIHJ@barnacle?1bcl_chew2?4wav?$AA@	; `string'
PUBLIC	??_C@_0BH@JIFM@barnacle?1bcl_chew3?4wav?$AA@	; `string'
PUBLIC	??_C@_0BI@KDNJ@barnacle?1bcl_alert2?4wav?$AA@	; `string'
...
; File z:\xashxtsrc\server\monsters\barnacle.cpp
CONST	SEGMENT
??_C@_0BH@KELH@barnacle?1bcl_bite3?4wav?$AA@ DB 'barnacle/bcl_bite3.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@NIBG@barnacle?1bcl_chew1?4wav?$AA@
CONST	SEGMENT
??_C@_0BH@NIBG@barnacle?1bcl_chew1?4wav?$AA@ DB 'barnacle/bcl_chew1.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@DIHJ@barnacle?1bcl_chew2?4wav?$AA@
CONST	SEGMENT
??_C@_0BH@DIHJ@barnacle?1bcl_chew2?4wav?$AA@ DB 'barnacle/bcl_chew2.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@JIFM@barnacle?1bcl_chew3?4wav?$AA@
CONST	SEGMENT
??_C@_0BH@JIFM@barnacle?1bcl_chew3?4wav?$AA@ DB 'barnacle/bcl_chew3.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@KDNJ@barnacle?1bcl_alert2?4wav?$AA@
CONST	SEGMENT
??_C@_0BI@KDNJ@barnacle?1bcl_alert2?4wav?$AA@ DB 'barnacle/bcl_alert2.wav'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_07EMHC@attack1?$AA@
CONST	SEGMENT
...
CONST	ENDS
;	COMDAT __real@8@4004b000000000000000
CONST	SEGMENT
__real@8@4004b000000000000000 DQ 04046000000000000r ; 44
CONST	ENDS
...
_pVictim$ = -12
_flLength$ = -16
_vecNewEnemyOrigin$36670 = -28
_vecEntOrigin$36711 = -40
?BarnacleThink@CBarnacle@@QAEXXZ PROC NEAR		; CBarnacle::BarnacleThink, COMDAT
...
; 150  : 	CBaseEntity *pTouchEnt;
; 151  : 	CBaseMonster *pVictim;
; 152  : 	float flLength;
; 153  : 
; 154  : 	pev->nextthink = gpGlobals->time + 0.1;
...
; 158  : // barnacle has prey.
; 159  : 
; 160  : 		if ( !m_hEnemy->IsAlive() )
...
; 162  : 			// someone (maybe even the barnacle) killed the prey. Reset barnacle.
; 163  : 			m_fLiftingPrey = FALSE;// indicate that we're not lifting prey.
...
; 167  : 
; 168  : 		if ( m_fLiftingPrey )

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+2412], 0
	je	$L36668

; 170  : 			if ( m_hEnemy != NULL && m_hEnemy->pev->deadflag != DEAD_NO )
...
; 172  : 				// crap, someone killed the prey on the way up.
; 173  : 				m_hEnemy = NULL;
...
; 177  : 
; 178  : 			// still pulling prey.
; 179  : 			Vector vecNewEnemyOrigin = m_hEnemy->GetAbsOrigin();
	...
	push	eax
	lea	ecx, DWORD PTR _vecNewEnemyOrigin$36670[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 180  : 			vecNewEnemyOrigin.x = GetAbsOrigin().x;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _vecNewEnemyOrigin$36670[ebp], ecx

; 181  : 			vecNewEnemyOrigin.y = GetAbsOrigin().y;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecNewEnemyOrigin$36670[ebp+4], edx

; 182  : 
; 183  : 			// guess as to where their neck is
; 184  : 			vecNewEnemyOrigin.x -= 6 * cos( m_hEnemy->GetAbsAngles().y * M_PI / 180.0 );	

	fld	DWORD PTR _vecNewEnemyOrigin$36670[ebp]
	...
	fsubr	QWORD PTR -68+[ebp]
	fstp	DWORD PTR _vecNewEnemyOrigin$36670[ebp]

; 185  : 			vecNewEnemyOrigin.y -= 6 * sin( m_hEnemy->GetAbsAngles().y * M_PI / 180.0 );

	fld	DWORD PTR _vecNewEnemyOrigin$36670[ebp+4]
	...
	add	esp, 8
	fmul	QWORD PTR __real@8@4001c000000000000000
	fsubr	QWORD PTR -76+[ebp]
	fstp	DWORD PTR _vecNewEnemyOrigin$36670[ebp+4]

; 186  : 
; 187  : 			m_flAltitude -= BARNACLE_PULL_SPEED;
...
; 188  : 			vecNewEnemyOrigin.z += BARNACLE_PULL_SPEED;

	fld	DWORD PTR _vecNewEnemyOrigin$36670[ebp+8]
	fadd	DWORD PTR __real@4@40028000000000000000
	fstp	DWORD PTR _vecNewEnemyOrigin$36670[ebp+8]

; 189  : 
; 190  : 			if( fabs( GetAbsOrigin().z - ( vecNewEnemyOrigin.z + m_hEnemy->pev->view_ofs.z - 8 )) < BARNACLE_BODY_HEIGHT )
	...
	call	_fabs
	add	esp, 8
	fcomp	QWORD PTR __real@8@4004b000000000000000
	fnstsw	ax
	test	ah, 1
	je	$L36674

; 192  : 				// prey has just been lifted into position ( if the victim origin + eye height + 8 is higher than the bottom of the barnacle, it is assumed that the head is within barnacle's body )
; 193  : 				m_fLiftingPrey = FALSE;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2412], 0

; 194  : 
; 195  : 				EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_bite3.wav", 1, ATTN_NORM );	

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BH@KELH@barnacle?1bcl_bite3?4wav?$AA@ ; `string'
	push	1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
...
; 196  : 
; 197  : 				pVictim = m_hEnemy->MyMonsterPointer();
	...
	mov	DWORD PTR _pVictim$[ebp], eax

; 198  : 
; 199  : 				m_flKillVictimTime = gpGlobals->time + 10;// now that the victim is in place, the killing bite will be administered in 10 seconds.
...
; 203  : 					pVictim->BarnacleVictimBitten( pev );
	...
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _pVictim$[ebp]
	call	DWORD PTR [edx+556]

; 204  : 					SetActivity ( ACT_EAT );
...
; 207  : 
; 208  : 			UTIL_SetOrigin( m_hEnemy, vecNewEnemyOrigin );

	lea	eax, DWORD PTR _vecNewEnemyOrigin$36670[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 1960				; 000007a8H
...
; 212  : 	// prey is lifted fully into feeding position and is dangling there.
; 213  : 
; 214  : 			pVictim = m_hEnemy->MyMonsterPointer();
...
; 215  : 
; 216  : 			if ( m_flKillVictimTime != -1 && gpGlobals->time > m_flKillVictimTime )
...
; 221  : 					pVictim->TakeDamage ( pev, pev, pVictim->pev->health, DMG_SLASH | DMG_ALWAYSGIB );
...
; 227  : 
; 228  : 			// bite prey every once in a while
; 229  : 			if ( pVictim && ( RANDOM_LONG(0,49) == 0 ) )
...
; 233  : 				case 0:	EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_chew1.wav", 1, ATTN_NORM );	break;

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BH@NIBG@barnacle?1bcl_chew1?4wav?$AA@ ; `string'
	push	1
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
...
; 234  : 				case 1:	EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_chew2.wav", 1, ATTN_NORM );	break;

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BH@DIHJ@barnacle?1bcl_chew2?4wav?$AA@ ; `string'
	push	1
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
...
; 235  : 				case 2:	EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_chew3.wav", 1, ATTN_NORM );	break;

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BH@JIFM@barnacle?1bcl_chew3?4wav?$AA@ ; `string'
	push	1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	push	eax
...
; 237  : 
; 238  : 				pVictim->BarnacleVictimBitten( pev );
...
; 245  : // barnacle has no prey right now, so just idle and check to see if anything is touching the tongue.
; 246  : 
; 247  : 		// If idle and no nearby client, don't think so often
; 248  : 		if ( FNullEnt( FIND_CLIENT_IN_PVS( edict() ) ) )
...
; 249  : 			pev->nextthink = gpGlobals->time + RANDOM_FLOAT(1,1.5);	// Stagger a bit to keep barnacles from thinking on the same frame
...
; 250  : 
; 251  : 		if ( m_fSequenceFinished )

	mov	eax, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [eax+1804], 0
	je	SHORT $L36694

; 253  : 			SetActivity ( ACT_IDLE );
...
; 254  : 			m_flTongueAdj = -100;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2416], -1027080192	; c2c80000H
$L36694:

; 256  : 
; 257  : 		if ( m_cGibs && RANDOM_LONG(0,99) == 1 )

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+2404], 0
	je	$L36697
	push	99					; 00000063H
	push	0
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
...
; 259  : 			// cough up a gib.
; 260  : 			CGib::SpawnRandomGibs( pev, 1, 1 );
...
; 264  : 			{
	...
	je	SHORT $L36702
	cmp	DWORD PTR -92+[ebp], 2
	je	SHORT $L36704
	jmp	SHORT $L36697
$L36700:

; 265  : 			case 0: EMIT_SOUND( edict(), CHAN_WEAPON, "barnacle/bcl_chew1.wav", 1, ATTN_NORM ); break;
...
; 266  : 			case 1: EMIT_SOUND( edict(), CHAN_WEAPON, "barnacle/bcl_chew2.wav", 1, ATTN_NORM ); break;
...
; 267  : 			case 2: EMIT_SOUND( edict(), CHAN_WEAPON, "barnacle/bcl_chew3.wav", 1, ATTN_NORM ); break;
...
; 270  : 
; 271  : 		pTouchEnt = TongueTouchEnt( &flLength );

	lea	ecx, DWORD PTR _flLength$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?TongueTouchEnt@CBarnacle@@QAEPAVCBaseEntity@@PAM@Z ; CBarnacle::TongueTouchEnt
	mov	DWORD PTR _pTouchEnt$[ebp], eax

; 272  : 
; 273  : 		if ( pTouchEnt != NULL && m_fTongueExtended )

	cmp	DWORD PTR _pTouchEnt$[ebp], 0
	je	$L36706
	mov	edx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [edx+2408], 0
	je	$L36706

; 275  : 			// tongue is fully extended, and is touching someone.
; 276  : 			if ( pTouchEnt->FBecomeProne() )

	mov	eax, DWORD PTR _pTouchEnt$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pTouchEnt$[ebp]
	call	DWORD PTR [edx+300]
	test	eax, eax
	je	$L36707

; 278  : 				EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_alert2.wav", 1, ATTN_NORM );	

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BI@KDNJ@barnacle?1bcl_alert2?4wav?$AA@ ; `string'
	push	1
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
...
; 281  : 				m_flTongueAdj = -20;

	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [edx+2416], -1046478848	; c1a00000H

; 282  : 
; 283  : 				m_hEnemy = pTouchEnt;
...
; 284  : 
; 285  : 				pTouchEnt->pev->movetype = MOVETYPE_FLY;

	mov	ecx, DWORD PTR _pTouchEnt$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+264], 5

; 286  : 				pTouchEnt->SetAbsVelocity( g_vecZero );

	push	OFFSET FLAT:?g_vecZero@@3VVector@@B	; g_vecZero
	mov	ecx, DWORD PTR _pTouchEnt$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity

; 287  : 				pTouchEnt->SetBaseVelocity( g_vecZero );
...
; 288  : 
; 289  : 				Vector vecEntOrigin = pTouchEnt->GetAbsOrigin();

	mov	ecx, DWORD PTR _pTouchEnt$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _vecEntOrigin$36711[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 290  : 				vecEntOrigin.x = GetAbsOrigin().x;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR _vecEntOrigin$36711[ebp], eax

; 291  : 				vecEntOrigin.y = GetAbsOrigin().y;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecEntOrigin$36711[ebp+4], ecx

; 292  : 
; 293  : 				pTouchEnt->SetAbsOrigin( vecEntOrigin );

	lea	edx, DWORD PTR _vecEntOrigin$36711[ebp]
	push	edx
	mov	ecx, DWORD PTR _pTouchEnt$[ebp]
	call	?SetAbsOrigin@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsOrigin

; 294  : 
; 295  : 				m_fLiftingPrey = TRUE;// indicate that we should be lifting prey.

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2412], 1

; 296  : 				m_flKillVictimTime = -1;// set this to a bogus time while the victim is lifted.

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+2400], -1082130432	; bf800000H

; 297  : 
; 298  : 				m_flAltitude = (GetAbsOrigin().z - pTouchEnt->EyePosition().z);

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	esi, eax
	lea	edx, DWORD PTR $T37365[ebp]
	push	edx
	mov	eax, DWORD PTR _pTouchEnt$[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pTouchEnt$[ebp]
...
; 303  : 			// calculate a new length for the tongue to be clear of anything else that moves under it. 
; 304  : 			if ( m_flAltitude < flLength )
...
; 306  : 				// if tongue is higher than is should be, lower it kind of slowly.
; 307  : 				m_flAltitude += BARNACLE_PULL_SPEED;
...
; 312  : 				m_flAltitude = flLength;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _flLength$[ebp]
	mov	DWORD PTR [edx+2396], eax

; 313  : 				m_fTongueExtended = TRUE;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+2408], 1
$L36715:

; 319  : 
; 320  : 	// ALERT( at_console, "tounge %f\n", m_flAltitude + m_flTongueAdj );
; 321  : 	SetBoneController( 0, -(m_flAltitude + m_flTongueAdj) );
...
; 323  : }
	...
	pop	ebp
	ret	0
?BarnacleThink@CBarnacle@@QAEXXZ ENDP			; CBarnacle::BarnacleThink
_TEXT	ENDS
;	COMDAT ??0Vector@@QAE@ABV0@@Z
_TEXT	SEGMENT
_v$ = 8
...
_TEXT	ENDS
PUBLIC	?Killed@CBarnacle@@UAEXPAUentvars_s@@H@Z	; CBarnacle::Killed
PUBLIC	??_C@_0BG@CJEG@barnacle?1bcl_die1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BG@GJAM@barnacle?1bcl_die3?4wav?$AA@	; `string'
;	COMDAT ??_C@_0BG@CJEG@barnacle?1bcl_die1?4wav?$AA@
; File z:\xashxtsrc\server\monsters\barnacle.cpp
CONST	SEGMENT
??_C@_0BG@CJEG@barnacle?1bcl_die1?4wav?$AA@ DB 'barnacle/bcl_die1.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@GJAM@barnacle?1bcl_die3?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@GJAM@barnacle?1bcl_die3?4wav?$AA@ DB 'barnacle/bcl_die3.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ?Killed@CBarnacle@@UAEXPAUentvars_s@@H@Z
_TEXT	SEGMENT
_this$ = -4
_pVictim$ = -8
?Killed@CBarnacle@@UAEXPAUentvars_s@@H@Z PROC NEAR	; CBarnacle::Killed, COMDAT
...
; 330  : 	CBaseMonster *pVictim;
; 331  : 
; 332  : 	pev->solid = SOLID_NOT;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+268], 0

; 333  : 	pev->takedamage = DAMAGE_NO;
...
; 337  : 		pVictim = m_hEnemy->MyMonsterPointer();
...
; 341  : 			pVictim->BarnacleVictimReleased();
...
; 349  : 	case 0:	EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_die1.wav", 1, ATTN_NORM );	break;

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BG@CJEG@barnacle?1bcl_die1?4wav?$AA@ ; `string'
	push	1
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
...
; 350  : 	case 1:	EMIT_SOUND( ENT(pev), CHAN_WEAPON, "barnacle/bcl_die3.wav", 1, ATTN_NORM );	break;

	push	1061997773				; 3f4ccccdH
	push	1065353216				; 3f800000H
	push	OFFSET FLAT:??_C@_0BG@GJAM@barnacle?1bcl_die3?4wav?$AA@ ; `string'
	push	1
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	push	eax
...
; 357  : 
; 358  : 	pev->nextthink = gpGlobals->time + 0.1;
...
; 359  : 	SetThink ( WaitTillDead );

	push	OFFSET FLAT:??_C@_0N@LFLO@WaitTillDead?$AA@ ; `string'
	push	OFFSET FLAT:?WaitTillDead@CBarnacle@@QAEXXZ ; CBarnacle::WaitTillDead
	mov	ecx, DWORD PTR _this$[ebp]
	call	?ThinkSet@CBaseEntity@@QAEP81@AEXXZP81@AEXXZPAD@Z ; CBaseEntity::ThinkSet
...
; 360  : }
	...
	pop	ebp
	ret	8
?Killed@CBarnacle@@UAEXPAUentvars_s@@H@Z ENDP		; CBarnacle::Killed
_TEXT	ENDS
...
_this$ = -4
_flInterval$ = -8
?WaitTillDead@CBarnacle@@QAEXXZ PROC NEAR		; CBarnacle::WaitTillDead, COMDAT
...
; 366  : 	pev->nextthink = gpGlobals->time + 0.1;
...
; 367  : 
; 368  : 	float flInterval = StudioFrameAdvance( 0.1 );
...
; 369  : 	DispatchAnimEvents ( flInterval );
...
; 370  : 
; 371  : 	if ( m_fSequenceFinished )

	mov	ecx, DWORD PTR _this$[ebp]
	cmp	DWORD PTR [ecx+1804], 0
	je	SHORT $L36741

; 373  : 		// death anim finished. 
; 374  : 		StopAnimation();
...
; 377  : }
	...
	pop	ebp
	ret	0
?WaitTillDead@CBarnacle@@QAEXXZ ENDP			; CBarnacle::WaitTillDead
_TEXT	ENDS
;	COMDAT ?StopAnimation@CBaseMonster@@QAEXXZ
_TEXT	SEGMENT
_this$ = -4
...
_TEXT	ENDS
PUBLIC	?Precache@CBarnacle@@UAEXXZ			; CBarnacle::Precache
;	COMDAT ?Precache@CBarnacle@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
?Precache@CBarnacle@@UAEXXZ PROC NEAR			; CBarnacle::Precache, COMDAT
...
; 385  : 		PRECACHE_MODEL((char*)STRING(pev->model)); //LRC
...
; 387  : 		PRECACHE_MODEL("models/barnacle.mdl");
...
; 388  : 
; 389  : 	PRECACHE_SOUND("barnacle/bcl_alert2.wav");	// happy, lifting food up

	push	OFFSET FLAT:??_C@_0BI@KDNJ@barnacle?1bcl_alert2?4wav?$AA@ ; `string'
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 390  : 	PRECACHE_SOUND("barnacle/bcl_bite3.wav");	// just got food to mouth

	push	OFFSET FLAT:??_C@_0BH@KELH@barnacle?1bcl_bite3?4wav?$AA@ ; `string'
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 391  : 	PRECACHE_SOUND("barnacle/bcl_chew1.wav");

	push	OFFSET FLAT:??_C@_0BH@NIBG@barnacle?1bcl_chew1?4wav?$AA@ ; `string'
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 392  : 	PRECACHE_SOUND("barnacle/bcl_chew2.wav");

	push	OFFSET FLAT:??_C@_0BH@DIHJ@barnacle?1bcl_chew2?4wav?$AA@ ; `string'
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 393  : 	PRECACHE_SOUND("barnacle/bcl_chew3.wav");

	push	OFFSET FLAT:??_C@_0BH@JIFM@barnacle?1bcl_chew3?4wav?$AA@ ; `string'
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 394  : 	PRECACHE_SOUND("barnacle/bcl_die1.wav" );

	push	OFFSET FLAT:??_C@_0BG@CJEG@barnacle?1bcl_die1?4wav?$AA@ ; `string'
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4

; 395  : 	PRECACHE_SOUND("barnacle/bcl_die3.wav" );
...
; 396  : }	
	...
	pop	ebp
	ret	0
?Precache@CBarnacle@@UAEXXZ ENDP			; CBarnacle::Precache
_TEXT	ENDS
...
_count$ = -144
_i$36770 = -148
?TongueTouchEnt@CBarnacle@@QAEPAVCBaseEntity@@PAM@Z PROC NEAR ; CBarnacle::TongueTouchEnt, COMDAT
...
; 407  : 	float		length;
; 408  : 
; 409  : 	// trace once to hit architecture and see if the tongue needs to change position.
; 410  : 	UTIL_TraceLine ( GetAbsOrigin(), GetAbsOrigin() - Vector ( 0, 0, 2048 ), ignore_monsters, edict(), &tr );
	...
	push	0
	push	0
	lea	ecx, DWORD PTR $T37420[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	ecx, DWORD PTR $T37421[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
; 411  : 	length = fabs( GetAbsOrigin().z - tr.vecEndPos.z );

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	fld	DWORD PTR [eax+8]
	fsub	DWORD PTR _tr$[ebp+28]
	sub	esp, 8
	fstp	QWORD PTR [esp]
	call	_fabs
	add	esp, 8
...
; 413  : 	if ( pflLength )
	...
	cmp	DWORD PTR _pflLength$[ebp], 0
	je	SHORT $L36760

; 415  : 		*pflLength = length;

	mov	edx, DWORD PTR _pflLength$[ebp]
	mov	eax, DWORD PTR _length$[ebp]
	mov	DWORD PTR [edx], eax
$L36760:

; 417  : 
; 418  : 	Vector delta = Vector( BARNACLE_CHECK_SPACING, BARNACLE_CHECK_SPACING, 0 );

	push	0
	push	1090519040				; 41000000H
	push	1090519040				; 41000000H
	lea	ecx, DWORD PTR $T37422[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	ecx, DWORD PTR _delta$[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 419  : 	Vector mins = GetAbsOrigin() - delta;

	lea	ecx, DWORD PTR _delta$[ebp]
	push	ecx
	lea	edx, DWORD PTR $T37423[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
; 420  : 	Vector maxs = GetAbsOrigin() + delta;

	lea	eax, DWORD PTR _delta$[ebp]
	push	eax
	lea	ecx, DWORD PTR $T37424[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
; 421  : 	maxs.z = GetAbsOrigin().z;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _maxs$[ebp+8], edx

; 422  : 	mins.z -= length;

	fld	DWORD PTR _mins$[ebp+8]
	fsub	DWORD PTR _length$[ebp]
	fstp	DWORD PTR _mins$[ebp+8]

; 423  : 
; 424  : 	CBaseEntity *pList[10];
; 425  : 	int count = UTIL_EntitiesInBox( pList, 10, mins, maxs, (FL_CLIENT|FL_MONSTER) );
...
; 428  : 		for ( int i = 0; i < count; i++ )
	...
	mov	DWORD PTR _i$36770[ebp], 0
	jmp	SHORT $L36771
$L36772:
	mov	eax, DWORD PTR _i$36770[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36770[ebp], eax
$L36771:
	mov	ecx, DWORD PTR _i$36770[ebp]
	cmp	ecx, DWORD PTR _count$[ebp]
	jge	SHORT $L36773

; 430  : 			// only clients and monsters
; 431  : 			if ( pList[i] != this && IRelationship( pList[i] ) > R_NO && pList[ i ]->pev->deadflag == DEAD_NO )	// this ent is one of our enemies. Barnacle tries to eat it.

	mov	edx, DWORD PTR _i$36770[ebp]
...
; 433  : 				return pList[i];
	...
	mov	eax, DWORD PTR _i$36770[ebp]
	mov	eax, DWORD PTR _pList$[ebp+eax*4]
	jmp	SHORT $L36755
$L36774:
...
; 439  : }
	...
	pop	ebp
	ret	4
?TongueTouchEnt@CBarnacle@@QAEPAVCBaseEntity@@PAM@Z ENDP ; CBarnacle::TongueTouchEnt
_TEXT	ENDS
;	COMDAT ??HVector@@QBE?AV0@ABV0@@Z
_TEXT	SEGMENT
_v$ = 12
...
PUBLIC	?Create@?$CEntityFactory@VCBarnacle@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CBarnacle>::Create
PUBLIC	?Destroy@?$CEntityFactory@VCBarnacle@@@@UAEXPAVCBaseEntity@@@Z ; CEntityFactory<CBarnacle>::Destroy
PUBLIC	?GetEntitySize@?$CEntityFactory@VCBarnacle@@@@UAEIXZ ; CEntityFactory<CBarnacle>::GetEntitySize
PUBLIC	??_7?$CEntityFactory@VCBarnacle@@@@6B@		; CEntityFactory<CBarnacle>::`vftable'
EXTRN	?EntityFactoryDictionary@@YAPAVIEntityFactoryDictionary@@XZ:NEAR ; EntityFactoryDictionary
;	COMDAT ??_7?$CEntityFactory@VCBarnacle@@@@6B@
; File z:\xashxtsrc\server\util.h
CONST	SEGMENT
??_7?$CEntityFactory@VCBarnacle@@@@6B@ DD FLAT:?Create@?$CEntityFactory@VCBarnacle@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CBarnacle>::`vftable'
	DD	FLAT:?Destroy@?$CEntityFactory@VCBarnacle@@@@UAEXPAVCBaseEntity@@@Z
	DD	FLAT:?GetEntitySize@?$CEntityFactory@VCBarnacle@@@@UAEIXZ
CONST	ENDS
;	COMDAT ??0?$CEntityFactory@VCBarnacle@@@@QAE@PBD@Z
_TEXT	SEGMENT
_pClassName$ = 8
_this$ = -4
??0?$CEntityFactory@VCBarnacle@@@@QAE@PBD@Z PROC NEAR	; CEntityFactory<CBarnacle>::CEntityFactory<CBarnacle>, COMDAT
...
; 86   : 	CEntityFactory( const char *pClassName )
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET FLAT:??_7?$CEntityFactory@VCBarnacle@@@@6B@ ; CEntityFactory<CBarnacle>::`vftable'
...
; 89   : 	}
	...
	pop	ebp
	ret	4
??0?$CEntityFactory@VCBarnacle@@@@QAE@PBD@Z ENDP	; CEntityFactory<CBarnacle>::CEntityFactory<CBarnacle>
_TEXT	ENDS
PUBLIC	?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z	; GetClassPtr
;	COMDAT ?Create@?$CEntityFactory@VCBarnacle@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT
_pClassName$ = 8
_pev$ = 12
_this$ = -4
_pEnt$ = -8
?Create@?$CEntityFactory@VCBarnacle@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z PROC NEAR ; CEntityFactory<CBarnacle>::Create, COMDAT
...
; 93   : 		T* pEnt = GetClassPtr((T*)pev, pClassName);
	...
	push	ecx
	call	?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z ; GetClassPtr
	add	esp, 8
...
; 95   : 	}
	...
	pop	ebp
	ret	8
?Create@?$CEntityFactory@VCBarnacle@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ENDP ; CEntityFactory<CBarnacle>::Create
_TEXT	ENDS
...
_pEntity$ = 8
_this$ = -4
?Destroy@?$CEntityFactory@VCBarnacle@@@@UAEXPAVCBaseEntity@@@Z PROC NEAR ; CEntityFactory<CBarnacle>::Destroy, COMDAT
...
; 100  : 	}
	...
	pop	ebp
	ret	4
?Destroy@?$CEntityFactory@VCBarnacle@@@@UAEXPAVCBaseEntity@@@Z ENDP ; CEntityFactory<CBarnacle>::Destroy
_TEXT	ENDS
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCBarnacle@@@@UAEIXZ
_TEXT	SEGMENT
_this$ = -4
?GetEntitySize@?$CEntityFactory@VCBarnacle@@@@UAEIXZ PROC NEAR ; CEntityFactory<CBarnacle>::GetEntitySize, COMDAT
...
; 105  : 	}
	...
	pop	ebp
	ret	0
?GetEntitySize@?$CEntityFactory@VCBarnacle@@@@UAEIXZ ENDP ; CEntityFactory<CBarnacle>::GetEntitySize
_TEXT	ENDS
...
PUBLIC	??0CBarnacle@@QAE@XZ				; CBarnacle::CBarnacle
...
; File z:\xashxtsrc\server\cbase.h
xdata$x	SEGMENT
__ehfuncinfo$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z DD 019930520H
	DD	01H
	DD	FLAT:__unwindtable$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
__unwindtable$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z$0
xdata$x	ENDS
;	COMDAT ?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z
_TEXT	SEGMENT
$T37474 = -20
...
_className$ = 12
_pev$ = -16
?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z PROC NEAR	; GetClassPtr, COMDAT
...
; 1093 : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z
	mov	eax, DWORD PTR fs:__except_list
	push	eax
	mov	DWORD PTR fs:__except_list, esp
	sub	esp, 80					; 00000050H
...
; 1106 : 		newEnt = new(pev) T;
	...
	add	esp, 8
	mov	DWORD PTR $T37475[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T37475[ebp], 0
	je	SHORT $L37476
	mov	ecx, DWORD PTR $T37475[ebp]
	call	??0CBarnacle@@QAE@XZ			; CBarnacle::CBarnacle
...
$L37477:
	...
	mov	DWORD PTR $T37474[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T37474[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z$0:
	mov	eax, DWORD PTR _pev$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T37475[ebp]
	push	ecx
	...
	add	esp, 8
	ret	0
__ehhandler$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z
	jmp	___CxxFrameHandler
text$x	ENDS
?GetClassPtr@@YAPAVCBarnacle@@PAV1@PBD@Z ENDP		; GetClassPtr
;	COMDAT ?VARS@@YAPAUentvars_s@@PAUedict_s@@@Z
_TEXT	SEGMENT
_pent$ = 8
...
PUBLIC	??_7CBarnacle@@6B@				; CBarnacle::`vftable'
...
;	COMDAT ??_7CBarnacle@@6B@
CONST	SEGMENT
??_7CBarnacle@@6B@ DD FLAT:?GetDataDescMap@CBarnacle@@UAEPAUdatamap_s@@XZ ; CBarnacle::`vftable'
	DD	FLAT:?Spawn@CBarnacle@@UAEXXZ
	DD	FLAT:?Precache@CBarnacle@@UAEXXZ
	...
	DD	FLAT:?Classify@CBarnacle@@UAEHXZ
	...
	DD	FLAT:?TakeDamage@CBarnacle@@UAEHPAUentvars_s@@0MH@Z
	DD	FLAT:?TakeHealth@CBaseMonster@@UAEHMH@Z
	DD	FLAT:?TakeArmor@CBaseEntity@@UAEHMH@Z
	DD	FLAT:?Killed@CBarnacle@@UAEXPAUentvars_s@@H@Z
	...
	DD	FLAT:?HandleAnimEvent@CBarnacle@@UAEXPAUMonsterEvent_t@@@Z
...
_TEXT	SEGMENT
_this$ = -4
??0CBarnacle@@QAE@XZ PROC NEAR				; CBarnacle::CBarnacle, COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	push	ebx
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET FLAT:??_7CBarnacle@@6B@ ; CBarnacle::`vftable'
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0CBarnacle@@QAE@XZ ENDP				; CBarnacle::CBarnacle
_TEXT	ENDS
;	COMDAT ?ObjectCaps@CBaseEntity@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4
