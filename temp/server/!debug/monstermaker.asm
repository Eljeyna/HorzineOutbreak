...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T37291[ebp], eax
	mov	ecx, DWORD PTR $T37291[ebp]
...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T37296[ebp], edx
	mov	eax, DWORD PTR $T37296[ebp]
	push	eax
...
; 164  : 		TraceResult tr;
	...
	lea	ecx, DWORD PTR _tr$36690[ebp]
...
; 166  : 		UTIL_TraceLine ( GetAbsOrigin(), GetAbsOrigin() - Vector ( 0, 0, 2048 ), ignore_monsters, ENT(pev), &tr );
	...
	lea	edx, DWORD PTR _tr$36690[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	...
	push	0
	push	0
	lea	ecx, DWORD PTR $T37331[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	edx, DWORD PTR $T37332[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 167  : 		m_flGround = tr.vecEndPos.z;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _tr$36690[ebp+28]
...
; 171  : 	Vector maxs = GetAbsOrigin() + Vector( 34, 34, 0 );
	...
	push	1107820544				; 42080000H
	push	1107820544				; 42080000H
	lea	ecx, DWORD PTR $T37335[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	eax, DWORD PTR $T37336[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
$L37415:
	...
	mov	DWORD PTR $T37412[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T37412[ebp]
...
; 714  : 	virtual Vector Center( ) { return (pev->absmax + pev->absmin) * 0.5; }; // center point of entity
	...
	lea	eax, DWORD PTR $T37542[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	add	edx, 196				; 000000c4H
	push	edx
	lea	eax, DWORD PTR $T37541[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T37740[ebp], eax
	cmp	DWORD PTR $T37740[ebp], 0
	je	SHORT $L37741
	mov	ecx, DWORD PTR $T37740[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T37740[ebp]
