...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T37278[ebp], eax
	mov	ecx, DWORD PTR $T37278[ebp]
...
; 200  : 			delete m_Names[i];
	...
	mov	DWORD PTR $T37283[ebp], edx
	mov	eax, DWORD PTR $T37283[ebp]
	push	eax
...
; 164  : 		TraceResult tr;
	...
	lea	ecx, DWORD PTR _tr$36677[ebp]
...
; 166  : 		UTIL_TraceLine ( GetAbsOrigin(), GetAbsOrigin() - Vector ( 0, 0, 2048 ), ignore_monsters, ENT(pev), &tr );
	...
	lea	edx, DWORD PTR _tr$36677[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
...
; 167  : 		m_flGround = tr.vecEndPos.z;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR _tr$36677[ebp+28]
...
; 170  : 	Vector mins = GetAbsOrigin() - Vector( 34, 34, 0 );
	...
	push	1107820544				; 42080000H
	lea	ecx, DWORD PTR $T37320[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	edx, DWORD PTR $T37321[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
$L37402:
	...
	mov	DWORD PTR $T37399[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T37399[ebp]
...
; 318  : 	virtual Vector BodyTarget( const Vector &posSrc ) { return Center( ) * 0.75 + EyePosition() * 0.25; };		// position to shoot at
	...
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	ecx, DWORD PTR $T37591[ebp]
	push	ecx
	push	1061158912				; 3f400000H
	lea	edx, DWORD PTR $T37588[ebp]
	push	edx
	lea	eax, DWORD PTR $T37587[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T37727[ebp], eax
	cmp	DWORD PTR $T37727[ebp], 0
	je	SHORT $L37728
	mov	ecx, DWORD PTR $T37727[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T37727[ebp]
