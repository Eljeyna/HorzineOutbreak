...
; 1106 : 		newEnt = new(pev) T;
	...
	add	esp, 8
	mov	DWORD PTR $T39489[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T39489[ebp], 0
	je	SHORT $L39490
	mov	ecx, DWORD PTR $T39489[ebp]
