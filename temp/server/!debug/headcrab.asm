	TITLE	Z:\XashXTSRC\server\monsters\headcrab.cpp
	.386P
include listing.inc
if @Version gt 510
.model FLAT
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0P@ODNC@HCRangeAttack1?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_08OIJA@HCRAFast?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BB@GGGK@monster_headcrab?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_09LMD@CHeadCrab?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_09IOHL@LeapTouch?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@NOGO@headcrab?1hc_idle1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@DOAB@headcrab?1hc_idle2?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@JOCE@headcrab?1hc_idle3?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BH@CIGM@headcrab?1hc_alert1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@MFFD@headcrab?1hc_pain1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@CFDM@headcrab?1hc_pain2?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BG@IFBJ@headcrab?1hc_pain3?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BI@MNJG@headcrab?1hc_attack1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BI@CNPJ@headcrab?1hc_attack2?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BI@INNM@headcrab?1hc_attack3?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BF@DEPK@headcrab?1hc_die1?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BF@NEJF@headcrab?1hc_die2?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BJ@DBBP@headcrab?1hc_headbite?4wav?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BE@GOFB@models?1headcrab?4mdl?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_C@_0BJ@FGOK@models?1baby_headcrab?4mdl?$AA@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDamageAmount@CHeadCrab@@UAEMXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetVoicePitch@CHeadCrab@@UAEHXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetSoundVolue@CHeadCrab@@UAEMXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT _$E28
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetBaseMap@CHeadCrab@@SAPAUdatamap_s@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT _$E31
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT _$E35
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?ScheduleFromName@CHeadCrab@@UAEPAUSchedule_t@@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Classify@CHeadCrab@@UAEHXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Center@CHeadCrab@@UAE?AVVector@@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?BodyTarget@CHeadCrab@@UAE?AVVector@@ABV2@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?SetYawSpeed@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?HandleAnimEvent@CHeadCrab@@UAEXPAUMonsterEvent_t@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Spawn@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Precache@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?RunTask@CHeadCrab@@UAEXPAUTask_t@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?LeapTouch@CHeadCrab@@QAEXPAVCBaseEntity@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?PrescheduleThink@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?CheckRangeAttack1@CHeadCrab@@UAEHMM@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?TakeDamage@CHeadCrab@@UAEHPAUentvars_s@@0MH@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?IdleSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?AlertSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?PainSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?DeathSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetDamageAmount@CBabyCrab@@UAEMXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetVoicePitch@CBabyCrab@@UAEHXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetSoundVolue@CBabyCrab@@UAEMXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT _$E36
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Spawn@CBabyCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Precache@CBabyCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?SetYawSpeed@CBabyCrab@@UAEXXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?CheckRangeAttack1@CBabyCrab@@UAEHMM@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetScheduleOfType@CBabyCrab@@UAEPAUSchedule_t@@H@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0?$CEntityFactory@VCHeadCrab@@@@QAE@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Create@?$CEntityFactory@VCHeadCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Destroy@?$CEntityFactory@VCHeadCrab@@@@UAEXPAVCBaseEntity@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCHeadCrab@@@@UAEIXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0?$CEntityFactory@VCBabyCrab@@@@QAE@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Create@?$CEntityFactory@VCBabyCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?Destroy@?$CEntityFactory@VCBabyCrab@@@@UAEXPAVCBaseEntity@@@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCBabyCrab@@@@UAEIXZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0CHeadCrab@@QAE@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
;	COMDAT ??0CBabyCrab@@QAE@XZ
_TEXT	SEGMENT PARA USE32 PUBLIC 'CODE'
_TEXT	ENDS
...
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_7CHeadCrab@@6B@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_7?$CEntityFactory@VCBabyCrab@@@@6B@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_7CBabyCrab@@6B@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
;	COMDAT ??_7?$CEntityFactory@VCHeadCrab@@@@6B@
CONST	SEGMENT DWORD USE32 PUBLIC 'CONST'
CONST	ENDS
FLAT	GROUP _DATA, CONST, _BSS, CRT$XCA, CRT$XCU, CRT$XCL, CRT$XCC, CRT$XCZ
	ASSUME	CS: FLAT, DS: FLAT, SS: FLAT
endif
PUBLIC	?tlHCRangeAttack1@@3PAUTask_t@@A		; tlHCRangeAttack1
PUBLIC	?slHCRangeAttack1@@3PAUSchedule_t@@A		; slHCRangeAttack1
PUBLIC	??_C@_0P@ODNC@HCRangeAttack1?$AA@		; `string'
PUBLIC	?tlHCRangeAttack1Fast@@3PAUTask_t@@A		; tlHCRangeAttack1Fast
PUBLIC	?slHCRangeAttack1Fast@@3PAUSchedule_t@@A	; slHCRangeAttack1Fast
PUBLIC	??_C@_08OIJA@HCRAFast?$AA@			; `string'
PUBLIC	?m_DataMap@CHeadCrab@@2Udatamap_s@@A		; CHeadCrab::m_DataMap
PUBLIC	?m_scheduleList@CHeadCrab@@2PAPAUSchedule_t@@A	; CHeadCrab::m_scheduleList
PUBLIC	?pIdleSounds@CHeadCrab@@2PAPBDA			; CHeadCrab::pIdleSounds
PUBLIC	?pAlertSounds@CHeadCrab@@2PAPBDA		; CHeadCrab::pAlertSounds
PUBLIC	?pPainSounds@CHeadCrab@@2PAPBDA			; CHeadCrab::pPainSounds
PUBLIC	?pAttackSounds@CHeadCrab@@2PAPBDA		; CHeadCrab::pAttackSounds
PUBLIC	?pDeathSounds@CHeadCrab@@2PAPBDA		; CHeadCrab::pDeathSounds
PUBLIC	?pBiteSounds@CHeadCrab@@2PAPBDA			; CHeadCrab::pBiteSounds
PUBLIC	??_C@_09LMD@CHeadCrab?$AA@			; `string'
PUBLIC	?g_DataMapHolder@CHeadCrab_DataDescInit@@3PAUdatamap_s@@A ; CHeadCrab_DataDescInit::g_DataMapHolder
PUBLIC	??_C@_0BG@NOGO@headcrab?1hc_idle1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BG@DOAB@headcrab?1hc_idle2?4wav?$AA@	; `string'
PUBLIC	??_C@_0BG@JOCE@headcrab?1hc_idle3?4wav?$AA@	; `string'
PUBLIC	??_C@_0BH@CIGM@headcrab?1hc_alert1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BG@MFFD@headcrab?1hc_pain1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BG@CFDM@headcrab?1hc_pain2?4wav?$AA@	; `string'
PUBLIC	??_C@_0BG@IFBJ@headcrab?1hc_pain3?4wav?$AA@	; `string'
PUBLIC	??_C@_0BI@MNJG@headcrab?1hc_attack1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BI@CNPJ@headcrab?1hc_attack2?4wav?$AA@	; `string'
PUBLIC	??_C@_0BI@INNM@headcrab?1hc_attack3?4wav?$AA@	; `string'
PUBLIC	??_C@_0BF@DEPK@headcrab?1hc_die1?4wav?$AA@	; `string'
PUBLIC	??_C@_0BF@NEJF@headcrab?1hc_die2?4wav?$AA@	; `string'
PUBLIC	??_C@_0BJ@DBBP@headcrab?1hc_headbite?4wav?$AA@	; `string'
_BSS	SEGMENT
?g_DataMapHolder@CHeadCrab_DataDescInit@@3PAUdatamap_s@@A DD 01H DUP (?) ; CHeadCrab_DataDescInit::g_DataMapHolder
_BSS	ENDS
_DATA	SEGMENT
?tlHCRangeAttack1@@3PAUTask_t@@A DD 054H		; tlHCRangeAttack1
	DD	000000000r			; 0
	DD	01cH
	DD	000000000r			; 0
	DD	022H
	...
	DD	052H
	DD	03f000000r			; 0.5
?slHCRangeAttack1@@3PAUSchedule_t@@A DD FLAT:?tlHCRangeAttack1@@3PAUTask_t@@A ; slHCRangeAttack1
	DD	06H
	DD	021H
	DD	00H
	DD	FLAT:??_C@_0P@ODNC@HCRangeAttack1?$AA@
	ORG $+4
?tlHCRangeAttack1Fast@@3PAUTask_t@@A DD 054H		; tlHCRangeAttack1Fast
	DD	000000000r			; 0
	DD	01cH
	DD	000000000r			; 0
	DD	022H
	...
	DD	039H
	DD	03f800000r			; 1
?slHCRangeAttack1Fast@@3PAUSchedule_t@@A DD FLAT:?tlHCRangeAttack1Fast@@3PAUTask_t@@A ; slHCRangeAttack1Fast
	DD	04H
	DD	021H
	DD	00H
	DD	FLAT:??_C@_08OIJA@HCRAFast?$AA@
_DATA	ENDS
CRT$XCU	SEGMENT
_$S30	DD	FLAT:_$E29
CRT$XCU	ENDS
_DATA	SEGMENT
	ORG $+4
?m_DataMap@CHeadCrab@@2Udatamap_s@@A DD 00H		; CHeadCrab::m_DataMap
	DD	00H
	DD	FLAT:??_C@_09LMD@CHeadCrab?$AA@
	DD	00H
_DATA	ENDS
CRT$XCU	SEGMENT
_$S33	DD	FLAT:_$E32
CRT$XCU	ENDS
_DATA	SEGMENT
_?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A DD 012H
	DD	00H
	DD	00H
	DW	00H
	DW	00H
	...
	DD	012H
	ORG $+20
?m_scheduleList@CHeadCrab@@2PAPAUSchedule_t@@A DD FLAT:?slHCRangeAttack1@@3PAUSchedule_t@@A ; CHeadCrab::m_scheduleList
	DD	FLAT:?slHCRangeAttack1Fast@@3PAUSchedule_t@@A
?pIdleSounds@CHeadCrab@@2PAPBDA DD FLAT:??_C@_0BG@NOGO@headcrab?1hc_idle1?4wav?$AA@ ; CHeadCrab::pIdleSounds
	DD	FLAT:??_C@_0BG@DOAB@headcrab?1hc_idle2?4wav?$AA@
	DD	FLAT:??_C@_0BG@JOCE@headcrab?1hc_idle3?4wav?$AA@
?pAlertSounds@CHeadCrab@@2PAPBDA DD FLAT:??_C@_0BH@CIGM@headcrab?1hc_alert1?4wav?$AA@ ; CHeadCrab::pAlertSounds
?pPainSounds@CHeadCrab@@2PAPBDA DD FLAT:??_C@_0BG@MFFD@headcrab?1hc_pain1?4wav?$AA@ ; CHeadCrab::pPainSounds
	DD	FLAT:??_C@_0BG@CFDM@headcrab?1hc_pain2?4wav?$AA@
	DD	FLAT:??_C@_0BG@IFBJ@headcrab?1hc_pain3?4wav?$AA@
?pAttackSounds@CHeadCrab@@2PAPBDA DD FLAT:??_C@_0BI@MNJG@headcrab?1hc_attack1?4wav?$AA@ ; CHeadCrab::pAttackSounds
	DD	FLAT:??_C@_0BI@CNPJ@headcrab?1hc_attack2?4wav?$AA@
	DD	FLAT:??_C@_0BI@INNM@headcrab?1hc_attack3?4wav?$AA@
?pDeathSounds@CHeadCrab@@2PAPBDA DD FLAT:??_C@_0BF@DEPK@headcrab?1hc_die1?4wav?$AA@ ; CHeadCrab::pDeathSounds
	DD	FLAT:??_C@_0BF@NEJF@headcrab?1hc_die2?4wav?$AA@
?pBiteSounds@CHeadCrab@@2PAPBDA DD FLAT:??_C@_0BJ@DBBP@headcrab?1hc_headbite?4wav?$AA@ ; CHeadCrab::pBiteSounds
_DATA	ENDS
CRT$XCU	SEGMENT
_$S38	DD	FLAT:_$E37
CRT$XCU	ENDS
;	COMDAT ??_C@_0P@ODNC@HCRangeAttack1?$AA@
CONST	SEGMENT
??_C@_0P@ODNC@HCRangeAttack1?$AA@ DB 'HCRangeAttack1', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_08OIJA@HCRAFast?$AA@
CONST	SEGMENT
??_C@_08OIJA@HCRAFast?$AA@ DB 'HCRAFast', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_09LMD@CHeadCrab?$AA@
CONST	SEGMENT
??_C@_09LMD@CHeadCrab?$AA@ DB 'CHeadCrab', 00H		; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@NOGO@headcrab?1hc_idle1?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@NOGO@headcrab?1hc_idle1?4wav?$AA@ DB 'headcrab/hc_idle1.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@DOAB@headcrab?1hc_idle2?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@DOAB@headcrab?1hc_idle2?4wav?$AA@ DB 'headcrab/hc_idle2.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@JOCE@headcrab?1hc_idle3?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@JOCE@headcrab?1hc_idle3?4wav?$AA@ DB 'headcrab/hc_idle3.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BH@CIGM@headcrab?1hc_alert1?4wav?$AA@
CONST	SEGMENT
??_C@_0BH@CIGM@headcrab?1hc_alert1?4wav?$AA@ DB 'headcrab/hc_alert1.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@MFFD@headcrab?1hc_pain1?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@MFFD@headcrab?1hc_pain1?4wav?$AA@ DB 'headcrab/hc_pain1.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@CFDM@headcrab?1hc_pain2?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@CFDM@headcrab?1hc_pain2?4wav?$AA@ DB 'headcrab/hc_pain2.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BG@IFBJ@headcrab?1hc_pain3?4wav?$AA@
CONST	SEGMENT
??_C@_0BG@IFBJ@headcrab?1hc_pain3?4wav?$AA@ DB 'headcrab/hc_pain3.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@MNJG@headcrab?1hc_attack1?4wav?$AA@
CONST	SEGMENT
??_C@_0BI@MNJG@headcrab?1hc_attack1?4wav?$AA@ DB 'headcrab/hc_attack1.wav'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@CNPJ@headcrab?1hc_attack2?4wav?$AA@
CONST	SEGMENT
??_C@_0BI@CNPJ@headcrab?1hc_attack2?4wav?$AA@ DB 'headcrab/hc_attack2.wav'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BI@INNM@headcrab?1hc_attack3?4wav?$AA@
CONST	SEGMENT
??_C@_0BI@INNM@headcrab?1hc_attack3?4wav?$AA@ DB 'headcrab/hc_attack3.wav'
	DB	00H						; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@DEPK@headcrab?1hc_die1?4wav?$AA@
CONST	SEGMENT
??_C@_0BF@DEPK@headcrab?1hc_die1?4wav?$AA@ DB 'headcrab/hc_die1.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BF@NEJF@headcrab?1hc_die2?4wav?$AA@
CONST	SEGMENT
??_C@_0BF@NEJF@headcrab?1hc_die2?4wav?$AA@ DB 'headcrab/hc_die2.wav', 00H ; `string'
CONST	ENDS
;	COMDAT ??_C@_0BJ@DBBP@headcrab?1hc_headbite?4wav?$AA@
CONST	SEGMENT
...
_$E29	ENDP
_TEXT	ENDS
PUBLIC	??0?$CEntityFactory@VCHeadCrab@@@@QAE@PBD@Z	; CEntityFactory<CHeadCrab>::CEntityFactory<CHeadCrab>
PUBLIC	??_C@_0BB@GGGK@monster_headcrab?$AA@		; `string'
_BSS	SEGMENT
_monster_headcrab DD 01H DUP (?)
_BSS	ENDS
;	COMDAT ??_C@_0BB@GGGK@monster_headcrab?$AA@
; File z:\xashxtsrc\server\monsters\headcrab.cpp
CONST	SEGMENT
...
; 111  : LINK_ENTITY_TO_CLASS( monster_headcrab, CHeadCrab );
	...
	mov	ecx, OFFSET FLAT:_monster_headcrab
	call	??0?$CEntityFactory@VCHeadCrab@@@@QAE@PBD@Z ; CEntityFactory<CHeadCrab>::CEntityFactory<CHeadCrab>
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
...
_$E28	ENDP
_TEXT	ENDS
PUBLIC	?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ	; CHeadCrab::GetDataDescMap
;	COMDAT ?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ
_TEXT	SEGMENT
_this$ = -4
?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ PROC NEAR ; CHeadCrab::GetDataDescMap, COMDAT

; 113  : BEGIN_DATADESC( CHeadCrab )
	...
	mov	eax, OFFSET FLAT:?m_DataMap@CHeadCrab@@2Udatamap_s@@A ; CHeadCrab::m_DataMap
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ ENDP	; CHeadCrab::GetDataDescMap
_TEXT	ENDS
PUBLIC	?GetBaseMap@CHeadCrab@@SAPAUdatamap_s@@XZ	; CHeadCrab::GetBaseMap
PUBLIC	?DataMapAccess@@YAXPAVCBaseMonster@@PAPAUdatamap_s@@@Z ; DataMapAccess
;	COMDAT ?GetBaseMap@CHeadCrab@@SAPAUdatamap_s@@XZ
_TEXT	SEGMENT
_pResult$ = -4
?GetBaseMap@CHeadCrab@@SAPAUdatamap_s@@XZ PROC NEAR	; CHeadCrab::GetBaseMap, COMDAT
...
; 113  : BEGIN_DATADESC( CHeadCrab )
	...
	pop	ebp
	ret	0
?GetBaseMap@CHeadCrab@@SAPAUdatamap_s@@XZ ENDP		; CHeadCrab::GetBaseMap
_TEXT	ENDS
;	COMDAT _$E32
_TEXT	SEGMENT
...
_$E32	ENDP
_TEXT	ENDS
PUBLIC	?DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z	; DataMapInit
;	COMDAT _$E31
_TEXT	SEGMENT
...
; 113  : BEGIN_DATADESC( CHeadCrab )
	...
	push	edi
	push	0
	call	?DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z ; DataMapInit
	add	esp, 4
	mov	DWORD PTR ?g_DataMapHolder@CHeadCrab_DataDescInit@@3PAUdatamap_s@@A, eax ; CHeadCrab_DataDescInit::g_DataMapHolder
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
...
PUBLIC	?LeapTouch@CHeadCrab@@QAEXPAVCBaseEntity@@@Z	; CHeadCrab::LeapTouch
PUBLIC	??_C@_09IOHL@LeapTouch?$AA@			; `string'
EXTRN	_atexit:NEAR
_BSS	SEGMENT
_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4VCDatadescGeneratedNameHolder@@A DB 01cH DUP (?)
_?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA DB 01H DUP (?)
_BSS	ENDS
;	COMDAT ??_C@_09IOHL@LeapTouch?$AA@
; File z:\xashxtsrc\server\monsters\headcrab.cpp
CONST	SEGMENT
??_C@_09IOHL@LeapTouch?$AA@ DB 'LeapTouch', 00H		; `string'
CONST	ENDS
;	COMDAT ?DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z
_TEXT	SEGMENT
?DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z PROC NEAR ; DataMapInit, COMDAT
...
; 113  : BEGIN_DATADESC( CHeadCrab )
	...
	push	edi
	xor	eax, eax
	mov	al, BYTE PTR _?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA
	and	eax, 1
	test	eax, eax
	jne	SHORT $L36687
	mov	cl, BYTE PTR _?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA
	or	cl, 1
	mov	BYTE PTR _?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA, cl
	push	OFFSET FLAT:??_C@_09LMD@CHeadCrab?$AA@	; `string'
	mov	ecx, OFFSET FLAT:_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4VCDatadescGeneratedNameHolder@@A
	...
	add	esp, 4
$L36687:
	call	?GetBaseMap@CHeadCrab@@SAPAUdatamap_s@@XZ ; CHeadCrab::GetBaseMap
	mov	DWORD PTR ?m_DataMap@CHeadCrab@@2Udatamap_s@@A+12, eax

; 114  : 	DEFINE_FUNCTION( LeapTouch ),

	xor	edx, edx
	mov	dl, BYTE PTR _?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA
	and	edx, 2
	test	edx, edx
	jne	SHORT $L36691
	mov	al, BYTE PTR _?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA
	or	al, 2
	mov	BYTE PTR _?$S34@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4EA, al
	push	OFFSET FLAT:??_C@_09IOHL@LeapTouch?$AA@	; `string'
	mov	ecx, OFFSET FLAT:_?nameHolder@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4VCDatadescGeneratedNameHolder@@A
	call	?GenerateName@CDatadescGeneratedNameHolder@@QAEPBDPBD@Z ; CDatadescGeneratedNameHolder::GenerateName
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+28, eax
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+32, 0
	mov	WORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+36, 1
	mov	WORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+38, 8
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+40, 0
	mov	DWORD PTR _?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+44, OFFSET FLAT:?LeapTouch@CHeadCrab@@QAEXPAVCBaseEntity@@@Z ; CHeadCrab::LeapTouch
$L36691:
...
; 115  : END_DATADESC()
	...
	test	ecx, ecx
	je	SHORT $L36695
	mov	DWORD PTR ?m_DataMap@CHeadCrab@@2Udatamap_s@@A+4, 1
	mov	DWORD PTR ?m_DataMap@CHeadCrab@@2Udatamap_s@@A, OFFSET FLAT:_?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A+24
	jmp	SHORT $L36696
$L36695:
	mov	DWORD PTR ?m_DataMap@CHeadCrab@@2Udatamap_s@@A+4, 1
	mov	DWORD PTR ?m_DataMap@CHeadCrab@@2Udatamap_s@@A, OFFSET FLAT:_?dataDesc@?1??DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z@4PAUtypedescription_s@@A
$L36696:
	mov	eax, OFFSET FLAT:?m_DataMap@CHeadCrab@@2Udatamap_s@@A ; CHeadCrab::m_DataMap
	pop	edi
	pop	esi
	...
	pop	ebp
	ret	0
?DataMapInit@@YAPAUdatamap_s@@PAVCHeadCrab@@@Z ENDP	; DataMapInit
_TEXT	ENDS
...
; 206  : 		char *pBuf = new char[m_nLenBase + strlen(pszIdentifier) + 1];
	...
	add	esp, 4
	mov	DWORD PTR $T37654[ebp], eax
	mov	ecx, DWORD PTR $T37654[ebp]
...
PUBLIC	?ScheduleFromName@CHeadCrab@@UAEPAUSchedule_t@@PBD@Z ; CHeadCrab::ScheduleFromName
...
_this$ = -4
_pSchedule$ = -8
?ScheduleFromName@CHeadCrab@@UAEPAUSchedule_t@@PBD@Z PROC NEAR ; CHeadCrab::ScheduleFromName, COMDAT

; 123  : IMPLEMENT_CUSTOM_SCHEDULES( CHeadCrab, CBaseMonster );
	...
	mov	DWORD PTR _this$[ebp], ecx
	push	2
	push	OFFSET FLAT:?m_scheduleList@CHeadCrab@@2PAPAUSchedule_t@@A ; CHeadCrab::m_scheduleList
...
$L36701:
	...
	pop	ebp
	ret	4
?ScheduleFromName@CHeadCrab@@UAEPAUSchedule_t@@PBD@Z ENDP ; CHeadCrab::ScheduleFromName
_TEXT	ENDS
PUBLIC	?Classify@CHeadCrab@@UAEHXZ			; CHeadCrab::Classify
;	COMDAT ?Classify@CHeadCrab@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4
?Classify@CHeadCrab@@UAEHXZ PROC NEAR			; CHeadCrab::Classify, COMDAT
...
; 165  : 	return m_iClass ? m_iClass : CLASS_ALIEN_PREY;
...
; 166  : }
	...
	pop	ebp
	ret	0
?Classify@CHeadCrab@@UAEHXZ ENDP			; CHeadCrab::Classify
_TEXT	ENDS
PUBLIC	??0Vector@@QAE@MMM@Z				; Vector::Vector
PUBLIC	??0Vector@@QAE@ABV0@@Z				; Vector::Vector
PUBLIC	?Center@CHeadCrab@@UAE?AVVector@@XZ		; CHeadCrab::Center
...
___$ReturnUdt$ = 8
_this$ = -4
?Center@CHeadCrab@@UAE?AVVector@@XZ PROC NEAR		; CHeadCrab::Center, COMDAT
...
; 175  : 	return Vector( GetAbsOrigin().x, GetAbsOrigin().y, GetAbsOrigin().z + 6 );
...
; 176  : }
	...
	pop	ebp
	ret	4
?Center@CHeadCrab@@UAE?AVVector@@XZ ENDP		; CHeadCrab::Center
_TEXT	ENDS
;	COMDAT ??0Vector@@QAE@MMM@Z
_TEXT	SEGMENT
_X$ = 8
...
_TEXT	ENDS
PUBLIC	?BodyTarget@CHeadCrab@@UAE?AVVector@@ABV2@@Z	; CHeadCrab::BodyTarget
;	COMDAT ?BodyTarget@CHeadCrab@@UAE?AVVector@@ABV2@@Z
_TEXT	SEGMENT
$T37689 = -16
___$ReturnUdt$ = 8
_this$ = -4
?BodyTarget@CHeadCrab@@UAE?AVVector@@ABV2@@Z PROC NEAR	; CHeadCrab::BodyTarget, COMDAT
...
; 182  : }
	...
	pop	ebp
	ret	8
?BodyTarget@CHeadCrab@@UAE?AVVector@@ABV2@@Z ENDP	; CHeadCrab::BodyTarget
_TEXT	ENDS
PUBLIC	?SetYawSpeed@CHeadCrab@@UAEXXZ			; CHeadCrab::SetYawSpeed
;	COMDAT ?SetYawSpeed@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
_ys$ = -8
?SetYawSpeed@CHeadCrab@@UAEXXZ PROC NEAR		; CHeadCrab::SetYawSpeed, COMDAT
...
; 193  : 	{
	...
	xor	eax, eax
	mov	al, BYTE PTR $L37692[ecx]
	jmp	DWORD PTR $L37693[eax*4]
$L36742:
...
; 199  : 		ys = 20;
	...
	mov	DWORD PTR _ys$[ebp], 20			; 00000014H
...
; 201  : 	case ACT_TURN_LEFT:
; 202  : 	case ACT_TURN_RIGHT:
; 203  : 		ys = 60;
...
$L37692:
	...
	DB	4
	DB	3
?SetYawSpeed@CHeadCrab@@UAEXXZ ENDP			; CHeadCrab::SetYawSpeed
_TEXT	ENDS
...
PUBLIC	?HandleAnimEvent@CHeadCrab@@UAEXPAUMonsterEvent_t@@@Z ; CHeadCrab::HandleAnimEvent
PUBLIC	__real@4@3fff8000000000000000
PUBLIC	__real@4@40038000000000000000
PUBLIC	__real@4@40008000000000000000
PUBLIC	__real@8@3fff8000000000000000
PUBLIC	__real@4@4008a280000000000000
PUBLIC	__real@8@4008a280000000000000
...
CONST	ENDS
;	COMDAT __real@4@4008a280000000000000
CONST	SEGMENT
__real@4@4008a280000000000000 DD 044228000r	; 650
CONST	ENDS
;	COMDAT __real@8@4008a280000000000000
CONST	SEGMENT
__real@8@4008a280000000000000 DQ 04084500000000000r ; 650
CONST	ENDS
;	COMDAT ?HandleAnimEvent@CHeadCrab@@UAEXPAUMonsterEvent_t@@@Z
_TEXT	SEGMENT
$T37696 = -52
...
_distance$36770 = -36
_iSound$36776 = -40
?HandleAnimEvent@CHeadCrab@@UAEXPAUMonsterEvent_t@@@Z PROC NEAR ; CHeadCrab::HandleAnimEvent, COMDAT
...
; 223  : 	{
	...
	cmp	DWORD PTR -152+[ebp], 2
	je	SHORT $L36755
	jmp	$L36779
$L36755:

; 226  : 			ClearBits( pev->flags, FL_ONGROUND );
...
; 227  : 
; 228  : 			// take him off ground so engine doesn't instantly reset onground 
; 229  : 			UTIL_SetOrigin( this, GetAbsOrigin() + Vector ( 0, 0, 1 ));

	push	1065353216				; 3f800000H
	push	0
	push	0
	lea	ecx, DWORD PTR $T37696[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	ecx, DWORD PTR $T37697[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
...
; 230  : 			UTIL_MakeVectors( GetAbsAngles() );
...
; 231  : 
; 232  : 			Vector vecJumpDir;

	lea	ecx, DWORD PTR _vecJumpDir$36758[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector

; 233  : 			if (m_hEnemy != NULL)
...
; 235  : 				float gravity = g_psv_gravity->value;

	mov	eax, DWORD PTR ?g_psv_gravity@@3PAUcvar_s@@A ; g_psv_gravity
	mov	ecx, DWORD PTR [eax+12]
	mov	DWORD PTR _gravity$36760[ebp], ecx

; 236  : 				if (gravity <= 1)

	fld	DWORD PTR _gravity$36760[ebp]
...
; 237  : 					gravity = 1;
	...
	mov	DWORD PTR _gravity$36760[ebp], 1065353216 ; 3f800000H
$L36761:

; 238  : 
; 239  : 				// How fast does the headcrab need to travel to reach that height given gravity?
; 240  : 				float height = (m_hEnemy->EyePosition().z - GetAbsOrigin().z);

	lea	edx, DWORD PTR $T37698[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 1960				; 000007a8H
	...
	fstp	DWORD PTR _height$36762[ebp]

; 241  : 				if (height < 16)

	fld	DWORD PTR _height$36762[ebp]
...
; 242  : 					height = 16;
	...
	mov	DWORD PTR _height$36762[ebp], 1098907648 ; 41800000H
$L36764:

; 243  : 				float speed = sqrt( 2 * gravity * height );

	fld	DWORD PTR __real@4@40008000000000000000
	fmul	DWORD PTR _gravity$36760[ebp]
	fmul	DWORD PTR _height$36762[ebp]
	sub	esp, 8
	fstp	QWORD PTR [esp]
	call	_sqrt
	add	esp, 8
	fst	DWORD PTR _speed$36765[ebp]

; 244  : 				float time = speed / gravity;

	fdiv	DWORD PTR _gravity$36760[ebp]
	fstp	DWORD PTR _time$36766[ebp]

; 245  : 
; 246  : 				// Scale the sideways velocity to get there at the right time
; 247  : 				vecJumpDir = (m_hEnemy->EyePosition() - GetAbsOrigin());

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	eax, DWORD PTR $T37700[ebp]
	push	eax
	...
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _vecJumpDir$36758[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecJumpDir$36758[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _vecJumpDir$36758[ebp+8], eax

; 248  : 				vecJumpDir = vecJumpDir * ( 1.0 / time );

	fld	DWORD PTR _time$36766[ebp]
	fdivr	QWORD PTR __real@8@3fff8000000000000000
	fst	DWORD PTR -164+[ebp]
	push	ecx
	fstp	DWORD PTR [esp]
	lea	ecx, DWORD PTR $T37701[ebp]
	push	ecx
	lea	ecx, DWORD PTR _vecJumpDir$36758[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	mov	edx, DWORD PTR [eax]
	mov	DWORD PTR _vecJumpDir$36758[ebp], edx
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR _vecJumpDir$36758[ebp+4], ecx
	mov	edx, DWORD PTR [eax+8]
	mov	DWORD PTR _vecJumpDir$36758[ebp+8], edx

; 249  : 
; 250  : 				// Speed to offset gravity at the desired height
; 251  : 				vecJumpDir.z = speed;

	mov	eax, DWORD PTR _speed$36765[ebp]
	mov	DWORD PTR _vecJumpDir$36758[ebp+8], eax

; 252  : 
; 253  : 				// Don't jump too far/fast
; 254  : 				float distance = vecJumpDir.Length();

	lea	ecx, DWORD PTR _vecJumpDir$36758[ebp]
	call	?Length@Vector@@QBEMXZ			; Vector::Length
	fstp	DWORD PTR _distance$36770[ebp]

; 255  : 				
; 256  : 				if (distance > 650)

	fld	DWORD PTR _distance$36770[ebp]
	fcomp	DWORD PTR __real@4@4008a280000000000000
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $L36771

; 258  : 					vecJumpDir = vecJumpDir * ( 650.0 / distance );

	fld	DWORD PTR _distance$36770[ebp]
	fdivr	QWORD PTR __real@8@4008a280000000000000
	fst	DWORD PTR -168+[ebp]
	push	ecx
	fstp	DWORD PTR [esp]
	lea	ecx, DWORD PTR $T37702[ebp]
	push	ecx
	lea	ecx, DWORD PTR _vecJumpDir$36758[ebp]
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	mov	edx, DWORD PTR [eax]
...
; 263  : 				// jump hop, don't care where
; 264  : 				vecJumpDir = Vector( gpGlobals->v_forward.x, gpGlobals->v_forward.y, gpGlobals->v_up.z ) * 350;
...
; 266  : 
; 267  : 			int iSound = RANDOM_LONG(0,2);

	push	2
	push	0
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	DWORD PTR _iSound$36776[ebp], eax

; 268  : 			if ( iSound != 0 )

	cmp	DWORD PTR _iSound$36776[ebp], 0
	je	SHORT $L36777

; 269  : 				EMIT_SOUND_DYN( edict(), CHAN_VOICE, pAttackSounds[iSound], GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	push	ecx
	fstp	DWORD PTR [esp]
	mov	eax, DWORD PTR _iSound$36776[ebp]
	mov	ecx, DWORD PTR ?pAttackSounds@CHeadCrab@@2PAPBDA[eax*4]
	push	ecx
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
...
; 270  : 
; 271  : 			SetAbsVelocity( vecJumpDir );

	lea	edx, DWORD PTR _vecJumpDir$36758[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsVelocity@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsVelocity

; 272  : 			m_flNextAttack = gpGlobals->time + 2;
...
; 275  : 
; 276  : 		default:
; 277  : 			CBaseMonster::HandleAnimEvent( pEvent );
...
; 280  : }
	...
	pop	ebp
	ret	4
?HandleAnimEvent@CHeadCrab@@UAEXPAUMonsterEvent_t@@@Z ENDP ; CHeadCrab::HandleAnimEvent
_TEXT	ENDS
;	COMDAT ??0Vector@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4
...
_TEXT	ENDS
PUBLIC	?Spawn@CHeadCrab@@UAEXXZ			; CHeadCrab::Spawn
PUBLIC	__real@4@00000000000000000000
PUBLIC	??_C@_0BE@GOFB@models?1headcrab?4mdl?$AA@	; `string'
EXTRN	?gSkillData@@3Uskilldata_t@@A:BYTE		; gSkillData
EXTRN	?UTIL_SetSize@@YAXPAUentvars_s@@ABVVector@@1@Z:NEAR ; UTIL_SetSize
;	COMDAT ??_C@_0BE@GOFB@models?1headcrab?4mdl?$AA@
; File z:\xashxtsrc\server\monsters\headcrab.cpp
CONST	SEGMENT
??_C@_0BE@GOFB@models?1headcrab?4mdl?$AA@ DB 'models/headcrab.mdl', 00H ; `string'
CONST	ENDS
...
$T37746 = -40
_this$ = -4
?Spawn@CHeadCrab@@UAEXXZ PROC NEAR			; CHeadCrab::Spawn, COMDAT
...
; 292  : 		SET_MODEL(ENT(pev), "models/headcrab.mdl");

	push	OFFSET FLAT:??_C@_0BE@GOFB@models?1headcrab?4mdl?$AA@ ; `string'
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	call	?ENT@@YAPAUedict_s@@PBUentvars_s@@@Z	; ENT
...
; 293  : 	UTIL_SetSize(pev, Vector(-12, -12, 0), Vector(12, 12, 24));

	push	1103101952				; 41c00000H
	push	1094713344				; 41400000H
	push	1094713344				; 41400000H
	lea	ecx, DWORD PTR $T37744[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	push	0
...
; 294  : 
; 295  : 	pev->solid			= SOLID_SLIDEBOX;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR [eax+268], 3

; 296  : 	pev->movetype		= MOVETYPE_STEP;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+264], 4

; 297  : 	m_bloodColor		= BLOOD_COLOR_GREEN;
...
; 299  : 	if (!pev->health) pev->health	= gSkillData.headcrabHealth;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR ?gSkillData@@3Uskilldata_t@@A+72
	mov	DWORD PTR [eax+352], ecx
$L36789:

; 300  : 	pev->view_ofs		= Vector ( 0, 0, 20 );// position of the eyes relative to monster's origin.

	push	1101004800				; 41a00000H
	push	0
	push	0
	lea	ecx, DWORD PTR $T37746[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	mov	edx, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [edx+4]
...
; 301  : 	pev->yaw_speed		= 5;//!!! should we put this in the monster's changeanim function since turn rates may vary with state/anim?

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+176], 1084227584		; 40a00000H

; 302  : 	m_flFieldOfView		= 0.5;// indicates the width of this monster's forward view cone ( as a dotproduct result )

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2056], 1056964608	; 3f000000H

; 303  : 	m_MonsterState		= MONSTERSTATE_NONE;
...
; 306  : }
	...
	pop	ebp
	ret	0
?Spawn@CHeadCrab@@UAEXXZ ENDP				; CHeadCrab::Spawn
_TEXT	ENDS
PUBLIC	?Precache@CHeadCrab@@UAEXXZ			; CHeadCrab::Precache
;	COMDAT ?Precache@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
_i$36794 = -8
...
_i$36814 = -24
_i$36819 = -28
?Precache@CHeadCrab@@UAEXXZ PROC NEAR			; CHeadCrab::Precache, COMDAT
...
; 313  : 	PRECACHE_SOUND_ARRAY(pIdleSounds);

	mov	DWORD PTR _i$36794[ebp], 0
	jmp	SHORT $L36795
$L36796:
	mov	eax, DWORD PTR _i$36794[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36794[ebp], eax
$L36795:
	cmp	DWORD PTR _i$36794[ebp], 3
	jae	SHORT $L36797
	mov	ecx, DWORD PTR _i$36794[ebp]
	mov	edx, DWORD PTR ?pIdleSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
...
; 314  : 	PRECACHE_SOUND_ARRAY(pAlertSounds);

	mov	DWORD PTR _i$36799[ebp], 0
	jmp	SHORT $L36800
$L36801:
	mov	eax, DWORD PTR _i$36799[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36799[ebp], eax
$L36800:
	cmp	DWORD PTR _i$36799[ebp], 1
	jae	SHORT $L36802
	mov	ecx, DWORD PTR _i$36799[ebp]
	mov	edx, DWORD PTR ?pAlertSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
	jmp	SHORT $L36801
...
; 315  : 	PRECACHE_SOUND_ARRAY(pPainSounds);

	mov	DWORD PTR _i$36804[ebp], 0
	jmp	SHORT $L36805
$L36806:
	mov	eax, DWORD PTR _i$36804[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36804[ebp], eax
$L36805:
	cmp	DWORD PTR _i$36804[ebp], 3
	jae	SHORT $L36807
	mov	ecx, DWORD PTR _i$36804[ebp]
	mov	edx, DWORD PTR ?pPainSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
	jmp	SHORT $L36806
...
; 316  : 	PRECACHE_SOUND_ARRAY(pAttackSounds);

	mov	DWORD PTR _i$36809[ebp], 0
	jmp	SHORT $L36810
$L36811:
	mov	eax, DWORD PTR _i$36809[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36809[ebp], eax
$L36810:
	cmp	DWORD PTR _i$36809[ebp], 3
	jae	SHORT $L36812
	mov	ecx, DWORD PTR _i$36809[ebp]
	mov	edx, DWORD PTR ?pAttackSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
	jmp	SHORT $L36811
...
; 317  : 	PRECACHE_SOUND_ARRAY(pDeathSounds);

	mov	DWORD PTR _i$36814[ebp], 0
	jmp	SHORT $L36815
$L36816:
	mov	eax, DWORD PTR _i$36814[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36814[ebp], eax
$L36815:
	cmp	DWORD PTR _i$36814[ebp], 2
	jae	SHORT $L36817
	mov	ecx, DWORD PTR _i$36814[ebp]
	mov	edx, DWORD PTR ?pDeathSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
	jmp	SHORT $L36816
...
; 318  : 	PRECACHE_SOUND_ARRAY(pBiteSounds);

	mov	DWORD PTR _i$36819[ebp], 0
	jmp	SHORT $L36820
$L36821:
	mov	eax, DWORD PTR _i$36819[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36819[ebp], eax
$L36820:
	cmp	DWORD PTR _i$36819[ebp], 1
	jae	SHORT $L36822
	mov	ecx, DWORD PTR _i$36819[ebp]
	mov	edx, DWORD PTR ?pBiteSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
	jmp	SHORT $L36821
...
; 321  : 		PRECACHE_MODEL((char*)STRING(pev->model)); //LRC
...
; 323  : 		PRECACHE_MODEL("models/headcrab.mdl");
...
; 324  : }	
	...
	pop	ebp
	ret	0
?Precache@CHeadCrab@@UAEXXZ ENDP			; CHeadCrab::Precache
_TEXT	ENDS
PUBLIC	?RunTask@CHeadCrab@@UAEXPAUTask_t@@@Z		; CHeadCrab::RunTask
...
_pTask$ = 8
_this$ = -4
?RunTask@CHeadCrab@@UAEXPAUTask_t@@@Z PROC NEAR		; CHeadCrab::RunTask, COMDAT
...
; 347  : 			CBaseMonster :: RunTask(pTask);
...
; 350  : }
	...
	pop	ebp
	ret	4
?RunTask@CHeadCrab@@UAEXPAUTask_t@@@Z ENDP		; CHeadCrab::RunTask
_TEXT	ENDS
...
_pOther$ = 8
_this$ = -4
?LeapTouch@CHeadCrab@@QAEXPAVCBaseEntity@@@Z PROC NEAR	; CHeadCrab::LeapTouch, COMDAT
...
; 362  : 
; 363  : 	if ( pOther->Classify() == Classify() )
...
; 367  : 
; 368  : 	// Don't hit if back on ground
; 369  : 	if ( !FBitSet( pev->flags, FL_ONGROUND ) )
...
; 371  : 		EMIT_SOUND_DYN( edict(), CHAN_WEAPON, RANDOM_SOUND_ARRAY(pBiteSounds), GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	eax, DWORD PTR ?pBiteSounds@CHeadCrab@@2PAPBDA[eax*4]
	push	eax
	push	1
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
; 372  : 		
; 373  : 		pOther->TakeDamage( pev, pev, GetDamageAmount(), DMG_SLASH );
...
; 377  : }
	...
	pop	ebp
	ret	4
?LeapTouch@CHeadCrab@@QAEXPAVCBaseEntity@@@Z ENDP	; CHeadCrab::LeapTouch
_TEXT	ENDS
PUBLIC	?PrescheduleThink@CHeadCrab@@UAEXXZ		; CHeadCrab::PrescheduleThink
...
_TEXT	SEGMENT
_this$ = -4
?PrescheduleThink@CHeadCrab@@UAEXXZ PROC NEAR		; CHeadCrab::PrescheduleThink, COMDAT
...
; 384  : 	// make the crab coo a little bit in combat state
; 385  : 	if ( m_MonsterState == MONSTERSTATE_COMBAT && RANDOM_FLOAT( 0, 5 ) < 0.1 )
...
; 389  : }
	...
	pop	ebp
	ret	0
?PrescheduleThink@CHeadCrab@@UAEXXZ ENDP		; CHeadCrab::PrescheduleThink
_TEXT	ENDS
PUBLIC	?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z		; CHeadCrab::StartTask
EXTRN	?StartTask@CBaseMonster@@UAEXPAUTask_t@@@Z:NEAR	; CBaseMonster::StartTask
;	COMDAT ?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z
_TEXT	SEGMENT
_pTask$ = 8
_this$ = -4
?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z PROC NEAR	; CHeadCrab::StartTask, COMDAT
...
; 393  : 	m_iTaskStatus = TASKSTATUS_RUNNING;
...
; 399  : 			EMIT_SOUND_DYN( edict(), CHAN_WEAPON, pAttackSounds[0], GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	push	ecx
	fstp	DWORD PTR [esp]
	mov	eax, DWORD PTR ?pAttackSounds@CHeadCrab@@2PAPBDA
	push	eax
	push	1
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
; 400  : 			m_IdealActivity = ACT_RANGE_ATTACK1;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx+2072], 28		; 0000001cH

; 401  : 			SetTouch ( LeapTouch );

	push	OFFSET FLAT:??_C@_09IOHL@LeapTouch?$AA@	; `string'
	push	OFFSET FLAT:?LeapTouch@CHeadCrab@@QAEXPAVCBaseEntity@@@Z ; CHeadCrab::LeapTouch
	mov	ecx, DWORD PTR _this$[ebp]
	call	?TouchSet@CBaseEntity@@QAEP81@AEXPAV1@@ZP81@AEX0@ZPAD@Z ; CBaseEntity::TouchSet
...
; 406  : 			CBaseMonster :: StartTask( pTask );
...
; 409  : }
	...
	pop	ebp
	ret	4
?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z ENDP		; CHeadCrab::StartTask
_TEXT	ENDS
PUBLIC	?CheckRangeAttack1@CHeadCrab@@UAEHMM@Z		; CHeadCrab::CheckRangeAttack1
...
_flDist$ = 12
_this$ = -4
?CheckRangeAttack1@CHeadCrab@@UAEHMM@Z PROC NEAR	; CHeadCrab::CheckRangeAttack1, COMDAT
...
; 417  : 	if ( FBitSet( pev->flags, FL_ONGROUND ) && flDist <= 256 && flDot >= 0.65 )
	...
	fcomp	QWORD PTR __real@8@3ffea666666666666800
	fnstsw	ax
	test	ah, 1
	jne	SHORT $L36874
...
; 422  : }
	...
	pop	ebp
	ret	8
?CheckRangeAttack1@CHeadCrab@@UAEHMM@Z ENDP		; CHeadCrab::CheckRangeAttack1
_TEXT	ENDS
PUBLIC	?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z		; CHeadCrab::CheckRangeAttack2
;	COMDAT ?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z
_TEXT	SEGMENT
_this$ = -4
?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z PROC NEAR	; CHeadCrab::CheckRangeAttack2, COMDAT
...
; 430  : 	// BUGBUG: Why is this code here?  There is no ACT_RANGE_ATTACK2 animation.  I've disabled it for now.
; 431  : #if 0
; 432  : 	if ( FBitSet( pev->flags, FL_ONGROUND ) && flDist > 64 && flDist <= 256 && flDot >= 0.5 )
; 433  : 	{
; 434  : 		return TRUE;
; 435  : 	}
; 436  : 	return FALSE;
...
; 438  : }
	...
	pop	ebp
	ret	8
?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z ENDP		; CHeadCrab::CheckRangeAttack2
_TEXT	ENDS
PUBLIC	?TakeDamage@CHeadCrab@@UAEHPAUentvars_s@@0MH@Z	; CHeadCrab::TakeDamage
...
_bitsDamageType$ = 20
_this$ = -4
?TakeDamage@CHeadCrab@@UAEHPAUentvars_s@@0MH@Z PROC NEAR ; CHeadCrab::TakeDamage, COMDAT
...
; 442  : 	// Don't take any acid damage -- BigMomma's mortar is acid
; 443  : 	if ( bitsDamageType & DMG_ACID )
...
; 445  : 
; 446  : 	return CBaseMonster::TakeDamage( pevInflictor, pevAttacker, flDamage, bitsDamageType );
...
; 447  : }
	...
	pop	ebp
	ret	16					; 00000010H
?TakeDamage@CHeadCrab@@UAEHPAUentvars_s@@0MH@Z ENDP	; CHeadCrab::TakeDamage
_TEXT	ENDS
PUBLIC	?IdleSound@CHeadCrab@@UAEXXZ			; CHeadCrab::IdleSound
;	COMDAT ?IdleSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
?IdleSound@CHeadCrab@@UAEXXZ PROC NEAR			; CHeadCrab::IdleSound, COMDAT
...
; 455  : 	EMIT_SOUND_DYN( edict(), CHAN_VOICE, RANDOM_SOUND_ARRAY(pIdleSounds), GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	eax, DWORD PTR ?pIdleSounds@CHeadCrab@@2PAPBDA[eax*4]
	push	eax
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
; 456  : }
	...
	pop	ebp
	ret	0
?IdleSound@CHeadCrab@@UAEXXZ ENDP			; CHeadCrab::IdleSound
_TEXT	ENDS
PUBLIC	?AlertSound@CHeadCrab@@UAEXXZ			; CHeadCrab::AlertSound
;	COMDAT ?AlertSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
?AlertSound@CHeadCrab@@UAEXXZ PROC NEAR			; CHeadCrab::AlertSound, COMDAT
...
; 463  : 	EMIT_SOUND_DYN( edict(), CHAN_VOICE, RANDOM_SOUND_ARRAY(pAlertSounds), GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	eax, DWORD PTR ?pAlertSounds@CHeadCrab@@2PAPBDA[eax*4]
	push	eax
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
; 464  : }
	...
	pop	ebp
	ret	0
?AlertSound@CHeadCrab@@UAEXXZ ENDP			; CHeadCrab::AlertSound
_TEXT	ENDS
PUBLIC	?PainSound@CHeadCrab@@UAEXXZ			; CHeadCrab::PainSound
;	COMDAT ?PainSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
?PainSound@CHeadCrab@@UAEXXZ PROC NEAR			; CHeadCrab::PainSound, COMDAT
...
; 471  : 	EMIT_SOUND_DYN( edict(), CHAN_VOICE, RANDOM_SOUND_ARRAY(pPainSounds), GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	eax, DWORD PTR ?pPainSounds@CHeadCrab@@2PAPBDA[eax*4]
	push	eax
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
; 472  : }
	...
	pop	ebp
	ret	0
?PainSound@CHeadCrab@@UAEXXZ ENDP			; CHeadCrab::PainSound
_TEXT	ENDS
PUBLIC	?DeathSound@CHeadCrab@@UAEXXZ			; CHeadCrab::DeathSound
;	COMDAT ?DeathSound@CHeadCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
?DeathSound@CHeadCrab@@UAEXXZ PROC NEAR			; CHeadCrab::DeathSound, COMDAT
...
; 479  : 	EMIT_SOUND_DYN( edict(), CHAN_VOICE, RANDOM_SOUND_ARRAY(pDeathSounds), GetSoundVolue(), ATTN_IDLE, 0, GetVoicePitch() );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	eax, DWORD PTR ?pDeathSounds@CHeadCrab@@2PAPBDA[eax*4]
	push	eax
	push	2
	mov	ecx, DWORD PTR _this$[ebp]
	call	?edict@CBaseEntity@@QAEPAUedict_s@@XZ	; CBaseEntity::edict
...
; 480  : }
	...
	pop	ebp
	ret	0
?DeathSound@CHeadCrab@@UAEXXZ ENDP			; CHeadCrab::DeathSound
_TEXT	ENDS
PUBLIC	?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z ; CHeadCrab::GetScheduleOfType
EXTRN	?GetScheduleOfType@CBaseMonster@@UAEPAUSchedule_t@@H@Z:NEAR ; CBaseMonster::GetScheduleOfType
;	COMDAT ?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z
_TEXT	SEGMENT
_Type$ = 8
_this$ = -4
?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z PROC NEAR ; CHeadCrab::GetScheduleOfType, COMDAT
...
; 488  : 			return &slHCRangeAttack1[ 0 ];

	mov	eax, OFFSET FLAT:?slHCRangeAttack1@@3PAUSchedule_t@@A ; slHCRangeAttack1
	jmp	SHORT $L36912
$L36914:

; 492  : 
; 493  : 	return CBaseMonster::GetScheduleOfType( Type );
...
; 494  : }
	...
	pop	ebp
	ret	4
?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z ENDP ; CHeadCrab::GetScheduleOfType
_TEXT	ENDS
;	COMDAT _$E37
_TEXT	SEGMENT
...
_$E37	ENDP
_TEXT	ENDS
PUBLIC	??0?$CEntityFactory@VCBabyCrab@@@@QAE@PBD@Z	; CEntityFactory<CBabyCrab>::CEntityFactory<CBabyCrab>
PUBLIC	??_C@_0BB@JADK@monster_babycrab?$AA@		; `string'
_BSS	SEGMENT
	ALIGN	4

_monster_babycrab DD 01H DUP (?)
_BSS	ENDS
;	COMDAT ??_C@_0BB@JADK@monster_babycrab?$AA@
; File z:\xashxtsrc\server\monsters\headcrab.cpp
CONST	SEGMENT
...
; 509  : LINK_ENTITY_TO_CLASS( monster_babycrab, CBabyCrab );
	...
	mov	ecx, OFFSET FLAT:_monster_babycrab
	call	??0?$CEntityFactory@VCBabyCrab@@@@QAE@PBD@Z ; CEntityFactory<CBabyCrab>::CEntityFactory<CBabyCrab>
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
...
_$E36	ENDP
_TEXT	ENDS
PUBLIC	?Spawn@CBabyCrab@@UAEXXZ			; CBabyCrab::Spawn
PUBLIC	??_C@_0BJ@FGOK@models?1baby_headcrab?4mdl?$AA@	; `string'
PUBLIC	__real@8@3ffd8000000000000000
;	COMDAT ??_C@_0BJ@FGOK@models?1baby_headcrab?4mdl?$AA@
; File z:\xashxtsrc\server\monsters\headcrab.cpp
CONST	SEGMENT
??_C@_0BJ@FGOK@models?1baby_headcrab?4mdl?$AA@ DB 'models/baby_headcrab.m'
	DB	'dl', 00H					; `string'
CONST	ENDS
...
$T37798 = -28
$T37799 = -40
?Spawn@CBabyCrab@@UAEXXZ PROC NEAR			; CBabyCrab::Spawn, COMDAT
...
; 516  : 		SET_MODEL(ENT(pev), STRING(pev->model)); //LRC
...
; 518  : 		SET_MODEL(ENT(pev), "models/baby_headcrab.mdl");

	push	OFFSET FLAT:??_C@_0BJ@FGOK@models?1baby_headcrab?4mdl?$AA@ ; `string'
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	call	?ENT@@YAPAUedict_s@@PBUentvars_s@@@Z	; ENT
...
; 519  : 	UTIL_SetSize(pev, Vector(-12, -12, 0), Vector(12, 12, 24));

	push	1103101952				; 41c00000H
	push	1094713344				; 41400000H
	push	1094713344				; 41400000H
	lea	ecx, DWORD PTR $T37797[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	push	0
	push	-1052770304				; c1400000H
	push	-1052770304				; c1400000H
	lea	ecx, DWORD PTR $T37798[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
...
; 520  : 
; 521  : 	pev->solid		= SOLID_SLIDEBOX;

	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR [eax+268], 3

; 522  : 	pev->movetype		= MOVETYPE_STEP;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+264], 4

; 523  : 	m_bloodColor		= BLOOD_COLOR_GREEN;

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2328], 195		; 000000c3H

; 524  : 	pev->rendermode		= kRenderTransTexture;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+328], 2

; 525  : 	pev->renderamt		= 192;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+332], 1128267776		; 43400000H

; 526  : 
; 527  : 	if (!pev->health) pev->health	= gSkillData.headcrabHealth * 0.25;	// less health than full grown
	...
	test	ah, 64					; 00000040H
	je	SHORT $L36990
	fld	DWORD PTR ?gSkillData@@3Uskilldata_t@@A+72
...
; 528  : 	pev->view_ofs		= Vector ( 0, 0, 20 );// position of the eyes relative to monster's origin.
...
; 529  : 	pev->yaw_speed		= 5;//!!! should we put this in the monster's changeanim function since turn rates may vary with state/anim?

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR [edx+176], 1084227584		; 40a00000H

; 530  : 	m_flFieldOfView		= 0.5;// indicates the width of this monster's forward view cone ( as a dotproduct result )

	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax+2056], 1056964608	; 3f000000H

; 531  : 	m_MonsterState		= MONSTERSTATE_NONE;
...
; 534  : }
	...
	pop	ebp
	ret	0
?Spawn@CBabyCrab@@UAEXXZ ENDP				; CBabyCrab::Spawn
_TEXT	ENDS
PUBLIC	?Precache@CBabyCrab@@UAEXXZ			; CBabyCrab::Precache
;	COMDAT ?Precache@CBabyCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
_i$36996 = -8
...
_i$37016 = -24
_i$37021 = -28
?Precache@CBabyCrab@@UAEXXZ PROC NEAR			; CBabyCrab::Precache, COMDAT
...
; 538  : 	PRECACHE_SOUND_ARRAY(pIdleSounds);

	mov	DWORD PTR _i$36996[ebp], 0
	jmp	SHORT $L36997
$L36998:
	mov	eax, DWORD PTR _i$36996[ebp]
	add	eax, 1
	mov	DWORD PTR _i$36996[ebp], eax
$L36997:
	cmp	DWORD PTR _i$36996[ebp], 3
	jae	SHORT $L36999
	mov	ecx, DWORD PTR _i$36996[ebp]
	mov	edx, DWORD PTR ?pIdleSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
; 539  : 	PRECACHE_SOUND_ARRAY(pAlertSounds);

	mov	DWORD PTR _i$37001[ebp], 0
	jmp	SHORT $L37002
$L37003:
	mov	eax, DWORD PTR _i$37001[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37001[ebp], eax
$L37002:
	cmp	DWORD PTR _i$37001[ebp], 1
	jae	SHORT $L37004
	mov	ecx, DWORD PTR _i$37001[ebp]
	mov	edx, DWORD PTR ?pAlertSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
; 540  : 	PRECACHE_SOUND_ARRAY(pPainSounds);

	mov	DWORD PTR _i$37006[ebp], 0
	jmp	SHORT $L37007
$L37008:
	mov	eax, DWORD PTR _i$37006[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37006[ebp], eax
$L37007:
	cmp	DWORD PTR _i$37006[ebp], 3
	jae	SHORT $L37009
	mov	ecx, DWORD PTR _i$37006[ebp]
	mov	edx, DWORD PTR ?pPainSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
; 541  : 	PRECACHE_SOUND_ARRAY(pAttackSounds);

	mov	DWORD PTR _i$37011[ebp], 0
	jmp	SHORT $L37012
$L37013:
	mov	eax, DWORD PTR _i$37011[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37011[ebp], eax
$L37012:
	cmp	DWORD PTR _i$37011[ebp], 3
	jae	SHORT $L37014
	mov	ecx, DWORD PTR _i$37011[ebp]
	mov	edx, DWORD PTR ?pAttackSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
; 542  : 	PRECACHE_SOUND_ARRAY(pDeathSounds);

	mov	DWORD PTR _i$37016[ebp], 0
	jmp	SHORT $L37017
$L37018:
	mov	eax, DWORD PTR _i$37016[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37016[ebp], eax
$L37017:
	cmp	DWORD PTR _i$37016[ebp], 2
	jae	SHORT $L37019
	mov	ecx, DWORD PTR _i$37016[ebp]
	mov	edx, DWORD PTR ?pDeathSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
; 543  : 	PRECACHE_SOUND_ARRAY(pBiteSounds);

	mov	DWORD PTR _i$37021[ebp], 0
	jmp	SHORT $L37022
$L37023:
	mov	eax, DWORD PTR _i$37021[ebp]
	add	eax, 1
	mov	DWORD PTR _i$37021[ebp], eax
$L37022:
	cmp	DWORD PTR _i$37021[ebp], 1
	jae	SHORT $L37024
	mov	ecx, DWORD PTR _i$37021[ebp]
	mov	edx, DWORD PTR ?pBiteSounds@CHeadCrab@@2PAPBDA[ecx*4]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+4
	add	esp, 4
...
; 544  : 
; 545  : 	PRECACHE_MODEL( "models/baby_headcrab.mdl" );
...
; 546  : }
	...
	pop	ebp
	ret	0
?Precache@CBabyCrab@@UAEXXZ ENDP			; CBabyCrab::Precache
_TEXT	ENDS
PUBLIC	?SetYawSpeed@CBabyCrab@@UAEXXZ			; CBabyCrab::SetYawSpeed
;	COMDAT ?SetYawSpeed@CBabyCrab@@UAEXXZ
_TEXT	SEGMENT
_this$ = -4
?SetYawSpeed@CBabyCrab@@UAEXXZ PROC NEAR		; CBabyCrab::SetYawSpeed, COMDAT
...
; 551  : 	pev->yaw_speed = 120;

	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	DWORD PTR [ecx+176], 1123024896		; 42f00000H
...
; 552  : }
	...
	pop	ebp
	ret	0
?SetYawSpeed@CBabyCrab@@UAEXXZ ENDP			; CBabyCrab::SetYawSpeed
_TEXT	ENDS
PUBLIC	?CheckRangeAttack1@CBabyCrab@@UAEHMM@Z		; CBabyCrab::CheckRangeAttack1
PUBLIC	__real@4@4006b400000000000000
PUBLIC	__real@8@3ffe8cccccccccccd000
;	COMDAT __real@4@4006b400000000000000
; File z:\xashxtsrc\server\monsters\headcrab.cpp
CONST	SEGMENT
__real@4@4006b400000000000000 DD 043340000r	; 180
CONST	ENDS
;	COMDAT __real@8@3ffe8cccccccccccd000
CONST	SEGMENT
__real@8@3ffe8cccccccccccd000 DQ 03fe199999999999ar ; 0.55
CONST	ENDS
;	COMDAT ?CheckRangeAttack1@CBabyCrab@@UAEHMM@Z
_TEXT	SEGMENT
_flDot$ = 8
_flDist$ = 12
_this$ = -4
?CheckRangeAttack1@CBabyCrab@@UAEHMM@Z PROC NEAR	; CBabyCrab::CheckRangeAttack1, COMDAT
...
; 559  : 		if ( pev->groundentity && (pev->groundentity->v.flags & (FL_CLIENT|FL_MONSTER)) )
...
; 561  : 
; 562  : 		// A little less accurate, but jump from closer
; 563  : 		if ( flDist <= 180 && flDot >= 0.55 )
	...
	je	SHORT $L37037
	fld	DWORD PTR _flDot$[ebp]
	fcomp	QWORD PTR __real@8@3ffe8cccccccccccd000
	fnstsw	ax
	test	ah, 1
	jne	SHORT $L37037
...
; 568  : }
	...
	pop	ebp
	ret	8
?CheckRangeAttack1@CBabyCrab@@UAEHMM@Z ENDP		; CBabyCrab::CheckRangeAttack1
_TEXT	ENDS
PUBLIC	?GetScheduleOfType@CBabyCrab@@UAEPAUSchedule_t@@H@Z ; CBabyCrab::GetScheduleOfType
;	COMDAT ?GetScheduleOfType@CBabyCrab@@UAEPAUSchedule_t@@H@Z
_TEXT	SEGMENT
_Type$ = 8
_this$ = -4
?GetScheduleOfType@CBabyCrab@@UAEPAUSchedule_t@@H@Z PROC NEAR ; CBabyCrab::GetScheduleOfType, COMDAT
...
; 575  : 		case SCHED_FAIL:	// If you fail, try to jump!
; 576  : 			if ( m_hEnemy != NULL )
...
; 577  : 				return slHCRangeAttack1Fast;

	mov	eax, OFFSET FLAT:?slHCRangeAttack1Fast@@3PAUSchedule_t@@A ; slHCRangeAttack1Fast
	jmp	SHORT $L37041
$L37047:
...
; 582  : 			return slHCRangeAttack1Fast;
...
; 586  : 
; 587  : 	return CHeadCrab::GetScheduleOfType( Type );

	mov	ecx, DWORD PTR _Type$[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z ; CHeadCrab::GetScheduleOfType
$L37041:
...
; 588  : }
	...
	pop	ebp
	ret	4
?GetScheduleOfType@CBabyCrab@@UAEPAUSchedule_t@@H@Z ENDP ; CBabyCrab::GetScheduleOfType
_TEXT	ENDS
PUBLIC	??0IEntityFactory@@QAE@XZ			; IEntityFactory::IEntityFactory
PUBLIC	?Create@?$CEntityFactory@VCHeadCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CHeadCrab>::Create
PUBLIC	?Destroy@?$CEntityFactory@VCHeadCrab@@@@UAEXPAVCBaseEntity@@@Z ; CEntityFactory<CHeadCrab>::Destroy
PUBLIC	?GetEntitySize@?$CEntityFactory@VCHeadCrab@@@@UAEIXZ ; CEntityFactory<CHeadCrab>::GetEntitySize
PUBLIC	??_7?$CEntityFactory@VCHeadCrab@@@@6B@		; CEntityFactory<CHeadCrab>::`vftable'
...
CONST	SEGMENT
??_7?$CEntityFactory@VCHeadCrab@@@@6B@ DD FLAT:?Create@?$CEntityFactory@VCHeadCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CHeadCrab>::`vftable'
	DD	FLAT:?Destroy@?$CEntityFactory@VCHeadCrab@@@@UAEXPAVCBaseEntity@@@Z
	DD	FLAT:?GetEntitySize@?$CEntityFactory@VCHeadCrab@@@@UAEIXZ
CONST	ENDS
;	COMDAT ??0?$CEntityFactory@VCHeadCrab@@@@QAE@PBD@Z
_TEXT	SEGMENT
_this$ = -4
_pClassName$ = 8
??0?$CEntityFactory@VCHeadCrab@@@@QAE@PBD@Z PROC NEAR	; CEntityFactory<CHeadCrab>::CEntityFactory<CHeadCrab>, COMDAT
...
; 86   : 	CEntityFactory( const char *pClassName )
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET FLAT:??_7?$CEntityFactory@VCHeadCrab@@@@6B@ ; CEntityFactory<CHeadCrab>::`vftable'
...
; 89   : 	}
	...
	pop	ebp
	ret	4
??0?$CEntityFactory@VCHeadCrab@@@@QAE@PBD@Z ENDP	; CEntityFactory<CHeadCrab>::CEntityFactory<CHeadCrab>
_TEXT	ENDS
PUBLIC	?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z	; GetClassPtr
;	COMDAT ?Create@?$CEntityFactory@VCHeadCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT
_this$ = -4
_pEnt$ = -8
_pClassName$ = 8
_pev$ = 12
?Create@?$CEntityFactory@VCHeadCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z PROC NEAR ; CEntityFactory<CHeadCrab>::Create, COMDAT
...
; 93   : 		T* pEnt = GetClassPtr((T*)pev, pClassName);
	...
	push	ecx
	call	?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z ; GetClassPtr
	add	esp, 8
...
; 95   : 	}
	...
	pop	ebp
	ret	8
?Create@?$CEntityFactory@VCHeadCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ENDP ; CEntityFactory<CHeadCrab>::Create
_TEXT	ENDS
...
_this$ = -4
_pEntity$ = 8
?Destroy@?$CEntityFactory@VCHeadCrab@@@@UAEXPAVCBaseEntity@@@Z PROC NEAR ; CEntityFactory<CHeadCrab>::Destroy, COMDAT
...
; 100  : 	}
	...
	pop	ebp
	ret	4
?Destroy@?$CEntityFactory@VCHeadCrab@@@@UAEXPAVCBaseEntity@@@Z ENDP ; CEntityFactory<CHeadCrab>::Destroy
_TEXT	ENDS
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCHeadCrab@@@@UAEIXZ
_TEXT	SEGMENT
_this$ = -4
?GetEntitySize@?$CEntityFactory@VCHeadCrab@@@@UAEIXZ PROC NEAR ; CEntityFactory<CHeadCrab>::GetEntitySize, COMDAT
...
; 105  : 	}
	...
	pop	ebp
	ret	0
?GetEntitySize@?$CEntityFactory@VCHeadCrab@@@@UAEIXZ ENDP ; CEntityFactory<CHeadCrab>::GetEntitySize
_TEXT	ENDS
PUBLIC	?Create@?$CEntityFactory@VCBabyCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CBabyCrab>::Create
PUBLIC	?Destroy@?$CEntityFactory@VCBabyCrab@@@@UAEXPAVCBaseEntity@@@Z ; CEntityFactory<CBabyCrab>::Destroy
PUBLIC	?GetEntitySize@?$CEntityFactory@VCBabyCrab@@@@UAEIXZ ; CEntityFactory<CBabyCrab>::GetEntitySize
PUBLIC	??_7?$CEntityFactory@VCBabyCrab@@@@6B@		; CEntityFactory<CBabyCrab>::`vftable'
;	COMDAT ??_7?$CEntityFactory@VCBabyCrab@@@@6B@
; File z:\xashxtsrc\server\util.h
CONST	SEGMENT
??_7?$CEntityFactory@VCBabyCrab@@@@6B@ DD FLAT:?Create@?$CEntityFactory@VCBabyCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ; CEntityFactory<CBabyCrab>::`vftable'
	DD	FLAT:?Destroy@?$CEntityFactory@VCBabyCrab@@@@UAEXPAVCBaseEntity@@@Z
	DD	FLAT:?GetEntitySize@?$CEntityFactory@VCBabyCrab@@@@UAEIXZ
CONST	ENDS
;	COMDAT ??0?$CEntityFactory@VCBabyCrab@@@@QAE@PBD@Z
_TEXT	SEGMENT
_pClassName$ = 8
_this$ = -4
??0?$CEntityFactory@VCBabyCrab@@@@QAE@PBD@Z PROC NEAR	; CEntityFactory<CBabyCrab>::CEntityFactory<CBabyCrab>, COMDAT
...
; 86   : 	CEntityFactory( const char *pClassName )
	...
	call	??0IEntityFactory@@QAE@XZ		; IEntityFactory::IEntityFactory
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET FLAT:??_7?$CEntityFactory@VCBabyCrab@@@@6B@ ; CEntityFactory<CBabyCrab>::`vftable'
...
; 89   : 	}
	...
	pop	ebp
	ret	4
??0?$CEntityFactory@VCBabyCrab@@@@QAE@PBD@Z ENDP	; CEntityFactory<CBabyCrab>::CEntityFactory<CBabyCrab>
_TEXT	ENDS
PUBLIC	?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z	; GetClassPtr
;	COMDAT ?Create@?$CEntityFactory@VCBabyCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z
_TEXT	SEGMENT
_pClassName$ = 8
_pev$ = 12
_this$ = -4
_pEnt$ = -8
?Create@?$CEntityFactory@VCBabyCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z PROC NEAR ; CEntityFactory<CBabyCrab>::Create, COMDAT
...
; 93   : 		T* pEnt = GetClassPtr((T*)pev, pClassName);
	...
	mov	ecx, DWORD PTR _pev$[ebp]
	push	ecx
	call	?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z ; GetClassPtr
	add	esp, 8
	mov	DWORD PTR _pEnt$[ebp], eax
...
; 95   : 	}
	...
	pop	ebp
	ret	8
?Create@?$CEntityFactory@VCBabyCrab@@@@UAEPAVCBaseEntity@@PBDPAUentvars_s@@@Z ENDP ; CEntityFactory<CBabyCrab>::Create
_TEXT	ENDS
;	COMDAT ?Destroy@?$CEntityFactory@VCBabyCrab@@@@UAEXPAVCBaseEntity@@@Z
_TEXT	SEGMENT
_pEntity$ = 8
_this$ = -4
?Destroy@?$CEntityFactory@VCBabyCrab@@@@UAEXPAVCBaseEntity@@@Z PROC NEAR ; CEntityFactory<CBabyCrab>::Destroy, COMDAT
...
; 100  : 	}
	...
	pop	ebp
	ret	4
?Destroy@?$CEntityFactory@VCBabyCrab@@@@UAEXPAVCBaseEntity@@@Z ENDP ; CEntityFactory<CBabyCrab>::Destroy
_TEXT	ENDS
;	COMDAT ?GetEntitySize@?$CEntityFactory@VCBabyCrab@@@@UAEIXZ
_TEXT	SEGMENT
_this$ = -4
?GetEntitySize@?$CEntityFactory@VCBabyCrab@@@@UAEIXZ PROC NEAR ; CEntityFactory<CBabyCrab>::GetEntitySize, COMDAT
...
; 105  : 	}
	...
	pop	ebp
	ret	0
?GetEntitySize@?$CEntityFactory@VCBabyCrab@@@@UAEIXZ ENDP ; CEntityFactory<CBabyCrab>::GetEntitySize
_TEXT	ENDS
...
PUBLIC	??0CHeadCrab@@QAE@XZ				; CHeadCrab::CHeadCrab
...
; File z:\xashxtsrc\server\cbase.h
xdata$x	SEGMENT
__ehfuncinfo$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z DD 019930520H
	DD	01H
	DD	FLAT:__unwindtable$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
__unwindtable$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z$0
xdata$x	ENDS
;	COMDAT ?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z
_TEXT	SEGMENT
_newEnt$ = 8
...
$T37862 = -24
__$EHRec$ = -12
?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z PROC NEAR	; GetClassPtr, COMDAT
...
; 1093 : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z
	mov	eax, DWORD PTR fs:__except_list
	push	eax
	mov	DWORD PTR fs:__except_list, esp
	sub	esp, 80					; 00000050H
...
; 1106 : 		newEnt = new(pev) T;
	...
	add	esp, 8
	mov	DWORD PTR $T37862[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T37862[ebp], 0
	je	SHORT $L37863
	mov	ecx, DWORD PTR $T37862[ebp]
	call	??0CHeadCrab@@QAE@XZ			; CHeadCrab::CHeadCrab
...
$L37864:
	...
	mov	DWORD PTR $T37861[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T37861[ebp]
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z$0:
	mov	eax, DWORD PTR _pev$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T37862[ebp]
	push	ecx
	...
	add	esp, 8
	ret	0
__ehhandler$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z
	jmp	___CxxFrameHandler
text$x	ENDS
?GetClassPtr@@YAPAVCHeadCrab@@PAV1@PBD@Z ENDP		; GetClassPtr
;	COMDAT ?VARS@@YAPAUentvars_s@@PAUedict_s@@@Z
_TEXT	SEGMENT
_pent$ = 8
...
_TEXT	ENDS
PUBLIC	??0CBabyCrab@@QAE@XZ				; CBabyCrab::CBabyCrab
;	COMDAT xdata$x
; File z:\xashxtsrc\server\cbase.h
xdata$x	SEGMENT
__ehfuncinfo$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z DD 019930520H
	DD	01H
	DD	FLAT:__unwindtable$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z
	DD	2 DUP(00H)
	DD	2 DUP(00H)
	ORG $+4
__unwindtable$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z DD 0ffffffffH
	DD	FLAT:__unwindfunclet$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z$0
xdata$x	ENDS
;	COMDAT ?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z
_TEXT	SEGMENT
_newEnt$ = 8
...
$T37883 = -24
__$EHRec$ = -12
?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z PROC NEAR	; GetClassPtr, COMDAT
...
; 1093 : {
	...
	mov	ebp, esp
	push	-1
	push	__ehhandler$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z
	mov	eax, DWORD PTR fs:__except_list
	push	eax
	mov	DWORD PTR fs:__except_list, esp
	sub	esp, 80					; 00000050H
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T37883[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T37883[ebp], 0
	je	SHORT $L37884
	mov	ecx, DWORD PTR $T37883[ebp]
	call	??0CBabyCrab@@QAE@XZ			; CBabyCrab::CBabyCrab
	mov	DWORD PTR -28+[ebp], eax
	jmp	SHORT $L37885
$L37884:
	mov	DWORD PTR -28+[ebp], 0
$L37885:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T37882[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T37882[ebp]
	mov	DWORD PTR _newEnt$[ebp], ecx
...
;	COMDAT text$x
text$x	SEGMENT
__unwindfunclet$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z$0:
	mov	eax, DWORD PTR _pev$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T37883[ebp]
	push	ecx
	...
	add	esp, 8
	ret	0
__ehhandler$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z:
	mov	eax, OFFSET FLAT:__ehfuncinfo$?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z
	jmp	___CxxFrameHandler
text$x	ENDS
?GetClassPtr@@YAPAVCBabyCrab@@PAV1@PBD@Z ENDP		; GetClassPtr
...
PUBLIC	?GetDamageAmount@CHeadCrab@@UAEMXZ		; CHeadCrab::GetDamageAmount
PUBLIC	?GetVoicePitch@CHeadCrab@@UAEHXZ		; CHeadCrab::GetVoicePitch
PUBLIC	?GetSoundVolue@CHeadCrab@@UAEMXZ		; CHeadCrab::GetSoundVolue
...
PUBLIC	??_7CHeadCrab@@6B@				; CHeadCrab::`vftable'
...
;	COMDAT ??_7CHeadCrab@@6B@
CONST	SEGMENT
??_7CHeadCrab@@6B@ DD FLAT:?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ ; CHeadCrab::`vftable'
	DD	FLAT:?Spawn@CHeadCrab@@UAEXXZ
	DD	FLAT:?Precache@CHeadCrab@@UAEXXZ
	...
	DD	FLAT:?Classify@CHeadCrab@@UAEHXZ
	...
	DD	FLAT:?TakeDamage@CHeadCrab@@UAEHPAUentvars_s@@0MH@Z
	...
	DD	FLAT:?HandleAnimEvent@CHeadCrab@@UAEXPAUMonsterEvent_t@@@Z
	...
	DD	FLAT:?CheckRangeAttack1@CHeadCrab@@UAEHMM@Z
	DD	FLAT:?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z
	DD	FLAT:?CheckMeleeAttack1@CBaseMonster@@UAEHMM@Z
	DD	FLAT:?CheckMeleeAttack2@CBaseMonster@@UAEHMM@Z
	DD	FLAT:?ScheduleFromName@CHeadCrab@@UAEPAUSchedule_t@@PBD@Z
	DD	FLAT:?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z
	DD	FLAT:?RunTask@CHeadCrab@@UAEXPAUTask_t@@@Z
	DD	FLAT:?GetScheduleOfType@CHeadCrab@@UAEPAUSchedule_t@@H@Z
	...
	DD	FLAT:?SetYawSpeed@CHeadCrab@@UAEXXZ
	...
	DD	FLAT:?PrescheduleThink@CHeadCrab@@UAEXXZ
	...
	DD	FLAT:?DeathSound@CHeadCrab@@UAEXXZ
	DD	FLAT:?AlertSound@CHeadCrab@@UAEXXZ
	DD	FLAT:?IdleSound@CHeadCrab@@UAEXXZ
	DD	FLAT:?PainSound@CHeadCrab@@UAEXXZ
	DD	FLAT:?StepSound@CBaseMonster@@UAEXXZ
	DD	FLAT:?StopFollowing@CBaseMonster@@UAEXH@Z
	DD	FLAT:?GetDamageAmount@CHeadCrab@@UAEMXZ
	DD	FLAT:?GetVoicePitch@CHeadCrab@@UAEHXZ
	DD	FLAT:?GetSoundVolue@CHeadCrab@@UAEMXZ
CONST	ENDS
;	COMDAT ??0CHeadCrab@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4
??0CHeadCrab@@QAE@XZ PROC NEAR				; CHeadCrab::CHeadCrab, COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	push	ebx
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET FLAT:??_7CHeadCrab@@6B@ ; CHeadCrab::`vftable'
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0CHeadCrab@@QAE@XZ ENDP				; CHeadCrab::CHeadCrab
_TEXT	ENDS
;	COMDAT ?ObjectCaps@CBaseEntity@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4
...
_TEXT	SEGMENT
_this$ = -4
?GetDamageAmount@CHeadCrab@@UAEMXZ PROC NEAR		; CHeadCrab::GetDamageAmount, COMDAT

; 96   : 	virtual float GetDamageAmount( void ) { return gSkillData.headcrabDmgBite; }
	...
	push	edi
	mov	DWORD PTR _this$[ebp], ecx
	fld	DWORD PTR ?gSkillData@@3Uskilldata_t@@A+76
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
?GetDamageAmount@CHeadCrab@@UAEMXZ ENDP			; CHeadCrab::GetDamageAmount
_TEXT	ENDS
;	COMDAT ?GetVoicePitch@CHeadCrab@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4
?GetVoicePitch@CHeadCrab@@UAEHXZ PROC NEAR		; CHeadCrab::GetVoicePitch, COMDAT

; 97   : 	virtual int GetVoicePitch( void ) { return 100; }
	...
	pop	ebp
	ret	0
?GetVoicePitch@CHeadCrab@@UAEHXZ ENDP			; CHeadCrab::GetVoicePitch
_TEXT	ENDS
;	COMDAT ?GetSoundVolue@CHeadCrab@@UAEMXZ
_TEXT	SEGMENT
_this$ = -4
?GetSoundVolue@CHeadCrab@@UAEMXZ PROC NEAR		; CHeadCrab::GetSoundVolue, COMDAT

; 98   : 	virtual float GetSoundVolue( void ) { return 1.0; }
	...
	pop	ebp
	ret	0
?GetSoundVolue@CHeadCrab@@UAEMXZ ENDP			; CHeadCrab::GetSoundVolue
_TEXT	ENDS
PUBLIC	?GetDamageAmount@CBabyCrab@@UAEMXZ		; CBabyCrab::GetDamageAmount
PUBLIC	?GetVoicePitch@CBabyCrab@@UAEHXZ		; CBabyCrab::GetVoicePitch
PUBLIC	?GetSoundVolue@CBabyCrab@@UAEMXZ		; CBabyCrab::GetSoundVolue
PUBLIC	??_7CBabyCrab@@6B@				; CBabyCrab::`vftable'
;	COMDAT ??_7CBabyCrab@@6B@
CONST	SEGMENT
??_7CBabyCrab@@6B@ DD FLAT:?GetDataDescMap@CHeadCrab@@UAEPAUdatamap_s@@XZ ; CBabyCrab::`vftable'
	DD	FLAT:?Spawn@CBabyCrab@@UAEXXZ
	DD	FLAT:?Precache@CBabyCrab@@UAEXXZ
	DD	FLAT:?KeyValue@CBaseMonster@@UAEXPAUKeyValueData_s@@@Z
	DD	FLAT:?Save@CBaseEntity@@UAEHAAVCSave@@@Z
	DD	FLAT:?Restore@CBaseMonster@@UAEHAAVCRestore@@@Z
	DD	FLAT:?ObjectCaps@CBaseEntity@@UAEHXZ
	...
	DD	FLAT:?GetStoppedActivity@CBaseMonster@@UAE?AW4Activity@@XZ
	DD	FLAT:?Stop@CBaseMonster@@UAEXXZ
	DD	FLAT:?CheckRangeAttack1@CBabyCrab@@UAEHMM@Z
	DD	FLAT:?CheckRangeAttack2@CHeadCrab@@UAEHMM@Z
	DD	FLAT:?CheckMeleeAttack1@CBaseMonster@@UAEHMM@Z
	DD	FLAT:?CheckMeleeAttack2@CBaseMonster@@UAEHMM@Z
	DD	FLAT:?ScheduleFromName@CHeadCrab@@UAEPAUSchedule_t@@PBD@Z
	DD	FLAT:?StartTask@CHeadCrab@@UAEXPAUTask_t@@@Z
	DD	FLAT:?RunTask@CHeadCrab@@UAEXPAUTask_t@@@Z
	DD	FLAT:?GetScheduleOfType@CBabyCrab@@UAEPAUSchedule_t@@H@Z
	DD	FLAT:?GetSchedule@CBaseMonster@@UAEPAUSchedule_t@@XZ
	DD	FLAT:?ScheduleChange@CBaseMonster@@UAEXXZ
	DD	FLAT:?CanPlaySequence@CBaseMonster@@UAEHHH@Z
	DD	FLAT:?CanPlaySentence@CBaseMonster@@UAEHH@Z
	...
	DD	FLAT:?CheckEnemy@CBaseMonster@@UAEHPAVCBaseEntity@@@Z
	DD	FLAT:?FTriangulate@CBaseMonster@@UAEHABVVector@@0MPAVCBaseEntity@@PAV2@@Z
	DD	FLAT:?SetYawSpeed@CBabyCrab@@UAEXXZ
	DD	FLAT:?BuildNearestRoute@CBaseMonster@@UAEHVVector@@0MM@Z
	DD	FLAT:?FindCover@CBaseMonster@@UAEHVVector@@0MM@Z
	DD	FLAT:?FValidateCover@CBaseMonster@@UAEHABVVector@@@Z
	DD	FLAT:?CoverRadius@CBaseMonster@@UAEMXZ
	...
	DD	FLAT:?StepSound@CBaseMonster@@UAEXXZ
	DD	FLAT:?StopFollowing@CBaseMonster@@UAEXH@Z
	DD	FLAT:?GetDamageAmount@CBabyCrab@@UAEMXZ
	DD	FLAT:?GetVoicePitch@CBabyCrab@@UAEHXZ
	DD	FLAT:?GetSoundVolue@CBabyCrab@@UAEMXZ
CONST	ENDS
;	COMDAT ??0CBabyCrab@@QAE@XZ
_TEXT	SEGMENT
_this$ = -4
??0CBabyCrab@@QAE@XZ PROC NEAR				; CBabyCrab::CBabyCrab, COMDAT
	push	ebp
	mov	ebp, esp
	sub	esp, 68					; 00000044H
	push	ebx
	...
	call	??0CHeadCrab@@QAE@XZ			; CHeadCrab::CHeadCrab
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR [eax], OFFSET FLAT:??_7CBabyCrab@@6B@ ; CBabyCrab::`vftable'
	mov	eax, DWORD PTR _this$[ebp]
	pop	edi
	pop	esi
	pop	ebx
	...
	pop	ebp
	ret	0
??0CBabyCrab@@QAE@XZ ENDP				; CBabyCrab::CBabyCrab
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -4
?GetDamageAmount@CBabyCrab@@UAEMXZ PROC NEAR		; CBabyCrab::GetDamageAmount, COMDAT

; 503  : 	float GetDamageAmount( void ) { return gSkillData.headcrabDmgBite * 0.3; }
	...
	pop	ebp
	ret	0
?GetDamageAmount@CBabyCrab@@UAEMXZ ENDP			; CBabyCrab::GetDamageAmount
_TEXT	ENDS
;	COMDAT ?GetVoicePitch@CBabyCrab@@UAEHXZ
_TEXT	SEGMENT
_this$ = -4
?GetVoicePitch@CBabyCrab@@UAEHXZ PROC NEAR		; CBabyCrab::GetVoicePitch, COMDAT

; 506  : 	virtual int GetVoicePitch( void ) { return PITCH_NORM + RANDOM_LONG(40,50); }
	...
	pop	ebp
	ret	0
?GetVoicePitch@CBabyCrab@@UAEHXZ ENDP			; CBabyCrab::GetVoicePitch
_TEXT	ENDS
...
_TEXT	SEGMENT
_this$ = -4
?GetSoundVolue@CBabyCrab@@UAEMXZ PROC NEAR		; CBabyCrab::GetSoundVolue, COMDAT

; 507  : 	virtual float GetSoundVolue( void ) { return 0.8; }
	...
	push	edi
	mov	DWORD PTR _this$[ebp], ecx
	fld	DWORD PTR __real@4@3ffecccccd0000000000
	pop	edi
	pop	esi
	pop	ebx
	mov	esp, ebp
	pop	ebp
	ret	0
?GetSoundVolue@CBabyCrab@@UAEMXZ ENDP			; CBabyCrab::GetSoundVolue
_TEXT	ENDS
...
; 318  : 	virtual Vector BodyTarget( const Vector &posSrc ) { return Center( ) * 0.75 + EyePosition() * 0.25; };		// position to shoot at
	...
	lea	edx, DWORD PTR $T38092[ebp]
	push	edx
	lea	eax, DWORD PTR $T38091[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 44   : 	new( pMemory ) T(src);
	...
	add	esp, 8
	mov	DWORD PTR $T38214[ebp], eax
	cmp	DWORD PTR $T38214[ebp], 0
	je	SHORT $L38215
	mov	ecx, DWORD PTR $T38214[ebp]
	mov	edx, DWORD PTR _src$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T38214[ebp]
