...
; 138  : 		CBaseEntity *pEntity = CBaseEntity::Instance( tr.pHit );
	...
	add	esp, 4
	mov	DWORD PTR _pEntity$38476[ebp], eax

; 139  : 		entvars_t *pevOwner = pev;

	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	DWORD PTR _pevOwner$38477[ebp], edx
...
; 141  : 			pevOwner = VARS(pev->owner);
	...
	add	esp, 4
	mov	DWORD PTR _pevOwner$38477[ebp], eax
$L38478:

; 142  : 
; 143  : 		if ( pEntity )

	cmp	DWORD PTR _pEntity$38476[ebp], 0
	je	SHORT $L38479
...
; 144  : 			pEntity->TakeDamage( pev, pevOwner, gSkillData.gargantuaDmgStomp, DMG_SONIC );
	...
	push	edx
	mov	eax, DWORD PTR _pevOwner$38477[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR _pEntity$38476[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pEntity$38476[ebp]
...
; 156  : 		for ( int i = 0; i < 2; i++ )
	...
	mov	DWORD PTR _i$38486[ebp], 0
	jmp	SHORT $L38487
$L38488:
	mov	edx, DWORD PTR _i$38486[ebp]
	add	edx, 1
	mov	DWORD PTR _i$38486[ebp], edx
$L38487:
	cmp	DWORD PTR _i$38486[ebp], 2
	jge	$L38489
...
; 158  : 			CSprite *pSprite = CSprite::SpriteCreate( GARG_STOMP_SPRITE_NAME, GetAbsOrigin(), TRUE );
	...
	mov	DWORD PTR _pSprite$38490[ebp], eax

; 159  : 			if ( pSprite )

	cmp	DWORD PTR _pSprite$38490[ebp], 0
	je	$L38491
...
; 162  : 				pSprite->SetAbsOrigin( tr.vecEndPos );
	...
	push	edx
	mov	ecx, DWORD PTR _pSprite$38490[ebp]
	call	?SetAbsOrigin@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsOrigin
...
; 499  : 			int attach = i%2;
	...
	inc	edx
$L40270:
	mov	DWORD PTR _attach$38861[ebp], edx
...
; 501  : 			GetAttachment( attach+1, posGun, angleGun );
	...
	lea	ecx, DWORD PTR _posGun$[ebp]
	push	ecx
	mov	edx, DWORD PTR _attach$38861[ebp]
	add	edx, 1
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
; 503  : 			Vector vecEnd = (gpGlobals->v_forward * GARG_FLAME_LENGTH) + posGun;
	...
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	push	eax
	lea	ecx, DWORD PTR _vecEnd$38862[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 515  : 			m_pFlame[i]->SetEndAttachment( attach + 2 );
	...
	mov	ecx, DWORD PTR _attach$38861[ebp]
	add	ecx, 2
	push	ecx
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _this$[ebp]
...
; 555  : 			Vector vecAim = GetAbsAngles();
	...
	call	?GetAbsAngles@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsAngles
	push	eax
	lea	ecx, DWORD PTR _vecAim$38895[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 556  : 			vecAim.x += m_flameX;

	mov	eax, DWORD PTR _this$[ebp]
	fld	DWORD PTR _vecAim$38895[ebp]
	fadd	DWORD PTR [eax+2436]
	fstp	DWORD PTR _vecAim$38895[ebp]

; 557  : 			vecAim.y += m_flameY;

	mov	ecx, DWORD PTR _this$[ebp]
	fld	DWORD PTR _vecAim$38895[ebp+4]
	fadd	DWORD PTR [ecx+2440]
	fstp	DWORD PTR _vecAim$38895[ebp+4]

; 558  : 
; 559  : 			UTIL_MakeVectors( vecAim );

	lea	edx, DWORD PTR _vecAim$38895[ebp]
	push	edx
	call	?UTIL_MakeVectors@@YAXABVVector@@@Z	; UTIL_MakeVectors
	add	esp, 4
...
; 562  : 			Vector vecEnd = vecStart + (gpGlobals->v_forward * GARG_FLAME_LENGTH); //  - offset[i] * gpGlobals->v_right;
	...
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	push	eax
	lea	ecx, DWORD PTR _vecEnd$38896[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 564  : 			UTIL_TraceLine( vecStart, vecEnd, dont_ignore_monsters, edict(), &trace );
	...
	push	eax
	push	0
	lea	eax, DWORD PTR _vecEnd$38896[ebp]
	push	eax
	lea	ecx, DWORD PTR _vecStart$[ebp]
	push	ecx
	call	?UTIL_TraceLine@@YAXABVVector@@0W4IGNORE_MONSTERS@@PAUedict_s@@PAUgametrace_s@@@Z ; UTIL_TraceLine
...
; 625  : 			float dist = DotProduct( vecAim, vecSpot - vecMid );
	...
	add	esp, 8
	fstp	DWORD PTR _dist$38934[ebp]

; 626  : 			if (dist > searchRadius)

	fld	DWORD PTR _dist$38934[ebp]
...
; 627  : 				dist = searchRadius;
	...
	mov	DWORD PTR _dist$38934[ebp], ecx
...
$L38936:
	...
	fchs
	fcomp	DWORD PTR _dist$38934[ebp]
	fnstsw	ax
	test	ah, 65					; 00000041H
	jne	SHORT $L38938
...
; 629  : 				dist = searchRadius;
	...
	mov	edx, DWORD PTR _searchRadius$[ebp]
	mov	DWORD PTR _dist$38934[ebp], edx
$L38938:
...
; 631  : 			Vector vecSrc = vecMid + dist * vecAim;
	...
	lea	eax, DWORD PTR _vecAim$[ebp]
	push	eax
	mov	ecx, DWORD PTR _dist$38934[ebp]
	push	ecx
	...
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	push	eax
	lea	ecx, DWORD PTR _vecSrc$38939[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 633  : 			UTIL_TraceLine ( vecSrc, vecSpot, dont_ignore_monsters, ENT(pev), &tr );
	...
	lea	ecx, DWORD PTR _vecSpot$[ebp]
	push	ecx
	lea	edx, DWORD PTR _vecSrc$38939[ebp]
	push	edx
	call	?UTIL_TraceLine@@YAXABVVector@@0W4IGNORE_MONSTERS@@PAUedict_s@@PAUgametrace_s@@@Z ; UTIL_TraceLine
	add	esp, 20					; 00000014H
...
; 655  : 					pEntity->TraceAttack( pevInflictor, flAdjustedDamage, (tr.vecEndPos - vecSrc).Normalize( ), &tr, bitsDamageType );
	...
	push	edx
	lea	eax, DWORD PTR _vecSrc$38939[ebp]
	push	eax
	lea	ecx, DWORD PTR $T40321[ebp]
	push	ecx
...
; 716  : 	{
	...
	xor	eax, eax
	mov	al, BYTE PTR $L40343[ecx]
	jmp	DWORD PTR $L40344[eax*4]
$L38982:
...
; 982  : 			CBaseEntity *pHurt = GargantuaCheckTraceHullAttack( GARG_ATTACKDIST + 10.0, gSkillData.gargantuaDmgSlash, DMG_SLASH );
	...
	mov	DWORD PTR _pHurt$39128[ebp], eax

; 983  : 			if (pHurt)

	cmp	DWORD PTR _pHurt$39128[ebp], 0
	je	$L39129

; 985  : 				if ( pHurt->pev->flags & (FL_MONSTER|FL_CLIENT) )

	mov	ecx, DWORD PTR _pHurt$39128[ebp]
	mov	edx, DWORD PTR [ecx+4]
...
; 998  : 			Vector forward;
	...
	lea	ecx, DWORD PTR _forward$39136[ebp]
	call	??0Vector@@QAE@XZ			; Vector::Vector
...
; 1049 : 		CBaseEntity *pEntity = CBaseEntity::Instance( tr.pHit );
	...
	call	?Instance@CBaseEntity@@SAPAV1@PAUedict_s@@@Z ; CBaseEntity::Instance
	add	esp, 4
	mov	DWORD PTR _pEntity$39158[ebp], eax
...
; 1053 : 			pEntity->TakeDamage( pev, pev, iDamage, iDmgType );
	...
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	mov	eax, DWORD PTR _pEntity$39158[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR _pEntity$39158[ebp]
	call	DWORD PTR [edx+96]
$L39159:
...
; 1128 : 			int parts = MODEL_FRAMES( gGargGibModel );
	...
	add	esp, 4
	mov	DWORD PTR _parts$39198[ebp], eax

; 1129 : 			for ( i = 0; i < 10; i++ )

	mov	DWORD PTR _i$39197[ebp], 0
	jmp	SHORT $L39199
$L39200:
	mov	ecx, DWORD PTR _i$39197[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$39197[ebp], ecx
$L39199:
	cmp	DWORD PTR _i$39197[ebp], 10		; 0000000aH
	jge	$L39201
...
; 1131 : 				CGib *pGib = GetClassPtr( (CGib *)NULL );
	...
	add	esp, 4
	mov	DWORD PTR _pGib$39202[ebp], eax

; 1132 : 
; 1133 : 				pGib->Spawn( GARG_GIB_MODEL );

	push	OFFSET FLAT:??_C@_0BK@LCEG@models?1metalplategibs?4mdl?$AA@ ; `string'
	mov	ecx, DWORD PTR _pGib$39202[ebp]
	call	?Spawn@CGib@@QAEXPBD@Z			; CGib::Spawn

; 1134 : 				
; 1135 : 				int bodyPart = 0;

	mov	DWORD PTR _bodyPart$39208[ebp], 0

; 1136 : 				if ( parts > 1 )

	cmp	DWORD PTR _parts$39198[ebp], 1
	jle	SHORT $L39209
...
; 1137 : 					bodyPart = RANDOM_LONG( 0, pev->body-1 );
	...
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+360
	add	esp, 8
	mov	DWORD PTR _bodyPart$39208[ebp], eax
$L39209:

; 1138 : 
; 1139 : 				pGib->pev->body = bodyPart;

	mov	edx, DWORD PTR _pGib$39202[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	ecx, DWORD PTR _bodyPart$39208[ebp]
...
; 1141 : 				pGib->m_material = matNone;
	...
	mov	eax, DWORD PTR _pGib$39202[ebp]
...
; 1143 : 				pGib->SetAbsVelocity( UTIL_RandomBloodVector() * RANDOM_FLOAT( 300, 500 ));
	...
	add	esp, 4
	fstp	DWORD PTR [esp]
	lea	ecx, DWORD PTR $T40428[ebp]
	push	ecx
	lea	edx, DWORD PTR $T40427[ebp]
	push	edx
...
; 1148 : 			Vector vecOrigin = GetAbsOrigin();
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _vecOrigin$39216[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 1154 : 				WRITE_COORD( vecOrigin.x );
	...
	mov	eax, DWORD PTR _vecOrigin$39216[ebp]
	push	eax
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 1155 : 				WRITE_COORD( vecOrigin.y );
	...
	mov	ecx, DWORD PTR _vecOrigin$39216[ebp+4]
	push	ecx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 1156 : 				WRITE_COORD( vecOrigin.z );
	...
	mov	edx, DWORD PTR _vecOrigin$39216[ebp+8]
	push	edx
	call	DWORD PTR ?g_engfuncs@@3Uenginefuncs_s@@A+212
	add	esp, 4
...
; 1202 : 			BOOL cancel = FALSE;
	...
	mov	DWORD PTR _cancel$39221[ebp], 0

; 1203 : 
; 1204 : 			Vector angles = g_vecZero;

	push	OFFSET FLAT:?g_vecZero@@3VVector@@B	; g_vecZero
	lea	ecx, DWORD PTR _angles$39222[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 1207 : 			CBaseEntity *pEnemy = m_hEnemy;
	...
	mov	DWORD PTR _pEnemy$39223[ebp], eax

; 1208 : 			if ( pEnemy )

	cmp	DWORD PTR _pEnemy$39223[ebp], 0
	je	$L39230
...
; 1210 : 				Vector org = GetAbsOrigin();
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _org$39225[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector

; 1211 : 				org.z += 64;

	fld	DWORD PTR _org$39225[ebp+8]
	fadd	DWORD PTR __real@4@40058000000000000000
	fstp	DWORD PTR _org$39225[ebp+8]
...
; 1212 : 				Vector dir = pEnemy->BodyTarget(org) - org;
	...
	push	edx
	lea	eax, DWORD PTR _org$39225[ebp]
	push	eax
	lea	ecx, DWORD PTR $T40429[ebp]
	push	ecx
	mov	edx, DWORD PTR _pEnemy$39223[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _pEnemy$39223[ebp]
	call	DWORD PTR [eax+316]
	mov	ecx, eax
	call	??GVector@@QBE?AV0@ABV0@@Z		; Vector::operator-
	push	eax
	lea	ecx, DWORD PTR _dir$39226[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 1213 : 				angles = UTIL_VecToAngles( dir );
	...
	add	esp, 8
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _angles$39222[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _angles$39222[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _angles$39222[ebp+8], eax

; 1214 : 				angles.y -= GetAbsAngles().y;

	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsAngles@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsAngles
	fld	DWORD PTR _angles$39222[ebp+4]
	fsub	DWORD PTR [eax+4]
	fstp	DWORD PTR _angles$39222[ebp+4]
...
; 1216 : 					cancel = TRUE;
	...
	mov	DWORD PTR _cancel$39221[ebp], 1
$L39230:
...
; 1221 : 			if ( cancel )
	...
	cmp	DWORD PTR _cancel$39221[ebp], 0
	je	SHORT $L39232
...
; 1227 : 			FlameControls( angles.x, angles.y );
	...
	mov	edx, DWORD PTR _angles$39222[ebp+4]
	push	edx
	mov	eax, DWORD PTR _angles$39222[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?FlameControls@CGargantua@@QAEXMM@Z	; CGargantua::FlameControls
$L39220:
...
; 1319 : 		Vector position = GetAbsOrigin();
	...
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	push	eax
	lea	ecx, DWORD PTR _position$39314[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 1320 : 		Vector direction = Vector( 0, 0, 1 );
	...
	push	0
	push	0
	lea	ecx, DWORD PTR $T40462[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	ecx, DWORD PTR _direction$39315[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 1322 : 		float fraction = 1.0 / pev->speed;
	...
	fstp	DWORD PTR _fraction$39317[ebp]
...
; 1324 : 		float radius = (pev->scale * pev->health) * fraction;
	...
	fmul	DWORD PTR _fraction$39317[ebp]
	fstp	DWORD PTR _radius$39318[ebp]
...
; 1326 : 		position.z += (pev->health * pev->dmg) * fraction;
	...
	fmul	DWORD PTR _fraction$39317[ebp]
	fadd	DWORD PTR _position$39314[ebp+8]
	fstp	DWORD PTR _position$39314[ebp+8]
...
; 1327 : 		Vector vecAngles = GetAbsAngles();
	...
	call	?GetAbsAngles@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsAngles
	push	eax
	lea	ecx, DWORD PTR _vecAngles$39319[ebp]
	call	??0Vector@@QAE@ABV0@@Z			; Vector::Vector
...
; 1328 : 		vecAngles.y = (pev->health * 360 * 8) * fraction;
	...
	fmul	DWORD PTR _fraction$39317[ebp]
	fstp	DWORD PTR _vecAngles$39319[ebp+4]

; 1329 : 		SetAbsAngles( vecAngles );

	lea	eax, DWORD PTR _vecAngles$39319[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetAbsAngles@CBaseEntity@@QAEXABVVector@@@Z ; CBaseEntity::SetAbsAngles
...
; 1331 : 		position = position + gpGlobals->v_forward * radius;
	...
	mov	ecx, DWORD PTR _radius$39318[ebp]
	push	ecx
	lea	edx, DWORD PTR $T40463[ebp]
	push	edx
	mov	ecx, DWORD PTR ?gpGlobals@@3PAUglobalvars_t@@A ; gpGlobals
	add	ecx, 40					; 00000028H
	call	??DVector@@QBE?AV0@M@Z			; Vector::operator*
	push	eax
	lea	eax, DWORD PTR $T40464[ebp]
	push	eax
	lea	ecx, DWORD PTR _position$39314[ebp]
	call	??HVector@@QBE?AV0@ABV0@@Z		; Vector::operator+
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _position$39314[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _position$39314[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _position$39314[ebp+8], eax
...
; 1332 : 		direction = (direction + gpGlobals->v_forward).Normalize();
	...
	call	?Normalize@Vector@@QBE?AV1@XZ		; Vector::Normalize
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR _direction$39315[ebp], ecx
	mov	edx, DWORD PTR [eax+4]
	mov	DWORD PTR _direction$39315[ebp+4], edx
	mov	eax, DWORD PTR [eax+8]
	mov	DWORD PTR _direction$39315[ebp+8], eax
...
; 1086 : 		a = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40552[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40552[ebp], 0
	je	SHORT $L40553
	mov	ecx, DWORD PTR $T40552[ebp]
...
$L40554:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T40551[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T40551[ebp]
	mov	DWORD PTR _a$[ebp], ecx
...
; 1086 : 		a = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40565[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40565[ebp], 0
	je	SHORT $L40566
	mov	ecx, DWORD PTR $T40565[ebp]
...
$L40567:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T40564[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T40564[ebp]
	mov	DWORD PTR _a$[ebp], ecx
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40578[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40578[ebp], 0
	je	SHORT $L40579
	mov	ecx, DWORD PTR $T40578[ebp]
	call	??0CSpiral@@QAE@XZ			; CSpiral::CSpiral
	mov	DWORD PTR -28+[ebp], eax
	jmp	SHORT $L40580
$L40579:
...
$L40580:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T40577[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T40577[ebp]
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40593[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40593[ebp], 0
	je	SHORT $L40594
	mov	ecx, DWORD PTR $T40593[ebp]
	call	??0CStomp@@QAE@XZ			; CStomp::CStomp
	mov	DWORD PTR -28+[ebp], eax
	jmp	SHORT $L40595
$L40594:
...
$L40595:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T40592[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T40592[ebp]
	mov	DWORD PTR _newEnt$[ebp], ecx
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40606[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40606[ebp], 0
	je	SHORT $L40607
	mov	ecx, DWORD PTR $T40606[ebp]
...
$L40608:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T40605[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T40605[ebp]
	mov	DWORD PTR _newEnt$[ebp], ecx
...
; 1106 : 		newEnt = new(pev) T;
	...
	call	??2CBaseEntity@@SAPAXIPAUentvars_s@@@Z	; CBaseEntity::operator new
	add	esp, 8
	mov	DWORD PTR $T40619[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T40619[ebp], 0
	je	SHORT $L40620
	mov	ecx, DWORD PTR $T40619[ebp]
...
$L40621:
	mov	eax, DWORD PTR -28+[ebp]
	mov	DWORD PTR $T40618[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T40618[ebp]
	mov	DWORD PTR _newEnt$[ebp], ecx
...
; 318  : 	virtual Vector BodyTarget( const Vector &posSrc ) { return Center( ) * 0.75 + EyePosition() * 0.25; };		// position to shoot at
	...
	lea	eax, DWORD PTR $T40836[ebp]
	push	eax
	lea	ecx, DWORD PTR $T40835[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _this$[ebp]
...
; 220  : 		pev->absmax = GetAbsOrigin() + Vector( 80, 80, 214 );
	...
	push	1117782016				; 42a00000H
	lea	ecx, DWORD PTR $T40854[ebp]
	call	??0Vector@@QAE@MMM@Z			; Vector::Vector
	push	eax
	lea	ecx, DWORD PTR $T40855[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?GetAbsOrigin@CBaseEntity@@QBEABVVector@@XZ ; CBaseEntity::GetAbsOrigin
	mov	ecx, eax
