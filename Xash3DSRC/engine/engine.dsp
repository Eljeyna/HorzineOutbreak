...
BuildCmds= \
	copy $(TargetDir)\xash.dll "Z:\xash.dll" \
	copy $(TargetDir)\xash.dll "Z:\Paranoia2\xash.dll" \
	copy $(TargetDir)\xash.dll "Z:\Quake\xash.dll" \
	copy $(TargetDir)\xash.dll "Z:\Xash3D\xash.dll" \
	

"Z:\xash.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"Z:\Paranoia2\xash.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"Z:\Quake\xash.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

"Z:\Xash3D\xash.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
